            ...
            <ul class="items items-user-toolbar">
                ...
                <li class="box-4">
                    <div class="btn-toggle-toolbar">
                        <button type="button" data-rel="0" {if $_COOKIE['condUserToolbar'] == 0 && isset($_COOKIE['condUserToolbar'])}style="display: none;"{else:} class="activeUT active"{/if}>
                            <span class="icon_times_toolbar_down"></span>
                        </button>
                        <button type="button" data-rel="1" {if $_COOKIE['condUserToolbar'] == 1 ||  !isset($_COOKIE['condUserToolbar'])}style="display: none;"{else:} class="activeUT active"{/if}>
