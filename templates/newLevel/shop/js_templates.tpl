        ...
        <div class="frame-bask">
            ...
            <div class="no-empty">
                <div class="drop-header">
                    <div class="title bask"><span>{/literal}{lang('В вашей корзине','newLevel')}{literal}</span> <span class="add-info"><span class="topCartCount"><%- Shop.Cart.totalCount %></span></span> <span class="plurProd"><%- pluralStr(Shop.Cart.totalCount, plurProd) %></span> <span>{/literal}{lang('на сумму','newLevel')}{literal}</span> <span class="add-info"><span class="topCartTotalPrice"><%- parseFloat(Shop.Cart.totalPrice).toFixed(pricePrecision) %></span></span> <%-curr%></div>
                </div>
            </div>
                        ...
                        <div class="inside-padd">
                            <div class="clearfix">
                                <span class="frame-discount">
                                    <span class="c_7">{/literal}{lang('Ваша текущая скидка','newLevel')}{literal}:</span>
                                ...
                                <div class="btn-back-prod f_l">
                                    <button type="button" data-closed="closed-js">
                                        <span class="text-el"><span class="f-s_14"><span class="icon_back_prod"></span></span> {/literal}{lang('Вернуться к оформлению','newLevel')}{literal}</span>
                                    </button>
                                </div>
                                <% } %>
                                <span class="c_7">{/literal}{lang('Итого к оплате','newLevel')}{literal}:</span>
                            ...
                            <div class="clearfix inside-padd">
                                <div class="btn-back-prod f_l">
                                    <button type="button" data-closed="closed-js">
                                        ...
                                        <span class="text-el"><span class="f-s_14"><span class="icon_back_prod"></span></span> {/literal}{lang('Вернуться к покупкам','newLevel')}{literal}</span>
                                    </button>
                                </div>
                    ...
                    <div class="header-frame-foot">
                        <div class="inside-padd">
                            ...
                            <span class="frame-discount">
                                ...
                                <span class="c_7 f-s_13">{/literal}{lang('Ваша текущая скидка','newLevel')}{literal}:</span>
                            ...
                            <span class="c_7 f-s_13">{/literal}{lang('И того к оплате','newLevel')}{literal}:</span>
                            <span class="frame-cur-sum-price">
                                <span class="frame-prices f-s_0">
                                    <span class="price-discount">
                                        <span class="frame-discount">
        ...
        <div class="inside-padd">
            ...
            <div>
                <div class="btn-autocomplete">{/literal}
                    <a href="{shop_url('search')}?text={literal}<%- items.queryString %>" {/literal} class="f-s_0 c_6">
                        <span class="text-el">{lang('Смотреть все товары','newLevel')}<span class="icon_show_all"></span></span>
                    </a>
                </div>{literal}
                <!-- End. Show link  -->
                <% } else {%>    
            ...
            <div class="inside-padd cofirm w-s_n-w">
                ...
                <div class="btn-cancel">
                    <button type="button" data-closed="closed-js" class="pointer">
                        <span class="text-el d_l_bl">{lang('Отменить' , 'newLevel')}</span>
                    </button>
                </div>
            </div>
        </div>
