        ...
        {if count($products) > 0}
            <div class="no-empty">
                ...
                <div class="f-s_0 title-compare without-crumbs clearfix">
                    ...
                    <div class="d_i-b m-l_10 m-t_3">
                        <span class="text-el v-a_m">{lang('Все параметры','newLevel')}</span>
                        <ul class="tabs groups-buttons tabs-list-table tabs-compare-diferent v-a_m" data-type="radio" data-cookie="compare">
                            <li class="btn-def {if $_COOKIE['compare'] == "#all-params"}active{/if}">
                                <button type="button" data-href="#all-params" data-title="{lang('Все параметры','newLevel')}" data-rel="tooltip">
                                    <span class="icon_table_cat"></span>
                                </button>
                            </li>
                            <li class="btn-def {if $_COOKIE['compare'] == "#only-dif"}active{/if}">
                                <button type="button" data-href="#only-dif" data-title="{lang('Только Различия','newLevel')}" data-rel="tooltip">
                                    <span class="icon_list_cat"></span>
                                </button>
                            </li>
                        </ul>
                        <span class="text-el v-a_m">{lang('Только Различия','newLevel')}</span>
                    </div>
                </div>
