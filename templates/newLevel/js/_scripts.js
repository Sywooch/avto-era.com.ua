$(document).ready(function(){
    ...
    $('.submitshyny').click(function(){
  $.fancybox.showActivity();
  if($('#typetr').val() == 0) {alert('Выберите тип');   $.fancybox.hideActivity();return false;}
if($('#sezon').val() == 0) {alert('Выберите сезон');   $.fancybox.hideActivity();return false;}
    var first = $('#typetr').val().split('*');
    var second = $('#sezon').val().split('*');

    $('.shinaform').attr('action', '/shop/category/' + first[1] + '/'  + second[1]);
    $('#typetr').remove();
    $('#sezon').remove();
...
$.ajax({
  ...
  data: {bid: $("#brand2").val() , cid: $("#typetr").val()},
  success: function(data){
    $('.selsezon').html(data);
...
$.ajax({
  ...
  data: {bid: $("#brand2").val() , cid: $("#sezon").val()},
  success: function(data){
...
$.ajax({
  ...
  data: {bid: $("#brand2").val() , cid: $("#sezon").val() , shirina: $("#shirina").val()},
  success: function(data){
    $('.selvysota').html(data);
...
$.ajax({
  ...
  data: {bid: $("#brand2").val() , cid: $("#sezon").val() , shirina: $("#shirina").val() , vysota: $("#vysota").val()},
  success: function(data){
...
$.ajax({
  ...
  data: {diam: $("#diametr").val() , bid: $("#brand").val()},
  success: function(data){
...
$.ajax({
  ...
  data: {diam: $("#diametr").val() , bid: $("#brand").val() , type: $("#disctype").val()},
  success: function(data){
    $('.selpcd').html(data);
     cuselInit(body, '#pcd');
     $.fancybox.hideActivity();
...
$.ajax({
  ...
  data: {diam: $("#diametr").val() , bid: $("#brand").val() , type: $("#disctype").val()  , pcd: $("#pcd").val()},
  success: function(data){
    $('.selet').html(data);
     cuselInit(body, '#et');
  }
...
$.ajax({
  ...
  data: {diam: $("#diametr").val() , bid: $("#brand").val() , type: $("#disctype").val()  , pcd: $("#pcd").val()  , et: $("#et").val()},
  success: function(data){
...
function init() {
    ...
    cuselInit(body, '#shnydimatr ,#vysota, #shirina, #sezon, #typetr, #brand , #brand2 , #diametr , #disctype , #pcd,  #et , #stupica , #sort, #sort2, #compare, #appointment, #season, #diameter, [id ^= сVariantSwitcher_]');
    /*call general functions and plugins*/
...
$('.main-body').delegate(".input-search", "focus blur", function(){
    var elem = $(this);
    elem.closest('.frame-search-input').siblings('.btn-search').toggleClass('focused', elem.is(":focus"));
});
