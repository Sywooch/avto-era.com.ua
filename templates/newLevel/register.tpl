                ...
                <div class="horizontal-form">
                    <div class="frame-label">
                        ...
                        <div class="frame-form-field">
                            <input type="text" class="required" id="reg_name" maxlength="30" name="username" value="{set_value('username')}" />
                        </div>
                    </div>
                    <div class="frame-label">
                    ...
                    <div class="frame-label">
                        ...
                        <div class="frame-form-field">
                            <input type="password" name="password" id="reg_pswd" value="{set_value('password')}" />
                            <span class="must">*</span>
                        </div>
                    </div>
                    <div class="frame-label">
                        ...
                        <div class="frame-form-field">
                            <input type="password" class="required" name="confirm_password" id="reg_rptpswd" />
                            <span class="must">*</span>
                        </div>
                    </div>
                    ...
                    <div class="frame-label">
                        ...
                        <div class="frame-form-field">
                            <div class="btn-back-prod-m btn-back-prod m-b_15">
                                <input type="submit" onclick=”_gaq.push([‘_trackEvent’, ‘Register’, ‘new’, ‘user’]);” value="{lang('Зарегистрироваться','newLevel')}"/>
                            </div>
                            ...
                            <ul class="items items-register-add-ref">
                                <li>
                                    <button type="button" data-trigger="#loginButton" class="pointer">
                                        <span class="text-el d_l_bl">{lang('Войти','newLevel')}</span>
                                    </button>
                                </li>
                                <li>
                                    <span class="divider">|</span>
                                    <button type="button" data-drop=".drop-forgot" data-source="{site_url('auth/forgot_password')}" class="pointer">
                                        <span class="text-el d_l_bl">{lang('Напомнить пароль','newLevel')}</span>
                                    </button>
                                </li>
                        </div>
                    </div>
