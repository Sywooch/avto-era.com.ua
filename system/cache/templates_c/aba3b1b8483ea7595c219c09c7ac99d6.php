<a href="/admin/components/run/shop/orders/index?status_id=1" class="btn btn-large pjax" data-title="<?php echo lang ('Orders','admin'); ?>" data-rel="tooltip" data-original-title="<?php echo lang ('Orders','admin'); ?>">
...
<a href="/admin/components/run/shop/search/index?WithoutImages=1" class="btn btn-large pjax" data-title="<?php echo lang ('Products without icons','admin'); ?>" data-rel="tooltip" data-original-title="">
...
<a href="<?php if(isset($ADMIN_URL)){ echo $ADMIN_URL; } ?>callbacks#callbacks_1" class="btn btn-large pjax" data-title="<?php echo lang ('Callback','admin'); ?>" data-rel="tooltip" data-original-title="<?php echo lang ('Callback','admin'); ?>">
...
<a href="/admin/components/cp/comments" class="btn btn-large pjax" data-title="<?php echo lang ('Latest/recent  comments','admin'); ?>" data-rel="tooltip" data-original-title="<?php echo lang ('Latest/recent  comments','admin'); ?>">
