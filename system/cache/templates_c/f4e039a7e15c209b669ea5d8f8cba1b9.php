				...
				<div class="content-carousel">
					<ul class="items items-brands">
                            <?php if(is_true_array($brands)){ foreach ($brands as $brand){ ?>
                                <li><a
							href="<?php echo shop_url ( $brand['full_url'] ); ?>"
							class="frame-photo-title"> <span class="photo-block"> <span
									class="helper"></span> <img
									data-original="<?php echo media_url ( $brand['img_fullpath'] ); ?>"
									src="<?php if(isset($THEME)){ echo $THEME; } ?>images/blank.gif"
									title="<?php echo $brand['name']; ?>"
									alt="<?php echo $brand['name']; ?>" class="lazy" />
							</span>
						</a></li>
                            <?php }} ?>
                        </ul>
