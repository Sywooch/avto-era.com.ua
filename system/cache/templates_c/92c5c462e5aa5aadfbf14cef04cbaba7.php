...
<div class="compare-list-btn tiny-compare-list"
	...
	<button onclick="location = '<?php echo shop_url ('compare'); ?>'">
		<span class="icon_compare_list"></span> <span
			class="text-compare-list f-s_0"> <span class="text-el"><?php echo lang ('Список сравнения','newLevel'); ?> </span>
			<span class="text-el">(</span> <span class="f-s_0"> <span
				class="text-el compareListCount"></span>
		</span> <span class="text-el">)</span>
		</span>
	</button>
