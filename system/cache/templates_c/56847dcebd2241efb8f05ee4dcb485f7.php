			...
			<div class="inside-padd">
				<ul class="contact-list">
					<li>
						...
						<div class="phone-number phone-number-footer">
							<span class="icon_footer-main-phone"></span><?php echo siteinfo('siteinfo_mainphone')?></div>
					</li>
					<li>
						<div class="btn-read_more btn-read_more-f btn-read_more-ft">
							<button type="button" data-trigger="[data-drop='#ordercall']"
								title="<?php echo lang ('Заказать звонок','newLevel'); ?>">
								<span class="text-el"><?php echo lang ('Заказать звонок','newLevel'); ?></span>
							</button>
						</div>
					</li>
...
<div class="footer-footer">
	<div class="container t-a_c">
		<div class="d_i-b">
            ...
            <a class="siteimage-link" target="_blank"
				href="http://siteimage.com.ua"><?php echo lang ('компании Siteimage','newLevel'); ?></a>
		</div>
        <?php if(function_exists('mobile_site_address')): ?>
            <div class="f_r">
			<a class="f-s_0 c_w"> <span class="icon_phone_footer"></span> <span
				class="text-el"><a href="<?php echo mobile_site_address (); ?>"><?php echo lang ('Мобильная версия','newLevel'); ?></a></span>
			</a>
		</div>
        <?php endif; ?>
    </div>
