<?php if($can_comment == 1 AND !$is_logged_in): ?>
    <label>
        <span class="title__icsi-css"><b><?php echo sprintf (lang('Пожалуйста, войдите для комментирования', 'newLevel'), site_url( $modules['auth'] )); ?></b></span>
    </label>
<?php endif; ?>
    ...
    <?php if($comments_arr): ?>
        <div class="frame-list-comment__icsi-css frame-list-comment__icsi-css-wrap">
                    ...
                    <li>
                        ...
                        <div class="author-data-comment__icsi-css">
                            ...
                            <span class="date-comment__icsi-css">
                                <span class="day"><?php echo date("d",  $comment['date'] ) ?> </span>
                        ...
                        <div class="clearfix">
                                ...
                                <div class="func-button-comment__icsi-css">
                                    <?php if($can_comment == 0 OR $is_logged_in): ?>
                                        <div class="btn__icsi-css f_l__icsi-css">
                                            <button type="button" data-rel="cloneAddPaste" data-parid="<?php echo $comment['id']; ?>" class="pointer">
                                                <span class="icon-comment__icsi-css"></span>
                                                <span class="text-el d_l_gr"><?php echo lang ('Ответить'); ?></span>
                                            </button>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="frame-comment__icsi-css_right">
                                ...
                                <div class="f_r__icsi-css">
                                    <span>
                                        <span class="s-t" style="margin-bottom: 3px; display: inline-block;"><?php echo lang ('Был ли вам этот отзыв полезен?','newLevel'); ?></span>
                                        <span class="btn__icsi-css like__icsi-css">
                                            <button type="button" class="usefullyes" data-comid="<?php echo  $comment['id']  ?>">
                                                ...
                                                <span class="text-el"><?php echo lang ('Да','newLevel'); ?> <span class="yesholder<?php echo $comment['id']; ?>">(<?php echo  $comment['like']  ?>)</span></span>
                                            </button>
                                        </span>
                                        <span class="btn__icsi-css dis-like__icsi-css">
                                            <button type="button" class="usefullno" data-comid="<?php echo  $comment['id']  ?>">
                                                ...
                                                <span class="text-el"><?php echo lang ('Нет','newLevel'); ?> <span class="noholder<?php echo $comment['id']; ?>">(<?php echo  $comment['disslike']  ?>)</span></span>
                                            </button>
                                        </span>
                                    </span>
                                </div>
                        ...
                        <div class="btn-all-comments">
                            <button type="button"><span class="text-el pointer" data-hide='<span class="d_l_gr"><?php echo lang ('Скрыть','newLevel'); ?></span> ↑' data-show='<span class="d_l_gr"><?php echo lang ('Все ответы','newLevel'); ?></span> ↓'></span></button>
                        </div>
                    </li>
                <?php }} ?>
            </ul>
            <button class="t-d_n f-s_0 s-all-d ref d_n_" data-trigger="[data-href='#comment']" data-scroll="true">
                ...
                <span class="text-el"><?php echo lang ('Смотреть все ответы','newLevel'); ?></span>
            </button>
        </div>
    <?php endif; ?>
    <?php if($can_comment == 0 OR $is_logged_in): ?>
            ...
            <div class="frame-comments__icsi-css layout-highlight">
                ...
                <div class="form-comment__icsi-css form__icsi-css main-form-comments">
                    <div class="inside-padd">
                        <form method="post">
                            ...
                            <div class="clearfix">
                                <label style="width: 52%;float: left;">
                                    <span class="title__icsi-css"><?php echo lang ('Как вас зовут','newLevel'); ?></span>
                                    <span class="frame_form_field__icsi-css">
                        ...
                        <?php endif; ?>
                        <label>
                            <span class="title__icsi-css"><?php echo lang ('Комментарий'); ?></span>
                            <span class="frame_form_field__icsi-css">
                        ...
                        <?php if($use_captcha): ?>
                            <label>
                                <span class="title__icsi-css"><?php echo lang ('Код защиты'); ?></span>
                        ...
                        <div class="frameLabel__icsi-css">
                            <span class="frame_form_field__icsi-css">
                                <div class="btn-comment">
                                       <input type="submit" value="<?php echo lang ('Отправить'); ?>" onclick="Comments.post
                                            (this)"/>
                                </div>
                            </span>
                        </div>
            ...
            <div class="form-comment__icsi-css form__icsi-css layout-highlight frame-comments__icsi-css">
                <div class="inside-padd">
                    <form>
                        ...
                        <?php if(!$is_logged_in): ?>
                            <label>
                                <span class="title__icsi-css"><?php echo lang ('Ваше имя:', 'newLevel'); ?></span>
                                <span class="frame_form_field__icsi-css">
                                    <input type="text" name="comment_author" value="<?php echo get_cookie ('comment_author'); ?>"/>
                                </span>
                            </label>
                        ...
                        <?php endif; ?>
                        <label>
                            <span class="title__icsi-css"><?php echo lang ('Текст ответа:','newLevel'); ?></span>
                            <span class="frame_form_field__icsi-css">
                        ...
                        <div class="frameLabel__icsi-css">
                            <span class="frame_form_field__icsi-css">
                                ...
                                <span class="btn-comment btn-comment-s">
                                    <input type="submit" value="<?php echo lang ('Отправить', 'newLevel'); ?>" onclick="Comments.post(this)"/>
                                </span>
                            </span>
                        </div>
                    </form>
