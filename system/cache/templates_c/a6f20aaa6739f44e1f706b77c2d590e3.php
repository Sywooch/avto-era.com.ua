								...
								<div class="control-group span9 p-r_25">
									...
									<div class="controls">
										<input type="text" id="Name" name="Name"
											value="<?php echo ShopCore::encode($model->getName())?>">
									</div>
								</div>
								<div class="span3">
                                    ...
                                    <?php endif; ?>
                                    <div class="frame_prod-on_off v-a_m"
										data-rel="tooltip" data-placement="top"
										data-original-title="<?php echo lang ('show','admin'); ?>">
										<span data-page="tovar"
											class="prod-on_off <?php if(isset($checkedP)){ echo $checkedP; } ?>"
											data-id="<?php echo $model->getId()?>"></span> <input
								...
								<div class="control-group m-t_10">
									...
									<div class="controls">
                                        <?php if($model->getHit() == true): ?>
											...
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> btn-primary active setHit"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('hit','admin'); ?>">
											<i class="icon-fire"></i> <?php echo lang ('Hit','admin'); ?></button>
                                        <?php else:?>
                                            <button type="button"
											data-id="<?php echo $model->getId()?>"
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> setHit"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('hit','admin'); ?>">
											<i class="icon-fire"></i> <?php echo lang ('Hit','admin'); ?></button>
                                        <?php endif; ?>
                                        ...
                                        <?php if($model->getHot() == true): ?>
                                            <button type="button"
											data-id="<?php echo $model->getId()?>"
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> btn-primary active setHot"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('novelty','admin'); ?>">
											<i class="icon-gift"></i> <?php echo lang ('Novelty','admin'); ?></button>
                                        <?php else:?>
                                            <button type="button"
											data-id="<?php echo $model->getId()?>"
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> setHot"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('novelty','admin'); ?>">
											<i class="icon-gift"></i> <?php echo lang ('Novelty','admin'); ?></button>
                                        <?php endif; ?>
                                        ...
                                        <?php if($model->getAction() == true): ?>
                                            <button type="button"
											data-id="<?php echo $model->getId()?>"
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> btn-primary active setAction"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('promotion','admin'); ?>">
											<i class="icon-star"></i> <?php echo lang ('Promotion','admin'); ?></button>
                                        <?php else:?>
                                            <button type="button"
											data-id="<?php echo $model->getId()?>"
											class="btn btn-small <?php if(isset($disableClass)){ echo $disableClass; } ?> setAction"
											data-rel="tooltip" data-placement="top"
											data-original-title="<?php echo lang ('promotion','admin'); ?>">
											<i class="icon-star"></i> <?php echo lang ('Promotion','admin'); ?></button>
                                        <?php endif; ?>
									...
									<table class="table table-bordered t-l_a">
										<thead>
											<tr>
												...
												<th class="span2"><?php echo ShopCore::encode($model->getLabel('Price'))?> <span
										...
										<tbody class="sortable save_positions_variant"
                                            ...
                                            <?php if($model->countProductVariants() > 0): ?>
                                                ...
                                                <?php if(is_true_array($model->getProductVariants(null,null, TRUE, $locale))){ foreach ($model->getProductVariants(null,null, TRUE, $locale) as $v){ ?>
                                                    ...
                                                    <tr
												id="ProductVariantRow_<?php if(isset($i)){ echo $i; } ?>">
												<td class="vName"><input name="idv" type="hidden"
													value="<?php echo $v->id?>" />
														...
														<input type="hidden" name="variants[RandomId][]"
															...
															name="variants[CurrentId][]"
															value="<?php echo $v->getId()?>" /> <input type="text"
															name="variants[Name][]"
															value="<?php echo ShopCore::encode($v->getName())?>" />
													</div></td>
												<td class="number"><input type="text"
													name="variants[PriceInMain][]"
													value="<?php echo ShopCore::encode($v->getPriceInMain())?>" />
												</td>
                                                        <?php if(count($currencies)>0): ?>
                                                            <td><select
													name="variants[currency][]">
                                                        ...
                                                        <td><input
													type="text" name="variants[Number][]"
													value="<?php echo ShopCore::encode($v->getNumber())?>"
													class="textbox_short" /></td>
												<td class="number"><input type="text"
													name="variants[Stock][]"
													value="<?php echo ShopCore::encode($v->getStock())?>"
													class="textbox_short" /></td>
													...
													<div class="control-group">
														<label class="control-label" style="display: none;"> <span
															class="btn btn-small p_r" data-url="file"> <i
																...
																name="image<?php if(isset($i)){ echo $i; } ?>"
																title="<?php echo lang ('Main image','admin'); ?>" /> <input
																type="hidden" name="changeImage[]" value=""
																class="changeImage" /> <input type="hidden"
																name="variants[MainImageForDel][<?php echo $v->getId()?>]"
														...
														<div class="controls photo_album">
															...
															<div class="btn-group f-s_0">
																...
																<button type="button" class="btn images_modal"
																	data-rel="tooltip"
																	data-title="<?php echo lang ('Load from internet', 'admin'); ?>"
																	data-original-title="">
																	<i class="icon-search"></i>
																</button>
																<button type="button" class="btn delete_image"
																	data-rel="tooltip"
																	data-title="<?php echo lang ('Remove','admin'); ?>">
																	<i class="icon-remove"></i>
																</button>
															</div>
                                                                    <?php if($v->getMainPhoto()): ?>
                                                                        <img
																src="<?php echo $v->getMainPhoto()?>"
																class="img-polaroid" style="width: 100px;">
                                                                    <?php else:?>
                                                                        <img
																src="<?php if(isset($THEME)){ echo $THEME; } ?>images/select-picture.png"
...
$result = SBrandsQuery::create ()->find ();
																																																if (is_true_array ( $result )) {
																																																	foreach ( $result as $brand ) {
																																																		?>
                                                    <option
													<?php if($model->getBrandId() == $brand->getId()): ?>
													selected="selected" <?php endif; ?>
													value="<?php echo $brand->getId()?>"><?php echo ShopCore::encode($brand->getName())?></option>
                                                <?php }} ?>
                                            </select>
										</div>
									</div>
										...
										<div class="controls">
											<select name="CategoryId" id="comment">
                                                <?php if(is_true_array($categories)){ foreach ($categories as $category){ ?>
                                                    <option
													<?php if($category->getLevel() == 0): ?>
													style="font-weight: bold;" <?php endif; ?>
													<?php if($model->getCategoryId() == $category->getId()): ?>
													selected="selected" <?php endif; ?>
							...
							<div class="control-group">
								<label class="control-label" for="ShortDescriptions"><?php echo $translatable?> <?php echo lang ('Short description','admin'); ?>:
                                </label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label" for="FullDescriptions"><?php echo $translatable?> <?php echo lang ('Full description','admin'); ?>:
                                </label>
								<div class="controls">
						...
						<div class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="pName"><?php echo lang ('Warehouses','admin'); ?>:
                                    <button type="button"
										data-clone="wares" class="btn btn-small">
										<i class="icon-plus"></i>
									</button>
									<br /> </label>
								<div class="controls">
												...
												<select name="warehouses[]" class="input-medium">
													<option value="">---</option>
                                                        <?php if(is_true_array($warehouses)){ foreach ($warehouses as $w){ ?>
                                                            <option
														<?php if($w->getId() == $w_data->getWarehouseId()): ?>
														selected <?php endif; ?> value="<?php echo $w->getId()?>"><?php echo encode($w->getName())?></option>
                                                        <?php }} ?>
                                                    </select> <input
													type="text" name="warehouses_c[]"
													value="<?php echo $w_data->getCount()?>"
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="comments" class="input-mini" name="EnableComments">
										<option <?php if($model->getEnableComments()): ?> selected
											<?php endif; ?> value="1"><?php echo lang ('Yes','admin'); ?></option>
										<option <?php if(!$model->getEnableComments()): ?> selected
											<?php endif; ?> value="0"><?php echo lang ('No','admin'); ?></option>
									</select>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="oldP"
										value="<?php echo $model->getOldPrice()?>" name="OldPrice" />
								</div>
							</div>
								...
								<div class="controls">
									...
									<div id="relatedProductsNames" style="margin-top: 10px;">
                                        <?php if(is_true_array($model->getRelatedProductsModels())){ foreach ($model->getRelatedProductsModels() as $shopKitProduct){ ?>
                                            <div
											id="tpm_row<?php echo $shopKitProduct->getId()?>">
											<span style="width: 70%; margin-left: 1%;" class="pull-left">
												<a
												href="<?php echo $ADMIN_URL .'products/edit/'.$shopKitProduct->getId()?>">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" id="templateGH" name="tpl"
										value="<?php echo ShopCore::encode($model->tpl)?>" />
						...
						<div class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<span class="o_h d_b"> <input type="text" name="Url" id="Url"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="MetaTitle" id="Mtag"
										value="<?php echo $model->getMetaTitle()?>" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="MetaDescription" id="mDesc"
										value="<?php echo $model->getMetaDescription()?>" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="MetaKeywords" id="mKey"
										value="<?php echo $model->getMetaKeywords()?>" />
								</div>
							</div>
						</div>
					</div>
                                ...
                                <?php for($i=0; $i<12; $i++){?>
									...
									style="height: 115px;">
										...
										<label class="control-label"
											for="additionalImage_<?php if(isset($i)){ echo $i; } ?>"> <span
											class="btn btn-small p_r" data-url="file"> <i
												class="icon-camera"></i>&nbsp;&nbsp;<?php echo lang ('Select a file','admin'); ?>
                                                    <input type="file"
												class="btn-small btn additional_image_file"
												id="additionalImage_<?php if(isset($i)){ echo $i; } ?>"
												name="additionalImages<?php echo $i?>"> <input type="hidden"
												class='additional_image_url'
												id='add_img_urls_<?php if(isset($i)){ echo $i; } ?>'
												name='add_img_urls_<?php if(isset($i)){ echo $i; } ?>'>
										</span>
										</label>
										<div class="controls">
                                                <?php if(isset($additionalImagePositions[$i])): ?>
                                                    <img
												src="/uploads/shop/products/origin/additional/<?php echo $additionalImagePositions[$i]->getImageName()?>"
...
<div class="tab-pane" id="kits">
				...
				<td colspan="6">
						...
						<thead>
							<tr>
								...
								<th><a class="pjax"
									href="<?php if(isset($ADMIN_URL)){ echo $ADMIN_URL; } ?>kits/kit_edit/<?php echo $kit->getId()?>"><?php echo lang ('Editing','admin'); ?></a>
								</th>
								<th>
                                                <?php echo lang ('Position','admin'); ?>: <?php echo $kit->getPosition()?>
                                                <button type="button"
										style="float: right" class="btn btn-mini kit_del"
										data-kid="<?php echo $kit->getId()?>">
										<i title="<?php echo lang ('Delete set','admin'); ?>"
											class="icon-trash"></i>
									</button>
									<button type="button" style="float: right; margin-right: 2px;"
										...
										data-kid="<?php echo $kit->getId()?>">
										<i title="<?php echo lang ('Active','admin'); ?>"
											class="icon-ok"></i>
									</button>
								</th>
							</tr>
						...
						<tbody>
							<tr>
								<td><b><?php echo $kit->getLabel('Id')?></b></td>
								<td><b><?php echo $kit->getLabel('Name')?></b></td>
								<td><b><?php echo $kit->getLabel('Discount')?></b></td>
                                        ...
                                        <?php if(is_true_array($kit->getShopKitProducts())){ foreach ($kit->getShopKitProducts() as $shopKitProduct){ ?>
                                            ...
                                            <tr
								class="<?php echo func_counter ('even','odd'); ?>">
    ...
    <?php else:?>
		...
		style="margin-bottom: 18px; margin-top: 71px;">
