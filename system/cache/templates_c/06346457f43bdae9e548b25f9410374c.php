<div class="frame-user-toolbar">
	<div class="container inside-padd">
        ...
        <div class="content-user-toolbar"
			<?php if(!($countCo!=0 || $countWL!=0 || $countSh!=0)): ?>
			...
			<ul class="items items-user-toolbar">
                ...
                <?php if($countSh): ?>
					...
					<div class="btn-already-show">
						<button type="button" data-drop=".frame-already-show"
							data-effect-on="slideDown" data-effect-off="slideUp"
							data-place="inherit">
							<span class="icon_already_show"></span> <span
								class="text-view-list"> <span class="text-el"><?php echo lang ("Просмотренные товары",'newLevel'); ?></span>
                ...
                <li class="box-4">
					<div class="btn-toggle-toolbar">
						<button type="button" data-rel="0"
							<?php if($_COOKIE['condUserToolbar'] == 0 && isset($_COOKIE['condUserToolbar'])): ?>
							style="display: none;" <?php else:?> class="activeUT active"
							<?php endif; ?>>
							<span class="icon_times_toolbar_down"></span>
						</button>
						<button type="button" data-rel="1"
							<?php if($_COOKIE['condUserToolbar'] == 1 ||  !isset($_COOKIE['condUserToolbar'])): ?>
							style="display: none;" <?php else:?> class="activeUT active"
							<?php endif; ?>>
