 ...
 if(is_true_array($result)){ foreach ($result as $b){ ?>
     ...
     <div class="check-appointment p_r  v-a_m m-t_10">
        ...
        <div class="benefits f_r">
            <ul>
                <li><span class="icon_work-time"></span>Работаем 7 дней в неделю</li>
                <li><span class="icon_system"></span>Гибкая система скидок для клиентов</li>
                <li><span class="icon_deliv-ben"></span>Доставка по Украине</li>
            </ul>
        </div>
    </div>
