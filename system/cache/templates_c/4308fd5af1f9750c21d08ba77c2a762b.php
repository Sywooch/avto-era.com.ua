<section class="mini-layout">
    ...
    <form method="post" action="/admin/components/init_window/banners/edit/<?php echo $banner['id']?>/<?php if(isset($locale)){ echo $locale; } ?>" enctype="multipart/form-data" id="image_upload_form">
                            ...
                            <div class="form-horizontal">
                                <div class="span9">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" id="Name" value="<?php echo $banner['name']?>" />
                                        </div>
                                        <div class="controls">
 ...
 if(is_true_array($result)){ foreach ($result as $w){ ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="datepicker" type="text" value="<?php if($banner['active_to']): ?><?php echo date('Y-m-d',$banner['active_to'])?><?php else:?><?php echo $date?><?php endif; ?>" name="active_to" />
                                    </div>
                                </div>  
                        ...
                        return false;"><i class="icon-picture"></i>  <?php echo lang ('Choose an image ', 'banners'); ?></button>
                                        </div>
                                        <div class="o_h">		            
                                            <input type="text" name="photo" id="Img" value="<?php echo $banner['photo'];?>">					
                                        </div>
                                        <div id="Img-preview" style="width: 400px;" >
                                            <?php if($banner['photo']): ?>
                                                <img src="<?php echo $banner['photo']?>" class="img-polaroid" style="width: 100px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
