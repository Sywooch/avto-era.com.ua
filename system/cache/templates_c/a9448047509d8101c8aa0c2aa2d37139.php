            ...
            <div class="inside-padd">
                <div class="title">
                    <span class="f-s_0">
                        ...
                        <span class="d_b">
                            <span class="text-el"><?php echo lang ('Производитель', 'newLevel'); ?></span>
                        </span>
                    </span>
                </div>
...
<?php */?>
<input disabled="disabled" type="hidden" name="requestUri" value="<?php echo site_url($CI->uri->uri_string())?>"/>
