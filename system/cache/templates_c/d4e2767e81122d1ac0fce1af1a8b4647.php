<div id="images_modal" class="modal hide fade">
    <div class="modal-header">
        ...
        <div class="span5" style="width: 424px;">
            <input data-original-title="<?php echo lang ('URL or request for search', 'admin'); ?>" type="text" id="url_image" maxlength="255" placeholder="<?php echo lang ('Enter the URL of the image or the search criterion', 'admin'); ?>">
        </div>
        <button id="search_images" class="btn"><i class="icon-search"></i></button>
    ...
    <div class="modal-footer images_modal_footer">
        <label id="as_additional_container" class="pull-left" data-original-title="<?php echo lang ('Hold down Shift to select multiple images', 'admin'); ?>" for="as_additional">
            <input type="checkbox" name="as_additional" id="as_additional" />
            <?php echo lang ('Save as additional', 'admin'); ?>
        </label>
        <a href="#" class="btn" data-dismiss="modal"><?php echo lang ('Cancel', 'admin'); ?></a>
