...
<div id="wishListData">
	<div class="wish-list-btn tiny-wish-list" <?php if($countWL == 0): ?>
		style="display: none;" <?php endif; ?>>
		<button onclick="location = '<?php echo site_url ('wishlist'); ?>'">
			<span class="icon_wish_list"></span> <span
				class="text-wish-list f-s_0"> <span class="text-el"><?php echo lang ('Список желаний','newLevel'); ?> </span>
				<span class="text-el">(</span> <span class="text-el wishListCount"><?php echo $countWL?></span>
			</span> <span class="text-el">)</span> </span>
		</button>
	</div>
</div>
