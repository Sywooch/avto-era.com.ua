...
<?php if(is_true_array($products)){ foreach ($products as $key => $p){ ?>
    ...
    <li class="clearfix <?php if($p->firstVariant->getStock() == 0): ?>not-avail<?php endif; ?>" data-pos="top">
        ...
        <div class="description">
            ...
            <?php if($codeArticle): ?>
                <div class="frame-variant-name-code">
                    ...
                    <span class="frame-variant-code" <?php if($hasCode): ?>style="display:none;"<?php endif; ?>><span class="text-number"></span>:
                        <span class="code">
                            <?php if(!$hasCode): ?>
                    ...
                    <span class="frame-variant-name" <?php if($hasVariant): ?>style="display:none;"<?php endif; ?>><span class="text-variant"></span>:
                        <span class="code">
                            <?php if(!$hasVariant): ?>
                    ...
                    <?php if(!$vertical): ?>
                        <?php if($p->enable_comments && intval($Comments[$p->getId()]) !== 0): ?>
                            <div class="frame-star f-s_0">
                                ...
                                <a href="<?php echo shop_url ('product/'.$p->url.'#comment'); ?>" class="count-response t-d_n">
                                ...
                                <ul class="prop-product">
                                    ...
                                    <?php if(strpos($CI->uri->uri_string(),'/category') !== false || strpos($CI->uri->uri_string(),'/brand') !== false || strpos($CI->uri->uri_string(),'/search') !== false): ?>
                                        <?php if(is_true_array($props)){ foreach ($props as $prop){ ?>
                                            <li class="li-table"><span class="c_3"><?php echo $prop['Name']; ?>:</span> <?php echo $prop['Value']; ?></li>
                                        <?php }} ?>
                                        <?php if($props = ShopCore::app()->SPropertiesRenderer->renderPropertiesMainArray($p, 0)): ?>
                                            <?php $pcnt = 1?>
                                            <?php if(is_true_array($props)){ foreach ($props as $prop){ ?>
                                                <li class="li-list" <?php if($pcnt == 1): ?>style="border-top:none"<?php endif; ?>>
