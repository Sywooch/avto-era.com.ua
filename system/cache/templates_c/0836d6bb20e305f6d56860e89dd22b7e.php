...
<div class="frame-inside page-category">
    ...
    <?php if($category->getId() != 102): ?>    <div class="filter-bus f_l" style="margin-left: -10px;">
           ...
           <div class="check-appointment p_r  v-a_m">
                <div class="lineForm">
                    <select class="color" id="brand2" name="brand[]" >
                        ...
                        <?php $result = getBrand(102, true); 
 if(is_true_array($result)){ foreach ($result as $b){ ?>
...
<script type="text/javascript" src="<?php if(isset($THEME)){ echo $THEME; } ?>js/cusel-min-2.5.js"></script><?php $mabilis_ttl=1411131443; $mabilis_last_modified=1408993275; ///var/www/avto-era.com.ua/templates/newLevel/shop/category.tpl ?>