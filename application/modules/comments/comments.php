...
class Comments extends MY_Controller {
	...
	public function commentsDeleteFromCategory($product) {
		...
		$array = $CI->db->select ( 'item_id' )->join ( 'shop_products', 'comments.item_id=shop_products.id' )->where_in ( 'shop_products.category_id', $ids )->where ( 'module', 'shop' )->group_by ( 'item_id' )->get ( 'comments' )->result_array ();
	...
	public function init($model) {
		\CMSFactory\assetManager::create ()->registerScript ( 'comments', TRUE );
