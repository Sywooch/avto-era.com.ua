...
class Wishlist_model extends CI_Model {
	...
	public function getSettings() {
		$this->db->cache_on ();
		$settings = $this->db->select ( 'settings' )->where ( 'identif', 'wishlist' )->get ( 'components' )->row_array ();
		$this->db->cache_off ();
	...
	public function setSettings($settings) {
		return $this->db->where ( 'identif', 'wishlist' )->update ( 'components', array (
	...
	public function getWishLists($userID = NULL) {
		...
		return $this->db->where ( 'user_id', $userID )->get ( 'mod_wish_list' )->result_array ();
	}
	...
	public function getAllUsers() {
		$users = $this->db->order_by ( 'user_name' )->get ( 'mod_wish_list_users' );
	...
	public function getUserByID($id) {
		$query = $this->db->where ( 'id', $id )->get ( 'mod_wish_list_users' );
	...
	public function getWLsByUserId($user_id, $access = array('shared')) {
		return $all_lists = $this->db->where ( 'user_id', $user_id )->where_in ( 'access', $access )->get ( 'mod_wish_list' )->result_array ();
	}
	...
	public function getUserWishList($user_id, $list_id, $access = array('public', 'shared', 'private')) {
		...
		$query = $this->db->where ( 'mod_wish_list.user_id', $user_id )->where_in ( 'access', $access )->where ( 'mod_wish_list.id', $list_id )->where ( 'shop_products_i18n.locale', $locale )->where ( 'shop_product_variants_i18n.locale', $locale )->join ( 'mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id' )->join ( 'shop_product_variants', 'shop_product_variants.id=mod_wish_list_products.variant_id' )->join ( 'shop_product_variants_i18n', 'shop_product_variants_i18n.id=shop_product_variants.id' )->join ( 'shop_products', 'shop_products.id=shop_product_variants.product_id' )->join ( 'shop_products_i18n', 'shop_products_i18n.id=shop_products.id' )->get ( 'mod_wish_list' )->result_array ();
		if (! $query)
			return $this->db->select ( '*, mod_wish_list.id AS `wish_list_id`' )->where_in ( 'mod_wish_list.access', $access )->where ( 'mod_wish_list_products.wish_list_id', NULL )->where ( 'mod_wish_list.id', $list_id )->where ( 'mod_wish_list.user_id', $user_id )->join ( 'mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id', 'left' )->get ( 'mod_wish_list' )->result_array ();
		return $query;
	}
	...
	public function getUserWishListByHash($hash, $access = array('public', 'shared', 'private')) {
		...
		$query = $this->db->select ( '*, mod_wish_list.user_id as wl_user_id, shop_product_variants.mainImage as image' )->where_in ( 'access', $access )->where ( 'mod_wish_list.hash', $hash )->where ( 'shop_products_i18n.locale', $locale )->where ( 'shop_product_variants_i18n.locale', $locale )->join ( 'mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id' )->join ( 'shop_product_variants', 'shop_product_variants.id=mod_wish_list_products.variant_id' )->join ( 'shop_product_variants_i18n', 'shop_product_variants_i18n.id=shop_product_variants.id' )->join ( 'shop_products', 'shop_products.id=shop_product_variants.product_id' )->join ( 'shop_products_i18n', 'shop_products_i18n.id=shop_products.id' )->get ( 'mod_wish_list' )->result_array ();
		
		if (! $query) {
			return $this->db->select ( '*, mod_wish_list.id AS `wish_list_id`' )->where_in ( 'mod_wish_list.access', $access )->where ( 'mod_wish_list_products.wish_list_id', NULL )->where ( 'mod_wish_list.hash', $hash )->join ( 'mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id', 'left' )->get ( 'mod_wish_list' )->result_array ();
		}
	...
	public function deleteItem($variant_id, $wish_list_id) {
		$this->db->delete ( 'mod_wish_list_products', array (
	...
	public function deleteItemsByIDs($ids) {
		return $this->db->where_in ( 'id', $ids )->delete ( 'mod_wish_list_products' );
	}
	...
	public function delWishListById($id) {
		$this->db->where_in ( 'id', $id )->delete ( 'mod_wish_list' );
	...
	public function getUserWishProducts($userID = null) {
		if (! $userID)
			$userID = $this->dx_auth->get_user_id ();
		$ID = array ();
		$ids = $this->db->where ( 'mod_wish_list.user_id', $userID )->join ( 'mod_wish_list_products', 'mod_wish_list_products.wish_list_id=mod_wish_list.id' )->group_by ( 'variant_id' )->get ( 'mod_wish_list' );
	...
	public function getAllUserWLs($userID = null) {
		...
		$ids = $this->db->where ( 'mod_wish_list.user_id', $userID )->get ( 'mod_wish_list' );
	...
	public function getMostPopularProducts($limit = 10) {
		$query = $this->db->select ( 'COUNT(id) as productCount, variant_id,' )->order_by ( 'productCount', 'desc' )->group_by ( 'variant_id' )->limit ( $limit )->get ( 'mod_wish_list_products' );
		if ($query)
	...
	public function insertWishList($title, $access, $user_id) {
		return $this->db->set ( 'title', $title )->set ( 'access', $access )->set ( 'user_id', $user_id )->insert ( 'mod_wish_list' );
	}
	...
	public function updateWishList($id, $data) {
		$this->db->where ( 'id', $id )->update ( 'mod_wish_list', $data );
	...
	public function insertUser($user_id, $user_image, $user_birthday, $user_name = null) {
		...
		return $this->db->set ( 'id', $user_id )->set ( 'user_name', $user_name )->set ( 'user_image', $user_image )->set ( 'user_birthday', $user_birthday )->insert ( 'mod_wish_list_users' );
	}
	...
	public function updateUser($userID, $user_name, $user_birthday, $description) {
		return $this->db->where ( 'id', $userID )->set ( 'user_name', $user_name )->set ( 'user_birthday', $user_birthday )->set ( 'description', $description )->update ( 'mod_wish_list_users' );
	}
	...
	public function updateWishListItem($varId, $wish_list_id, $data) {
		return $this->db->where ( 'wish_list_id', $wish_list_id )->where ( 'variant_id', $varId )->update ( 'mod_wish_list_products', $data );
	}
	...
	public function getUserWishListItemsCount($user_id) {
		$query = $this->db->where ( 'mod_wish_list.user_id', $user_id )->join ( "mod_wish_list_products", 'mod_wish_list_products.wish_list_id=mod_wish_list.id' )->get ( 'mod_wish_list' );
		if ($query) {
			return count ( $query->result_array () );
		} else
			return 0;
	...
	public function addReview($hash) {
		$count = $this->db->where ( 'hash', $hash )->select ( 'review_count' )->get ( 'mod_wish_list' )->row_array ();
		if (! $count)
			return FALSE;
		
		return $this->db->where ( 'hash', $hash )->set ( 'review_count', $count ['review_count'] + 1 )->update ( 'mod_wish_list' );
	}
	...
	public function setUserImage($userID, $file_name) {
		return $this->db->where ( 'id', $userID )->update ( 'mod_wish_list_users', array (
	...
	public function delUser($userID) {
		...
		$this->db->where ( 'id', $userID )->delete ( 'mod_wish_list_users' );
		return TRUE;
	}
	...
	public function install() {
		...
		$this->db->where ( 'identif', 'wishlist' )->update ( 'components', array (
