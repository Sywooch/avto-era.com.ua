...
class Admin extends BaseAdminController {
	...
	public function index() {
		...
		\CMSFactory\assetManager::create ()->setData ( 'settings', $this->wishlist_model->getSettings () )->setData ( 'users', $users )->renderAdmin ( 'users' );
	}
	...
	public function settings() {
		\CMSFactory\assetManager::create ()->setData ( 'settings', $this->wishlist_model->getSettings () )->renderAdmin ( 'main' );
	}
	...
	public function userWL($id) {
		...
		$this->session->set_userdata ( array (
				'admin_edit_user_id' => $id 
		) );
		$wishlist->getUserWL ( $id, array (
				'public',
				'shared',
				'private' 
		) );
		\CMSFactory\assetManager::create ()->registerScript ( 'wishlist' )->registerStyle ( 'style' )->setData ( 'wishlists', $wishlist->dataModel ['wishlists'] )->setData ( 'user', $wishlist->dataModel ['user'] )->setData ( 'settings', $wishlist->settings )->setData ( 'errors', $this->errors )->renderAdmin ( 'wishlist' );
	}
