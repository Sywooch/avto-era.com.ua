...
class WishlistApi extends \wishlist\classes\BaseApi {
	...
	public function renderPopupTpl($varId, $wish_list_id = '') {
		...
		return $popup = \CMSFactory\assetManager::create ()->registerStyle ( 'style' )->setData ( 'class', 'btn' )->setData ( 'wish_list_id', $wish_list_id )->setData ( 'varId', $varId )->setData ( $data )->setData ( 'max_lists_count', $this->settings ['maxListsCount'] )->render ( 'wishPopup', TRUE );
	}
	...
	public function renderEmail($wish_list_id) {
		\CMSFactory\assetManager::create ()->setData ( 'wish_list_id', $wish_list_id )->render ( 'sendEmail', TRUE );
	}
