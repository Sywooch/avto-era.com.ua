...
class Admin extends BaseAdminController {
	...
	public function insert_brands() {
		$data = $this->db_opencart->join ( 'manufacturer_description', 'manufacturer.manufacturer_id=manufacturer_description.manufacturer_id' )->order_by ( 'manufacturer.manufacturer_id' )->get ( 'manufacturer' );
		try {
			if ($data) {
				$data = $data->result_array ();
			} else {
	...
	public function insert_category() {
		$data = $this->db_opencart->join ( 'category_description', 'category.category_id=category_description.category_id' )->order_by ( 'category.category_id' )->get ( 'category' );
		try {
			if ($data) {
				$data = $data->result_array ();
			} else {
