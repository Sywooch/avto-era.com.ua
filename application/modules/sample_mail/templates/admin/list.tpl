<div class="container">
	...
	<div class="modal hide fade modal_del">
		...
		<div class="modal-footer">
			<a href="#" class="btn btn-primary"
				onclick="delete_function.deleteFunctionConfirm('/admin/components/cp/sample_mail/delete/')">Удалить</a>
	...
	<section class="mini-layout">
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">Просмотр
					списка шаблонов</span>
			</div>
			<div class="pull-right">
				...
				<div class="d-i_b">
					...
					<a class="btn btn-small btn-success pjax"
						href="/admin/components/cp/sample_mail/create"> <i
						class="icon-list-alt icon-white"></i>Создать шаблон
					</a>
				</div>
			</div>
		</div>
		<div class="tab-content">
						...
						<tbody class="sortable">
							...
							<tr>
								<td class="t-a_c"><span class="frame_label"> <span
										class="niceCheck b_n"> <input type="checkbox"
											name="ids" value="{echo $model.name}" />
									</span>
								</span></td>
								<td><a class="pjax"
									href="/admin/components/cp/sample_mail/edit/{echo $model.name}/{echo $locale}">{echo
										$model.name}</a></td>
								<td>
									<p>{echo $model.description}</p>
								</td> {$settings = unserialize($model.settings)}
			...
			{else:} </br>
			<div class="alert alert-info">Список шаблонов пустой</div>
			{/if}
		</div>
	</section>
</div>