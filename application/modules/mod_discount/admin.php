...
class Admin extends \ShopAdminController {
	function __construct() {
		...
		\CMSFactory\assetManager::create ()->registerStyle ( 'style' )->registerScript ( 'adminScripts' );
	}
	...
	public function index() {
		...
		$data = array (
				'discountsList' => $this->discount_model_admin->getDiscountsList ( $filterParam ) 
		);
		
		\CMSFactory\assetManager::create ()->setData ( $data )->renderAdmin ( 'list', true );
	}
	...
	public function create() {
		if ($this->input->post ()) {
			...
			\CMSFactory\assetManager::create ()->setData ( $data )->renderAdmin ( 'create' );
		}
	}
