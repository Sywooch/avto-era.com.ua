...
//                    $this->setOrderFailure();
    ...
    public function getForm($order = null) {
        ...
        $replace = array(
            ...
            'SUCCESS_URL' => shop_url('cart/view/' . $this->order->getKey() . '/?result=true&amp;pm=' . $this->paymentMethod->getId()),
    ...
    public function saveSettings(SPaymentMethods $paymentMethod) {
        ...
        $ci->form_validation->set_rules('PB_MERCHANT_ID', 'ID Мерчанта', 'trim|required|exact_length[5]');
