...
class OschadBankInvoiceSystem extends BasePaymentProcessor {
	...
	public function getAdminForm() {
		...
		<label class="control-label" for="inputRecCount">Отримувачa:</label>
		<div class="controls">
		...
		<div class="control-group">
		<label class="control-label" for="inputRecCount">Ідентифікаційний Код:</label>
		<div class="controls">
		<input type="text" name="bank[code]" value="' . $data ['code'] . '"  />
		<span class="help_text">Целое число. Максимальная длина 10 символов.</span>
		</div>
		</div>

		<div class="control-group">
		<label class="control-label" for="inputRecCount">Розрахунковий рахунок:</label>
		<div class="controls">
		<input type="text" name="bank[account]" value="' . $data ['account'] . '"  />
		<span class="help_text">Целое число. Максимальная длина 14 символов.</span>
		</div>
		</div>
		 
		<div class="control-group">
		<label class="control-label" for="inputRecCount">МФО банку:</label>
		<div class="controls">
		<input type="text" name="bank[mfo]" value="' . $data ['mfo'] . '"  />
		<span class="help_text">Целое число. Максимальная длина 6 символов.</span>
		</div>
		</div>

		 
		<div class="control-group">
		<label class="control-label" for="inputRecCount">Грошовий знак:</label>
		<div class="controls">
		<input type="text" name="bank[banknote]" value="' . $data ['banknote'] . '"  />
		<span class="help_text">Например: грн.</span>
		</div>
		</div>';
