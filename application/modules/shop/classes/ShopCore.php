...
class ShopCore {
	 ...
	 * @access public
	 * @param
	 *        	string translating message
	 * @param
	 *        	string category front|admin
	 * @param
	 *        	string lang file name without category prefix and extension sufix
	 * @param
	 *        	array params should be raplaced in message
	 * @param
	 *        	string	the language (en, ru) etc.
	 * @return string
	 */
