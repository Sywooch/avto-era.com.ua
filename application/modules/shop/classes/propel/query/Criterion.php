...
class Criterion {
	 ...
	 * For custom expressions with no binding, e.g.
	 * 'NOW() = 1'
	 *
	 * @param
	 *        	string &$sb The string that will receive the Prepared Statement
	...
	/**
	 * Appends a Prepared Statement representation of the Criterion onto the buffer
	 * For traditional expressions, e.g.
	...
	public function equals($obj) {
		...
		$isEquiv = ((($this->table === null && $crit->getTable () === null) || ($this->table !== null && $this->table === $crit->getTable ())) && $this->column === $crit->getColumn () && $this->comparison === $crit->getComparison ());
