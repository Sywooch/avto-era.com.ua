...
class Criteria implements IteratorAggregate {
	...
	/**
	 * Storage of aliased select data.
	 * Collection of column names.
	 * 
	 * @var array
	 */
	...
	/**
	 * Storage of select modifiers data.
	 * Collection of modifier names.
	 * 
	 * @var array
	 */
	...
	/**
	 * Storage of conditions data.
	 * Collection of Criterion objects.
	 * 
	 * @var array
	 */
	protected $map = array ();
	...
	/**
	 * Storage of join data.
	 * colleciton of Join objects.
	 * 
	 * @var array
	 */
	 ...
	 * can be reused as if it was new.
	 ...
	 *
	 * @param string $name
	 *        	Wanted Name of the column (alias).
	 * @param string $clause
	 ...
	 *
	 * @param string $column
	 *        	Full name of column (for example TABLE.COLUMN).
	 * @param mixed $value        	
	 ...
	 *
	 * @param string $critOrColumn
	 *        	The column to run the comparison on, or Criterion object.
	 * @param mixed $value        	
	 * @param string $comparison
	 *        	A String.
	 *        	
	 ...
	 *
	 * @param string $name
	 *        	name to combine the criterion later
	 * @param string $p1
	 *        	The column to run the comparison on, or Criterion object.
	 * @param mixed $value        	
	 * @param string $comparison
	 ...
	 *        	array of the name of the criterions to combine
	 * @param string $operator
	 *        	logical operator, either Criteria::LOGICAL_AND, or Criteria::LOGICAL_OR
	 * @param string $name
	 *        	optional name to combine the criterion later
	 */
	 ...
	 *
	 * @param mixed $left
	 *        	A String with the left side of the join.
	 * @param mixed $right
	 *        	A String with the right side of the join.
	 * @param mixed $joinType
	 *        	A String with the join operator
	 ...
	 *        	An array of conditions, each condition being an array (left, right, operator)
	 * @param string $joinType
	 *        	A String with the join operator. Defaults to an implicit join.
	 *        	
	 * @return Criteria A modified Criteria object.
	 */
	public function addMultipleJoin($conditions, $joinType = null) {
		...
		foreach ( $conditions as $condition ) {
			...
			if ($pos = strrpos ( $left, '.' )) {
				...
				list ( $leftTableName, $leftTableAlias ) = array (
						null,
						null 
				);
				$leftColumnName = $left;
			...
			if ($pos = strrpos ( $right, '.' )) {
				...
				list ( $rightTableName, $rightTableAlias ) = array (
						null,
						null 
				);
	...
	public function removeSelectModifier($modifier) {
		$this->selectModifiers = array_values ( array_diff ( $this->selectModifiers, array (
				$modifier 
		) ) );
	 ...
	 *
	 * @param boolean $b
	 *        	Set to TRUE if you expect the query to select just one record.
	 * @return Criteria Modified Criteria object (for fluent API)
	 */
	 ...
	 *
	 * @param int $offset
	 *        	An int with the value for offset. (Note this values is
	 ...
	 *        	The comment to add to the query, without comment sign
	 * @return Criteria Modified Criteria object (for fluent API)
	 */
	 ...
	 *
	 * @param mixed $p1
	 *        	A Criterion, or a SQL clause with a question mark placeholder, or a column name
	 * @param mixed $value
	 *        	The value to bind in the condition
	 * @param mixed $comparison
	 *        	A Criteria class constant, or a PDO::PARAM_ class constant
	 *        	
	 * @return Criterion
	 */
	 ...
	 * @see Criteria::add()
	 *
	 * @param string|Criterion $p1
	 *        	The column to run the comparison on (e.g. BookPeer::ID), or Criterion object
	 * @param mixed $value        	
	 * @param string $operator
	 *        	A String, like Criteria::EQUAL.
	 * @param boolean $preferColumnCondition
	 *        	If true, the condition is combined with an existing condition on the same column
