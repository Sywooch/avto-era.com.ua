...
class Join {
	 ...
	 *        	The type of the join. Valid join types are null (implicit join),
	 ...
	 *        	The comparison operator of the join condition, default Join::EQUAL
	 */
	 ...
	 *
	 * @param array $lefts
	 *        	The left columns of the join condition
	 * @param array $rights
	 *        	The right columns of the join condition
	 * @param array $operators
	 *        	The comparison operators of the join condition, default Join::EQUAL
	 */
	 ...
	 *          </code>
	 * @param string $left
	 *        	The name of the left column to add
	 */
	 ...
	 *          </code>
	 * @param integer $index
	 *        	The number of the condition to use
	 * @return string
	 */
	 ...
	 *          </code>
	 * @param string $right
	 *        	The name of the right column to add
	 */
	 ...
	 *
	 * @param Criteria $c
	 *        	A Criteria object to get Criterions from
	 */
