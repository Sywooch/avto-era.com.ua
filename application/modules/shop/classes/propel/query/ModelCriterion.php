...
class ModelCriterion extends Criterion {
	 ...
	 *
	 * @param Criteria $parent
	 *        	The outer class (this is an "inner" class).
	 * @param ColumnMap $column
	 *        	A Column object to help escaping the value
	 * @param mixed $value        	
	 * @param string $comparison,
	 *        	among ModelCriteria::MODEL_CLAUSE
	 * @param string $clause
	 *        	A simple pseudo-SQL clause, e.g. 'foo.BAR LIKE ?'
	 */
	 ...
	 *
	 * @param
	 *        	string &$sb The string that will receive the Prepared Statement
	 * @param array $params
	 *        	A list to which Prepared Statement parameters will be appended
	 */
	...
	/**
	 * Appends a Prepared Statement representation of the ModelCriterion onto the buffer
	 * For IN or NOT IN model clauses, e.g.
	 * 'book.TITLE NOT IN ?'
	 *
	 * @param
	 *        	string &$sb The string that will receive the Prepared Statement
	 ...
	 * For custom expressions with a typed binding, e.g.
	 * 'foobar = ?'
	 *
	 * @param
	 *        	string &$sb The string that will receive the Prepared Statement
	...
	public function equals($obj) {
		...
		$isEquiv = ((($this->table === null && $crit->getTable () === null) || ($this->table !== null && $this->table === $crit->getTable ())) && $this->clause === $crit->getClause () && $this->column === $crit->getColumn () && $this->comparison === $crit->getComparison ());
