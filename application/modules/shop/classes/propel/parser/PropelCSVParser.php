...
class PropelCSVParser extends PropelParser {
	 ...
	 *        	Whether the input data contains more than one row
	 * @param boolean $includeHeading
	 *        	Whether the output should contain a heading line
	 *        	
	 ...
	 *
	 * @param array $row
	 *        	of data to be formatted for output to the file
	 ...
	 *
	 * @param string $input
	 *        	single value to be escaped for output
	 * @return string input value
	 */
	protected function escape($input) {
		return str_replace ( $this->quotechar, $this->escapechar . $this->quotechar, $input );
	}
	 ...
	 *
	 * @param string $input
	 *        	single value to be quoted for output
	 * @return string input value
	 */
	 ...
	 *
	 * @param string $input
	 *        	single value to be checked for special characters
	 * @return boolean if contains any special characters
	 */
	 ...
	 *
	 * @param string $data
	 *        	Source data to convert, as a CSV string
	 * @param boolean $isList
	 *        	Whether the input data contains more than one row
	 * @param boolean $includeHeading
	 *        	Whether the input contains a heading line
	 *        	
	 ...
	 *
	 * @param
	 *        	array An array of data from a CSV output
	...
	protected function unescape($input) {
		return str_replace ( $this->escapechar . $this->quotechar, $this->quotechar, $input );
	}
