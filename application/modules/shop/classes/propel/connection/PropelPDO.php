...
class PropelPDO extends PDO {
	 ...
	 *
	 * @param integer $attribute
	 *        	The attribute to get (e.g. PropelPDO::PROPEL_ATTR_CACHE_PREPARES).
	 * @return mixed
	 */
	 ...
	 *        	Whether to suppress an exception if the statement class cannot be set.
	 *        	
	 ...
	 *
	 * @param integer $level
	 *        	Value of one of the Propel::LOG_* class constants.
	 */
	 ...
	 *        	A Logger with an API compatible with BasicLogger (or PEAR Log).
	 */
	 ...
	 *        	Message to log.
	 * @param integer $level
	 *        	Log level to use; will use self::setLogLevel() specified level by default.
	 * @param string $methodName
	 *        	Name of the method whose execution is being logged.
	 ...
	 * 'debugpdo.logging' prefix.
	 * If such a configuration setting hasn't been set, the given default
	 * value will be returned.
	 *
	 * @param string $key
	 *        	Key for which to return the value.
	 * @param mixed $defaultValue
	 *        	Default value to apply if config item hasn't been set.
	 *        	
	 * @return mixed
	 */
	 ...
	 *        	Name of the method whose execution is being logged.
	 * @param array $debugSnapshot
	 *        	A previous return value from self::getDebugSnapshot().
	 *        	
	 * @return string
	 */
