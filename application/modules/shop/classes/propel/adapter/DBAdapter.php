...
abstract class DBAdapter {
	 ...
	 *
	 * @param string $driver
	 *        	The name of the Propel driver to create a new adapter instance
	 ...
	 *
	 * @param PDO $con
	 *        	A $PDO PDO connection instance.
	 * @param string $charset
	 *        	The $string charset encoding.
	 */
	 ...
	 * This doesn't take care of dots which separate schema names from table names.
	 * Adapters for RDBMs which support
	 * schemas have to implement that in the platform-specific way.
	 *
	 * @param string $table
	 *        	The table name to quo
	 ...
	 *        	The temporal value
	 * @param mixed $type
	 *        	PropelColumnTypes constant, or ColumnMap object
	 *        	
	 ...
	 *
	 * @param mixed $seed
	 *        	(optional) seed value for databases that support this
	 */
	 ...
	 * taking into account select columns and 'as' columns (i.e.
	 * columns aliases)
	...
	public function createSelectSqlPart(Criteria $criteria, &$fromClause, $aliasAll = false) {
		...
		$sql = "SELECT " . ($queryComment ? '/* ' . $queryComment . ' */ ' : '') . ($selectModifiers ? (implode ( ' ', $selectModifiers ) . ' ') : '') . implode ( ", ", $selectClause );
	 ...
	 *        	The ColumnMap of the column to bind
	 * @param null|integer $position
	 *        	The position of the parameter to bind
	 *        	
	 * @return boolean
	 */
