...
interface NodePeer {
	 ...
	 *
	 * @param int $scopeId
	 *        	id to determine which root node to return
	 * @param PropelPDO $con
	 *        	to use.
	 * @return object object for root node
	 */
	 ...
	 *
	 * @param object $child
	 *        	object for child node
	 * @param object $parent
	 *        	object for parent node
	 * @param PropelPDO $con
	 *        	to use.
	 * @return void
	 */
	 ...
	 *
	 * @param object $node
	 *        	object for destination node
	 * @param object $sibling
	 *        	object for source node
	 * @param PropelPDO $con
	 *        	to use.
	 * @return void
	 */
	 ...
	 *
	 * @param object $parent
	 *        	Propel object for given parent node
	 * @param object $node
	 *        	Propel object for given destination node
	 * @param PropelPDO $con
	 *        	to use.
	 * @return void
	 ...
	 *
	 * @param int $scopeId
	 *        	id to determine which root node to delete
	 * @param PropelPDO $con
	 *        	to use.
	 ...
	 *
	 * @param int $scopeId
	 *        	id to determine which scope tree to return
	 * @param PropelPDO $con
	 *        	to use.
	 */
	 ...
	 *
	 * @param object $node
	 *        	object of node to create path to
	 * @param PropelPDO $con
	 *        	to use.
	 ...
	 *        	key/instance of required node
	 * @param PropelPDO $con
	 *        	to use.
	 * @return object object for model
	 */
