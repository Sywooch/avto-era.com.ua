...
class PropelPager implements Countable, Iterator {
	 ...
	 *        	The name of the static Peer class.
	 * @param string $peerSelectMethod
	 *        	The name of the static method for selecting content from the Peer class.
	 * @param int $page
	 *        	The current page (1-based).
	 * @param int $rowsPerPage
	 *        	The number of rows that should be displayed per page.
	 */
	 ...
	 * 
	 * @param string $method
	 *        	The name of the static method to call on the Peer class.
	 * @return void
	...
	public function getTotalRecordCount() {
		...
		if (empty ( $this->recordCount )) {
			...
			$this->recordCount = call_user_func ( array (
					$this->getPeerClass (),
