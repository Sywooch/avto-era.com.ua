...
", $namespace, $class );
	 ...
	 *
	 * @param Column $col
	 *        	The column we need a name for.
	 * @param string $classname
	 *        	The Peer classname to use.
	 *        	
	 ...
	 *
	 * @param ForeignKey $fk
	 *        	The local FK that we need a name for.
	 * @param boolean $plural
	 *        	Whether the php name should be plural (e.g. initRelatedObjs() vs. addRelatedObj()
	 * @return string
	 */
	 ...
	 *
	 * @param ForeignKey $fk
	 *        	The referrer FK that we need a name for.
	 * @param boolean $plural
	 *        	Whether the php name should be plural (e.g. initRelatedObjs() vs. addRelatedObj()
	 * @return string
	 */
	 ...
	 *        	The name of the hook as called from one of this class methods, e.g. "preSave"
	 * @param string $modifier
	 *        	The name of the modifier object providing the method in the behavior
	 * @return boolean
	 */
...
";
	 ...
	 *        	The name of the content as called from one of this class methods, e.g. "parentClassname"
	 * @param string $modifier
	 *        	The name of the modifier object providing the method in the behavior
	 */
