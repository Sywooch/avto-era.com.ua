...
abstract class DataModelBuilder {
	...
	/**
	 * An array of warning messages that can be retrieved for display (e.g.
	 * as part of phing build process).
	 * 
	 * @var array string[]
	 */
	 ...
	 * 
	 * @param Table $table
	 *        	The Table which we are using to build [OM, DDL, etc.].
	 */
