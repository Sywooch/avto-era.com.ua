...
abstract class PeerBuilder extends OMBuilder {
	...
	/**
	 * Adds the addSelectColumns(), doCount(), etc.
	 * methods.
	 * 
	 * @param
	...
	/**
	 * Adds the doInsert(), doUpdate(), doDeleteAll(), doValidate(), etc.
	 * methods.
	 * 
	 * @param
	 *        	string &$script The script will be modified in this method.
	 ...
	 *        	The PHP Name of the peer class. The 'Peer' is appended automatically.
	 *        	
