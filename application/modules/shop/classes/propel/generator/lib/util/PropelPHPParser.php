...
class PropelPHPParser {
	 ...
	 * @param string $code
	 *        	PHP code to parse
	 * @param boolean $isAddPhp
	 *        	Whether the supplied code needs a supplementary '<?php '
	 ...
	 *        	The name of the method to find, e.g. 'getAuthor'
	 *        	
	 ...
	 *        	The code to use in place of the old method definition
	 *        	
	 * @return mixed false if not found, or the method code string if found
	 */
