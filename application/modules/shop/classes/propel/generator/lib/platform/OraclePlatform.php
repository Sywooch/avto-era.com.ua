...
";
	...
	public function getPrimaryKeyDDL(Table $table) {
		if ($table->hasPrimaryKey ()) {
			...
			return sprintf ( $pattern, $this->quoteIdentifier ( $this->getPrimaryKeyName ( $table ) ), $this->getColumnListDDL ( $table->getPrimaryKey () ), $this->generateBlockStorage ( $table, true ) );
		}
	}
	 ...
	 *
	 * @param Table|Index $object
	 *        	object with vendor parameters
	 * @param bool $isPrimaryKey
	 *        	is a primary key vendor part
	 *        	
...
%s = \$row[0];";
		$script = sprintf ( $snippet, $connectionVariableName, $sequenceName, $columnValueMutator );
