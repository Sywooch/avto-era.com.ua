...
class PropelSchemaReverseTask extends PDOTask {
	 ...
	 *
	 * @param string $v
	 *        	The comma-separated list of which validators to add.
	 * @return void
	 */
	 ...
	 * @param string $type
	 *        	The type (string) for validator (e.g. 'required').
	 * @param mixed $value
	 *        	The value for the validator (if applicable)
	 */
