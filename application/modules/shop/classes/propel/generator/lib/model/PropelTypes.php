...
class PropelTypes {
	 ...
	 * Creole type provided.
	 * Use in the base object class generation.
	 *
	 * @param $propelType The
	 *        	Propel type name.
	...
	public static function isPhpObjectType($phpType) {
		return (! self::isPhpPrimitiveType ( $phpType ) && ! in_array ( $phpType, array (
				"resource",
				"array" 
		) ));
	}
