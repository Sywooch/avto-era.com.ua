...
class Table extends ScopedElement implements IDMethod {
	...
	/**
	 * ID method for the table (e.g.
	 * IDMethod::NATIVE, IDMethod::NONE).
	 *
	 * @var string
	 */
	private $idMethod;
	 ...
	 * if schemaAutoPrefix is set.
	 * Otherwise get the common name.
	 * 
	 * @return string
	 */
	...
	public function addExtraIndices() {
		/**
		 * A collection of indexed columns.
		 * The keys is the column name
	 ...
	 * @param array $columns
	 *        	The column names or objects
	 * @param array $collectedIndexes
	 *        	The collected indexes
	 */
	protected function collectIndexedColumns($indexName, $columns, &$collectedIndexes) {
		/**
		 * "If the table has a multiple-column index, any leftmost prefix of the
		 * index can be used by the optimizer to find rows.
		 * For example, if you
	 ...
	 * @param
	 *        	array Column[] or string[]
	 * @param string $delim
	 *        	The delimiter to use in separating the column names.
	 * @return string
	 */
	 ...
	 *
	 * @param $coldata xml
	 *        	attributes or Column class for the column to add
	 ...
	 *
	 * @param mixed $data
	 *        	Validator object or XML attribs (array) from <validator /> element.
	 ...
	 *
	 * @param
	 *        	string the name of the column bearing a validator
	 */
	...
	public function buildPhpName($name) {
		return NameFactory::generateName ( NameFactory::PHP_GENERATOR, array (
				$name,
				$this->phpNamingMethod 
		) );
	}
	 ...
	 *
	 * @param string $defaultStringFormat
	 ...
	 * class that is generated as being abstract.
	 * If you have a
	 ...
	 * 
	 * @param Column|string $col
	 *        	the column object or name (e.g. 'my_column')
	 * @param boolean $caseInsensitive
	 *        	Whether the check is case insensitive. False by default.
	 *        	
	 * @return boolean
	 */
