...
class Index extends XMLElement {
	...
	public function hasColumnAtPosition($pos, $name, $size = null, $caseInsensitive = false) {
		...
		$test = $caseInsensitive ? strtolower ( $this->indexColumns [$pos] ) != strtolower ( $name ) : $this->indexColumns [$pos] != $name;
		if ($test) {
			return false;
		}
