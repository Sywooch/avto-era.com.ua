...
class ColumnDefaultValue {
	 ...
	 *
	 * @param string $value
	 *        	The default value, as specified in the schema.
	 * @param string $type
	 *        	The type of default value (DefaultValue::TYPE_VALUE or DefaultValue::TYPE_EXPR)
	 */
	 ...
	 *
	 * @param string $value
	 *        	The value, as specified in the schema.
	 */
	 ...
	 *
	 * @param ColumnDefaultValue $other
