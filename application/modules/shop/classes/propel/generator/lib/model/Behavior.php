...
class Behavior extends XMLElement {
	 ...
	 *
	 * @param Table $table
	 *        	the table this behavior is applied to
	 */
	 ...
	 *        	the database this behavior is applied to
	 */
	 ...
	 *
	 * @param
	 *        	array associative array with name and value keys
	 */
	 ...
	 *        	The template file name, relative to the behavior's dirname
	 * @param array $vars
	 *        	An associative array of argumens to be rendered
	 * @param string $templateDir
	 *        	The name of the template subdirectory
	 *        	
	 ...
	 *
	 * @param string $param
	 *        	Name of the parameter storing the column name
