...
class ColumnMap {
	 ...
	 *        	The name of the column.
	 * @param
	 *        	TableMap containingTable TableMap of the table this column is in.
	 */
	 ...
	 *        	A string representing the PHP name.
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	boolean nn True if column may be null.
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string tableName The name of the table that is foreign.
	 * @param
	 *        	string columnName The name of the column that is foreign.
	 * @return void
	 */
	 ...
	 * 
	 * @param string $str
	 *        	The expression we want to apply the ignore case formatting to (e.g. the column name).
	 * @param DBAdapter $db        	
	 */
