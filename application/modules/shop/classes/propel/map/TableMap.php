...
class TableMap {
	 ...
	 *
	 * @param $pkInfo information
	 *        	needed to generate a key
	 */
	 ...
	 *
	 * @param
	 *        	string name A String with the column name.
	 * @param string $type
	 *        	A string specifying the Propel type.
	 * @param boolean $isNotNull
	 *        	Whether column does not allow NULL values.
	 * @param int $size
	 *        	An int specifying the size.
	 * @param boolean $pk
	 *        	True if column is a primary key.
	 * @param string $fkTable
	 *        	A String with the foreign key table name.
	 * @param $fkColumn A
	 *        	String with the foreign key column name.
	 ...
	 *
	 * @param mixed $name
	 *        	name of the column or ColumnMap instance
	 * @param boolean $normalize
	 *        	Normalize the column name (if column name not like FIRST_NAME)
	 ...
	 *        	A String with the foreign key column name.
	 * @param boolean $isNotNull
	 *        	Whether column does not allow NULL values.
	 * @param int $size
	 *        	An int specifying the size.
	 ...
	 *
	 * @param string $columnName
	 *        	The name of the validator's column
	 * @param string $name
	 *        	The rule name of this validator
	 * @param string $classname
	 *        	The dot-path name of class to use (e.g. myapp.propel.MyValidator)
	 * @param string $value        	
	 * @param string $message
	 *        	The error message which is returned on invalid values
	 * @return void
	 */
	 ...
	 * @param integer $type
	 *        	The relation type (either RelationMap::MANY_TO_ONE, RelationMap::ONE_TO_MANY, or RelationMAp::ONE_TO_ONE)
	 * @param array $columnMapping
	 *        	An associative array mapping column names (local => foreign)
	 * @param string $onDelete
	 *        	SQL behavior upon deletion ('SET NULL', 'CASCADE', ...)
	 * @param string $onUpdate
	 *        	SQL behavior upon update ('SET NULL', 'CASCADE', ...)
	 * @param string $pluralName
	 *        	Optional plural name for *_TO_MANY relationships
