...
abstract class PropelFormatter {
	protected $dbName, $class, $peer, $with = array (), $asColumns = array (), $hasLimit = false, $currentObjects = array ();
	 ...
	 *
	 * @param int $col
	 *        	Offset of the object in the list of objects to hydrate
	 * @param string $class
	 *        	Propel model object class
	 *        	
	 * @return BaseObject
	 */
	 ...
	 *
	 * @param array $row
	 *        	associative array indexed by column number,
	 *        	as returned by PDOStatement::fetch(PDO::FETCH_NUM)
	 * @param string $class
	 *        	The classname of the object to create
	 * @param int $col
	 *        	The start column for the hydration (modified)
	 *        	
	 * @return BaseObject
	 */
