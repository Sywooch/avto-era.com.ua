...
class Propel {
	 ...
	 *
	 * @param
	 *        	string Path (absolute or relative to include_path) to config file.
	 *        	
	 ...
	 *
	 * @param string $c
	 *        	The Propel configuration file path.
	 *        	
	 * @throws PropelException Any exceptions caught during processing will be
	 *         rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param
	 *        	int - PropelConfiguration::TYPE_ARRAY: return the configuration as an array
	 ...
	 *
	 * @param
	 *        	object The new logger to use. ([PEAR] Log or BasicLogger)
	 */
	 ...
	 *
	 * @param
	 *        	string The message that will be logged.
	 * @param
	 ...
	 *
	 * @param
	 *        	string The name of the database corresponding to the DatabaseMap to retrieve.
	 *        	
	 ...
	 * @param string $name
	 *        	The datasource name.
	 * @param DatabaseMap $map
	 *        	The database map object to use for specified datasource.
	 */
	 ...
	 *
	 * @param string $name
	 *        	The datasource name for the connection being set.
	 * @param PropelPDO $con
	 *        	The PDO connection.
	 * @param string $mode
	 *        	Whether this is a READ or WRITE connection (Propel::CONNECTION_READ, Propel::CONNECTION_WRITE)
	 */
	 ...
	 *
	 * @param string $name
	 *        	The datasource name that is used to look up the DSN from the runtime configuation file.
	 * @param string $mode
	 *        	The connection mode (this applies to replication systems).
	 *        	
	 ...
	 *
	 * @param string $name
	 *        	The datasource name that is used to look up the DSN
	 ...
	 *        	The PDO subclass to instantiate if there is no explicit classname
	 ...
	 *
	 * @param
	 *        	array Where to find the list of constant flags and their new setting.
	 * @param
	 *        	array Put the data into here
	 *        	
	 ...
	 *        	The DBAdapter implementation to use.
	 */
	 ...
	 *
	 * @param
	 *        	string The class name needing loading.
	 *        	
	 ...
	 *
	 * @param string $class
	 *        	dot-path to clas (e.g. path.to.my.ClassName).
