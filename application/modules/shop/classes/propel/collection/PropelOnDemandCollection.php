...
class PropelOnDemandCollection extends PropelCollection {
	 ...
	 */
	protected $iterator;
	protected $currentRow, $currentKey = - 1, $isValid = null;
	 ...
	 *        	If null, the returned array uses an incremental index.
	 *        	Otherwise, the array is indexed using the specified column
	 * @param boolean $usePrefix
	 *        	If true, the returned array prefixes keys
	 *        	with the model class name ('Article_0', 'Article_1', etc).
	 * @param string $keyType
	 *        	(optional) One of the class type constants BasePeer::TYPE_PHPNAME,
	 ...
	 * Warning: this number is inaccurate for most databases.
