...
class PropelCollection extends ArrayObject implements Serializable {
	 ...
	 *        	Propel collection.
	 * @return PropelCollection array of Propel objects from the collection that are not presents in the given collection.
	 */
	 ...
	 *
	 * @param string $model
	 *        	Name of the Propel object classes stored in the collection
	 */
	 ...
	 *
	 * @param string $type
	 *        	The connection type (Propel::CONNECTION_READ by default; can be Propel::connection_WRITE)
	 ...
	 *
	 * @param mixed $parser
	 *        	A PropelParser instance, or a format name ('XML', 'YAML', 'JSON', 'CSV')
	 * @param string $data
	 ...
	 *        	(optional) If true, the returned element keys will be prefixed with the
