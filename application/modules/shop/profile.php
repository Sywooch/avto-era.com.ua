...
class Profile extends \Profile\BaseProfile {
	...
	public function index() {
		...
		if ($this->uri->uri_string () == 'shop/profile/profile_change_pass') {
			$this->profileChangePass ();
		}
		if ($this->uri->uri_string () == 'shop/profile/profile_data') {
			$this->profileData ();
		}
		if ($this->uri->uri_string () == 'shop/profile/profile_history') {
			$this->profileHistory ();
		}
