...
class Wheels extends ShopController {
	...
	private function runProductUpdateQuery($pid,$vid,$line){
		...
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 58,'product_id' => $pid));

		$data = array('value' =>  $line[4]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 59,'product_id' => $pid));

		$data = array('value' =>  $line[5]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 60,'product_id' => $pid));

		$data = array('value' =>  $line[6]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 61,'product_id' => $pid));

		$data = array('value' =>  $line[7]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 62,'product_id' => $pid));

		$data = array('value' =>  $line[8]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 63,'product_id' => $pid));

		$data = array('value' =>  $line[9]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 64,'product_id' => $pid));

		$data = array('value' =>  $line[10]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 65,'product_id' => $pid));

		$data = array('value' =>  $line[11]) ;
		$this->db->update('shop_product_properties_data', $data, array('property_id' => 66,'product_id' => $pid));
