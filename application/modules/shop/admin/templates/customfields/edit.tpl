...
{$entities = array('user'=>'<i class="icon-user"></i> '.lang('One user','admin'), 'order'=>'<i class="icon-shopping-cart"></i> '.lang('Order','admin'))}
<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="/admin/components/run/shop/customfields" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                            ...
                            <form id="update" method="post" action="">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="fLabel" id="fLabel" value="{echo ShopCore::encode($model->getfieldlabel())}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <span class="frame_label no_connection">
                                                ...
                                                {lang('Field','admin')} {lang('Required','admin')}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                            ...
                                            <span class="frame_label no_connection">
                                                <span class="niceCheck b_n">
                                                    <input type="checkbox" id="private" name="is_private" {if  ShopCore::encode($model->getIsPrivate()) == 1 } checked="checked" {/if}/>
                                                           ...
                                                           {lang('Field','admin')} {lang('Private','admin')}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" >
                                            <span class="popover_ref" data-title="<b>Custom classes</b>">                                                                    
                                                <i class="icon-info-sign"></i>
                                            </span>
                                            <div class="d_n">
                                                Your custom classes for form widget
                                            </div>
                                            <span>Classes:</span>
                                        </label>
                                        <div class="controls">
