		...
		<div class="pull-right">
			<div class="d-i_b">
				...
				<button type="button" class="btn btn-small btn-success formSubmit"
					data-form="#create" data-action="edit" data-submit>
					...
					<div class="inside_padd">
						<div class="form-horizontal">
							<form id="create" method="post"
								active="{$ADMIN_URL}customfields/create">
								<div class="span12">
									<div class="control-group">
										...
										<div class="controls">
											<select name="Entity" id="Entity_select">
												...
												<option value="user_order">{lang('Users','admin')},
													{lang('Orders ','admin')}</option>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="name" value="" id="inputName"
												class="required" /> <span class="help-block">{lang('The
												field should only contain letters without numbers','admin')}</span>
										</div>
									</div>

									<div class="control-group">
										<label class="control-label" for="inputLabel">{lang('Label','admin')}:</label>
										<div class="controls">
											<input type="text" name="fLabel" id="inputLabel"
												class="required" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="description" value="" class="elRTE"
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="frame_label no_connection"> <span
												class="niceCheck b_n"> <input type="checkbox"
													name="is_active" class="" checked="checked" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="frame_label no_connection"> <span
												class="niceCheck b_n"> <input type="checkbox"
													name="is_private" id="inputPrivate" />
											</span> {lang('Field','admin')} {lang('Private','admin')}
											</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="type_select">{lang('Field
											type','admin')}:</label>
										<div class="controls">
									...
									<div class="control-group" id="possVal" style="display: none;">
										<label class="control-label" for="inputPV">{lang('Possible
											values','admin')}:</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label"> <span
											class="popover_ref"
											data-title="<b>{lang('Classes', 'admin')}</b>"> <i
												class="icon-info-sign"></i>
										</span>
											<div class="d_n">{lang('Custom classes for widget',
												'admin')}</div> <span>{lang('Classes', 'admin')}:</span>
										</label>
										<div class="controls">
