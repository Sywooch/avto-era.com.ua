		...
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">{lang('Editing
					by discounts','admin')}</span>
			</div>
			<div class="pull-right">
				<div class="d-i_b">
					<a href="/admin/components/run/shop/comulativ/allusers"
						...
						<td colspan="6">
							<div class="inside_padd">
								<div class="form-horizontal">
									<div class="row-fluid">
										{foreach $user as $u}
										<form id="comUserUpdate" method="post"
											active="{$ADMIN_URL}comulativ/user/{$u['user_id']}">
											<div class="control-group">
												<label class="control-label" for="inputRecCount">{lang('Full
													name','admin')}</label>
												<div class="controls">
													<input type="text" readonly="readonly" disabled="disabled"
														value="{echo encode($u['username'])}" />
												</div>
											</div>
											...
											<div class="control-group">
												<label class="control-label" for="inputRecCount">{lang('Purchase
													price','admin')}:</label>
												<div class="controls">
													<input type="text" readonly="readonly" disabled="disabled"
														value="{$u['amout']}" />
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="discount" id="discount"
														value="{$u['discount']}" /> <span class="help-block">{lang('Off
														manually entered','admin')} </span>
												</div>
											</div>
											{/foreach}
									</div>
