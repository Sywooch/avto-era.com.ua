    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#discountUpdate" data-action="close" data-submit><i class="icon-ok icon-white"></i>{lang('Save','admin')}</button>
                <button type="button" class="btn btn-small action_on formSubmit" data-form="#discountUpdate" data-action="exit"><i class="icon-check"></i>{lang('Save and exit','admin')}</button>                    
            </div>
        </div>                            
    </div>
                ...
                <td colspan="6">
                    <div class="inside_padd">
                        <div class="form-horizontal">
                            <form id="discountUpdate" method="post" active="{$ADMIN_URL}discounts/edit/{$model->getId()}">
                                <div class="span9">
                                    <div class="control-group">
                                        <label class="control-label" for="Name">{lang('Name','admin')}</label>
                                        <div class="controls">
                                            <input type="text" name="Name" id="Name" value="{echo encode($model->getName())}" required/>
                                        </div>
                                    </div>
                                ...
                                <div class="span9">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="p_r input-small">
                                                <input id="DateStart" name="DateStart" value="{echo date('m/d/Y',encode($model->getDateStart()))}" type="text" data-placement="top"  data-rel="tooltip" class="datepicker input-small" required/><i class="icon-calendar"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="p_r input-small">
                                                <input id="DateStop" name="DateStop" value="{echo date('m/d/Y',encode($model->getDateStop()))}" type="text" data-placement="top" data-rel="tooltip" class="datepicker input-small" required/> <i class="icon-calendar"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls number">
                                            <input type="text" name="Discount" id="Discount" value="{echo encode($model->getDiscount())}" data-max="100" required/>
                                        ...
                                        <div class="controls">
                                            <select name="Categories[]" id="Categories[]" multiple="multiple">
                                                ...
                                                {foreach $categoriesTree as $category}
                                                    {$selected=''}
                                                    {if in_array($category->getId(), $categoryId)}
                                    ...
                                    <div class="control-group">
                                    <label class="control-label" for="Products">{lang('Enter a product for discount','admin')}:</label>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="shopProductDiscount">{lang('Selected products:','admin')}</label>
                                        <div class="controls">
                                            <input type="text" name="Products" id="shopProductDiscount" value="{echo encode($model->getProducts())}" />
                                        ...
                                        <div class="controls">
                                            ...
                                            {else:}                           
                                                ...
                                                {foreach $roles as $key => $r}
                                                    <span class="frame_label no_connection">
                                                        <span class="niceCheck b_n">
                                                            <input name="roles[]"  id="rolesan"{if isset($userGroup)}{if in_array($r['id'], $userGroup)} checked="checked" {/if} {/if}value="{echo $r['id']}" type="checkbox"/>
                                                        </span>
                                                        {encode($r.alt_name)}
                                                    </span>
                                                    <br/>
