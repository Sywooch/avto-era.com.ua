	...
	<div class="modal hide fade modal_del">
		...
		<div class="modal-footer">
			<a href="#" class="btn btn-primary"
				onclick="delete_function.deleteFunctionConfirm('{$ADMIN_URL}discounts/deleteAll')">{lang('Delete','admin')}</a>
			<a href="#" class="btn" onclick="$('.modal').modal('hide');">{lang('Cancel','admin')}</a>
		</div>
	</div>


	<div id="delete_dialog" title="{lang('Removing discounts','admin')}"
		style="display: none">{lang('Remove the discount?','admin')}</div>
	<!-- ---------------------------------------------------Блок видалення---------------------------------------------------- -->
	<section class="mini-layout">
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">{lang('List
					of permanent discounts','admin')}</span>
			</div>
			<div class="pull-right">
				<div class="d-i_b">
					<a class="btn btn-small btn-primary pjax"
						href="/admin/components/run/shop/comulativ/allusers"><i
						class="icon-plus-sign icon-white"></i>{lang('Deposit
						rates','admin')}</a> <a class="btn btn-small btn-success pjax"
						href="/admin/components/run/shop/discounts/create"><i
				...
				<table
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="{$ADMIN_URL}discounts/edit/{echo $c->getId()}"
								data-rel="tooltip" data-title="{lang('Editing','admin')}"
								class="pjax">{echo ShopCore::encode($c->getName())}</a></td>
							...
							<td>
								<div class="frame_prod-on_off" data-rel="tooltip"
									...
									onclick="change_status('{$ADMIN_URL}discounts/change_discount_status/{echo $c->getId()}');">
									<span
										class="prod-on_off {if $c->getActive() == NULL}disable_tovar{/if}"
										style=""></span>
								</div>
							</td>
						</tr>
