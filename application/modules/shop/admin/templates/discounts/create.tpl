<section class="mini-layout">
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title">{lang('Create','admin')}
				{lang('Discounts','admin')}</span>
		</div>
	...
	<table
		...
		<thead>
			<tr>
				<th colspan="6">{lang('Payment method create','admin')}</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td colspan="6">
					<div class="inside_padd span9">
						<div class="form-horizontal">
							<form id="createDiscount" method="post"
								active="{$ADMIN_URL}discounts/create">
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="p_r input-small">
											<input name="DateStart" id="DateStart" value="" type="text"
												data-placement="top"
												data-original-title="{lang('choose a date','admin')}"
												data-rel="tooltip" class="datepicker" required /><i
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="p_r input-small">
											<input name="DateStop" id="DateStop" value="" type="text"
												data-placement="top"
												data-original-title="{lang('choose a date','admin')}"
												data-rel="tooltip" class="datepicker" required /> <i
												class="icon-calendar"></i>
								...
								<div class="control-group">
									...
									<div class="controls number">
										<input type="text" name="Discount" id="Discount" value=""
											required data-max="100" /> <span class="help-block">
											{lang(' Number greater than zero. To use a percent discount
											apply : "SUM" format.','admin')}</span>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<select name="Categories[]" multiple="multiple"
											id="Categories" style="width: 285px; height: 129px;">
								...
								<div class="control-group">
									<label class="control-label" for="Products">{lang('Enter
										a product for promotion','admin')}:</label>
								...
								<div class="control-group">
									<label class="control-label" for="Products">{lang('Selected
										products:','admin')}</label>
									<div class="controls">
										<input type="text" name="Products" id="Products" value=""
											class="textbox_long" /> <span class="help-block">{lang('Follow
											product ID by a comma.','admin')}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										users','admin')} {else:} <span
											...
											class="frame_label no_connection"> <span
											class="niceCheck b_n"> <input name="roles[]"
												id="rolesan" value="{echo $r['id']}" type="checkbox" />
