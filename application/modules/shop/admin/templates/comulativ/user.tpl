    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/components/run/shop/comulativ/allusers" class="t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                    <button type="button" class="btn btn-small btn-success formSubmit" data-action="edit" data-form="#comUserUpdate" ><i class="icon-plus-sign icon-white"></i>{lang('Save','admin')}</button>
