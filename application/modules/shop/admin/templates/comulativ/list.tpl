...
<div class="modal hide fade modal_del">
	...
	<div class="modal-footer">
		<a href="#" class="btn btn-primary"
			onclick="delete_function.deleteFunctionConfirm('{$ADMIN_URL}comulativ/deleteAll')">{lang('Delete','admin')}</a>
	...
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title">{lang('List
				of cumulative discounts','admin')}</span>
		</div>
		<div class="pull-right">
			<div class="d-i_b">
				<a class="btn btn-small btn-success pjax"
					href="/admin/components/run/shop/comulativ/create"><i
			...
			<table
				...
				<thead>
					<tr>
						...
						<th class="span3">{lang('Discount Amount of','admin')}</th>
						<th class="span3">{lang('Discount Amount to','admin')}</th>
						<th class="span2">{lang('Discount','admin')}</th>
						<th class="span3">{lang('Date of creation','admin')}</th>
				...
				<tbody class="sortable">
					...
					<tr>
						...
						<td><p>{echo $c['id']}</p></td>
						<td><a href="{$ADMIN_URL}comulativ/edit/{echo $c['id']}"
						...
						<td>
							<div class="frame_prod-on_off" data-rel="tooltip"
								...
								<span
									class="prod-on_off {if $c['active'] != 1}disable_tovar{/if}"></span>
							</div>
						</td>
					</tr>
					{/foreach}
