<div class="container">
	<section class="mini-layout">
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">{lang('Deposit
					rates','admin')}</span>
			</div>
				...
				<table
					...
					<thead>
						<tr>
							...
							<th class="span3">{lang('Date','admin')}</th>
						</tr>
					</thead>
					<tbody class="sortable">
						...
						<tr>
							<td><p>{echo $c['id']}</p></td>
							<td><a href="{$ADMIN_URL}comulativ/user/{echo $c['id']}">{echo
									$c['username']}</a></td>
							<td><p>{echo $c['email']}</p></td>
							<td><p>{if $c['discount'] == NULL}0%{else:}{echo
									$c['discount']}%{/if}</p></td>
