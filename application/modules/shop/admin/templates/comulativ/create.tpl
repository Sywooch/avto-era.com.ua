<section class="mini-layout">
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title">{lang('Creating
				cumulative discount','admin')}</span>
		</div>
	...
	<table
		...
		<thead>
			<tr>
				<th colspan="6">{lang('These discounts','admin')}</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td colspan="6">
					<div class="inside_padd span9">
						<div class="form-horizontal">
							<form id="createComulativ" method="post"
								active="{$ADMIN_URL}comulativ/create">
								...
								<div class="control-group">
									...
									<div class="controls number">
										...
										<span class="help-block">{lang('Amount of which will be
											a discount.','admin')}</span>
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label" for="total_a">{lang('Discount','admin')}
										{lang('to','admin')}:</label>
									<div class="controls number">
										<input type="text" name="total_a" id="total_a" value=""
											required /> <span class="help-block">{lang('The amount
											to which there will be a discount','admin')}</span>
									</div>
								</div>
