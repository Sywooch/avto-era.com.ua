        ...
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    ...
                    <button title="{lang('Filter','admin')}" type="submit" class="btn btn-small"><i class="icon-filter"></i>{lang('Filter','admin')}</button>
                    <a href="{$ADMIN_URL}search/index{if $_GET['WithoutImages'] == 1}?WithoutImages=1{/if}" title="{lang('Reset filter','admin')}" type="button" class="btn btn-small pjax"><i class="icon-refresh"></i>{lang('Cancel filter','admin')}</a>
                    <div class="dropdown d-i_b">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#" class="clone" onclick="product.cloneTo()">{lang('Create copy','admin')}</a></li>
                    ...
                    <a class="btn btn-small btn-success pjax" href="/admin/components/run/shop/products/create" ><i class="icon-plus-sign icon-white"></i>{lang('Create','admin')}</a>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <table class="table table-striped table-bordered table-hover table-condensed products_table">
                <thead>
                    <tr style="cursor: pointer;">
                        ...
                        <th class="span1 product_list_order" data-column="Reference">{lang('Article', 'admin')}
                ...
                <td>
                    <select class="prodFilterSelect" name="Active">
                        ...
                        <option value="true" {if $_GET['Active'] == 'true'}selected="selected"{/if}>{lang('Yes','admin')}</option>
                        <option value="false" {if $_GET['Active'] == 'false'}selected="selected"{/if}>{lang('No','admin')}</option>
                    </select>
                </td>
                <td>
                ...
                <td class="number">
                    <label>
                        ...
                        <span class="o_h d_b"><input type="text" name="min_price" value="{$_GET.min_price}"/></span>
                    </label>
                    <label>
                        <span class="pull-left"><span class="neigh_form_field help-inline"></span>{lang('To','admin')}&nbsp;&nbsp;</span>
                        <span class="o_h d_b"><input type="text" name="max_price" value="{$_GET.max_price}"/></span>
                    </label>
                </td>
                {form_csrf()}
                </form>
                ...
                <div class="row-fluid news">
                    <div class="span12">
                        <div class="alert alert-info">
                            ...
                            <p>{lang('There are no results. Modify your search or click the Reset Filter','admin')}</p>
                        </div>
                    </div>
                </div>
            </div>
