                                    ...
                                    {foreach $model as $p}
                                        ...
                                        {if sizeof($variants) == 1}
                                            <tr data-id="{echo $p->getId()}">
                                                ...
                                                <td class="share_alt">
                                                    <a href="/shop/product/{echo $p->getId()}" target="_blank" class="go_to_site pull-right btn btn-small"  data-rel="tooltip" data-placement="top" data-original-title="{lang('go to the website','admin')}"><i class="icon-share-alt"></i></a>
                                                ...
                                                <td class="share_alt">
                                                    ...
                                                    <a href="{$ADMIN_URL}categories/edit/{echo $p->getMainCategory()->getId()}" class="pjax" >{echo $p->getMainCategory()->getName()}</a></td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="pull-right"><span class="neigh_form_field help-inline"></span>&nbsp;&nbsp;{$CS}</span>
