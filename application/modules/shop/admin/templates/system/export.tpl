                    ...
                    <div class="inside_padd form-horizontal row-fluid">
                        ...
                        <div class="control-group">
                            {foreach $attributes as $attrKey => $attrName}                                
                                {if $attrKey != 'skip' and !in_array($attrName, $cFields)}
                                    <div class="controls">
                                        <span class="frame_label no_connection eattrcol">
                                            <span class="niceCheck b_n">
                                                <input type="checkbox" value="1" class="eattr" name="attribute[{$attrName}]" {if in_array($attrName, $checkedFields)} checked="checked" {/if}/>
                                            </span>
                                            {$attrKey}
                                        </span>
                                    </div>
