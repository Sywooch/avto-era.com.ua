    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="{$ADMIN_URL}paymentmethods" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                    ...
                    <button type="button" class="btn btn-small formSubmit" data-form="#createPayment" data-action="exit"><i class="icon-check"></i>{lang('Save and go back','admin')}</button>
                </div>
            </div>                            
        </div>
