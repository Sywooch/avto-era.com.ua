        ...
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    ...
                    <button type="button" class="btn btn-small btn-danger disabled action_on" id="del_sel_pm" onclick="delete_function.deleteFunction()"><i class="icon-trash icon-white"></i>{lang('Delete','admin')}</button>
                </div>
            </div>                            
        </div>
                    ...
                    <tbody class="sortable save_positions" data-url="/admin/components/run/shop/paymentmethods/savePositions">
                        {foreach $model as $c}
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="pjax" href="{$ADMIN_URL}paymentmethods/edit/{echo $c->getId()}" data-rel="tooltip" data-title="{lang('Editing','admin')}">{echo ShopCore::encode($c->getName())}</a>
                                </td>
