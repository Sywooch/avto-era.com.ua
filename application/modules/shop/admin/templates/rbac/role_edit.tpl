<section class="mini-layout">
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title">{lang('Role
				edit','admin')}: {echo $model->getName()}</span>
		</div>
		<div class="pull-right">
			<div class="d-i_b">
				<a href="{$BASE_URL}admin/components/run/shop/rbac/role_list"
	...
	<div class="row-fluid">
		<div class="span3 m-t_10">
			<ul class="nav myTab nav-tabs nav-stacked">
				...
				<li><a href="#mod{echo $group->Id}">{echo
						$group->getName()}</a></li> {/foreach}
			</ul>
		</div>
		<div class="span9 content_big_td">
			<form method="post"
				action="{$ADMIN_URL}rbac/role_edit/{echo $model->getId()}"
				class="form-horizontal" id="role_ed_form">
				<div class="tab-content">
												...
												<div class="control-group">
													...
													<div class="controls number">
														<input type="text" name="Importance" id="Importance"
															value="{echo $model->getImportance()}" />
													</div>
												</div>
											</div>
										</div>
					...
					{foreach $groups as $group} {if
					$group->getShopRbacPrivilegess()->count() > 0}
								...
								<tr>
									<th class="span1"><span class="frame_label"> <span
											class="niceCheck"> <input type="checkbox"
												class="maincheck" name="group_{echo $group->Id}" />
										</span>
									</span></th>
							...
							<tbody>
								...
								<tr class="simple_tr">
									<td><span class="frame_label"> <span
											class="niceCheck"> <input type="checkbox"
												class="chldcheck" value="{echo $privilege->Id}"
												name="Privileges[]" {if in_array($privilege->Id,
												$rolePrivileges)} checked="checked" {/if}/>
