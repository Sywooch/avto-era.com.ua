<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="{$ADMIN_URL}dashboard" class="t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                    ...
                    <div class="tab-pane active" id="view">
                                        ...
                                        <div class="inside_padd">
                                            <div class="number">
                                                <div class="control-group">
                                                    <label class="control-label">{lang('Products count shown on site','admin')}:</label>
                                                    <div class="controls">
                                                        <input type="text" value="{echo ShopCore::app()->SSettings->frontProductsPerPage}" name="frontProductsPerPage" class="input-small">
                                                        <span class="help-inline"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">{lang('The values ​​for the number of products per page (example: 12, 24, 48)','admin')}:</label>
                                                <div class="controls">
                                                    <input type="text" value="{echo  implode(",",unserialize(ShopCore::app()->SSettings->arrayFrontProductsPerPage))}" name="arrayFrontProductsPerPage" id="arrayFrontProductsPerPage" class="">
                                                    <span class="help-inline"></span>
                                                </div>
                                            </div>
                                            <div class="number">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label">{lang('Total','admin')} {lang('fractional digits','admin')}:</label>
                                                    <div class="controls">
                                                        <select name="pricePrecision" class="input-small">
                                                            ...
                                                            <option {if ShopCore::app()->SSettings->pricePrecision == 5}selected{/if} value="5">5</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                {/**<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        {if $templates}
                                                            <select name="systemTemplatePath" class="input-long">
                                                                {foreach $templates as $t}
                                                                    <option {if $t == ShopCore::app()->SSettings->systemTemplatePath}selected{/if} value="{echo $t}">{echo str_replace(array('./templates/', '/shop/'), '', $t)}</option>
                                                                {/foreach}
                                                            </select>
                                                        {else:}
                                                            {lang('List','admin')} {lang('Template','admin')} {lang('Empty.','admin')}.
                                                        {/if}
                                                    </div>
                                                </div>**/}
                                            </div>
                        ...
                        <div class="row-fluid">
                            <form method="post" action="#" class="form-horizontal">
                                <table class="table table-striped table-bordered table-hover table-condensed content_big_td orderMethodsTable">
                                    <thead>
                                        <tr>
                                        ...
                                        {foreach $sorting as $s}
                                            <tr data-locale="{echo $locale}" data-id="{echo $s['id']}" >
                                                <td>
                                                    ...
                                                    <input type="text" name="name" value="{echo $s['name']}" style="display: none">
                                                </td>
                                                <td>
                                                    <span>
                                                        {if $s['name_front']}
                                                    ...
                                                    <input type="text" name="name_front" value="{echo $s['name_front']}" style="display: none">
                                                </td>
                                                <td>
                                                    <span>
                                                        {if $s['tooltip']}
                                                    ...
                                                    <input type="text" name="tooltip" value="{echo $s['tooltip']}"  style="display: none">
                                                </td>
                                                <td>
                                                    <div class="get">
                                                        {echo $s['get']}
                                                ...
                                                <td>
                                                    <div class="frame_prod-on_off" data-rel="tooltip" data-placement="top" data-original-title="{if $s['active'] == 1}{lang('show','admin')}{else:}{lang("don't show",'admin')}{/if}" >
                                        ...
                                        <div data-frame>
                                            <div class="variantsProduct">
                                                <table class="table table-bordered t-l_a">
                                                    <thead>
                                                        <tr>
                                                            <th class="span3 vName">{lang('Prefix (folder will be created)','admin')}<span class="required">*</span></th>
                                                            <th class="span2 ">{lang('Height, px','admin')} <span class="required">*</span></th>
                                                            <th class="span2">{lang('Width, px','admin')} <span class="required">*</span></th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody id="AppendHolder">
                                                        {foreach $imageSizes as $key => $size}
                                                            <tr>
                                                                <td class="vName">
                                                                    <button class="btn my_btn_s btn-small pull-left btn-danger m-r_5 removeImageType" type="button"  data-rel="tooltip" data-title="{lang('Delete','admin')}"><i class="icon-trash icon-white"></i></button>
                                                                    <div class="o_h">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td colspan="8">
                                                                <div class="clearfix">
                                                                    <button id="addImageSizesBlock" type="button" class="pull-right btn btn-small btn-success"><i class="icon-plus-sign icon-white"></i> {lang('Add','admin')}</button>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
                        ...
                        <div style="display:none" >
                            <table>
                                <tr id="CloneImageSizesBlock">
                                    <td class="vName">
                                        <button class="btn my_btn_s btn-small pull-left btn-danger m-r_5" type="button" data-remove data-rel="tooltip" data-title="{lang('Delete','admin')}"><i class="icon-trash icon-white"></i></button>
                                        <div class="o_h">
                                        ...
                                        <div class="inside_padd">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select id="inputLocal" name="watermark[wm_hor_alignment]">
                                                        ...
                                                        <option {if ShopCore::app()->SSettings->watermark_wm_hor_alignment == 'center'}selected="selected"{/if} value="center">{lang('Center','admin')}</option>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <span class="help-block">
                                                            {lang('The file must be on the server. For example','admin')}: /uploads/images/logo.png
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls number">
                                                        ...
                                                        <div class="d_b m-t_10" id="inputWatermark-preview" style="width:220px">
                                                            ...
                                                            {if file_exists(BASEPATH.'..'.ShopCore::app()->SSettings->watermark_watermark_image)}
                                                                <img src="{echo ShopCore::app()->SSettings->watermark_watermark_image}" class="img-polaroid" />
                                                            {/if}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="fortextblock" {if ShopCore::app()->SSettings->watermark_watermark_type == 'overlay'} style="display:none;"{/if}>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input id="watermark_text_color" type="text" class="input-small" value="{echo ShopCore::app()->SSettings->watermark_watermark_color}" name="watermark[watermark_color]" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div>
                                                            <span class="btn btn-small p_r pull-right">
                                                                <i class="icon-folder-open"></i>&nbsp;&nbsp;{lang('Download','admin')}
                                                                <input type="file" class="btn-small btn" value="{echo ShopCore::app()->SSettings->watermark_watermark_font_path}" name="watermark[watermark_font_path]"/>
                                                            </span>
                                                            <div class="o_h">
                                                                <input type="text" value="{echo ShopCore::app()->SSettings->watermark_watermark_font_path}" name="watermark[watermark_font_path]">
                                                            </div>
                                                        </div>
                                                        <span class="help-block">
