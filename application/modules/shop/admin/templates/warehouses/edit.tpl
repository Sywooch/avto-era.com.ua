				...
				<td colspan="6">
					<div class="inside_padd">
						<div class="form-horizontal">
							<form id="warehousEdit" method="post"
								active="{$ADMIN_URL}warehouses/edit/{echo $model->getId()}"
								id="warehousEdit">
								<div class="span9">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="Name"
												value="{echo encode($model->getName())}" id="inputRecCount" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="Address"
												value="{echo encode($model->getAddress())}"
												id="inputAddress" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="Phone"
												value="{echo encode($model->getPhone())}" id="inputPhone" />
										</div>
									</div>
								</div>
								<div class="control-group">
