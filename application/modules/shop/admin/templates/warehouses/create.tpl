					...
					<td colspan="6">
						<div class="inside_padd">
							<div class="form-horizontal">
								<form id="createWarehouses" method="post"
									active="{$ADMIN_URL}warehouses/create" id="createWarehouses">
									<div class="span9">
										<div class="control-group">
											<label class="control-label" for="inputRecCount">{lang('Name','admin')}:</label>
											<div class="controls">
												<input type="text" name="Name" value="" id="inputRecCount"
													required />
											</div>
										</div>
