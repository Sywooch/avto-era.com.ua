<section class="mini-layout">
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title">{lang('Gift
				certificate settings','admin')}</span>
		</div>
	...
	<div class="tab-content">
		<div class="row-fluid">
			<form method="post" action="{$ADMIN_URL}gifts/save_settings"
				class="form-horizontal" id="gift_settings_form">
				<table
								...
								<div class="inside_padd">
									<div class="row-fluid">
										<div class="control-group">
											<label class="control-label">{lang('Use gift
												certificates?','admin')}:</label>
											<div class="controls">
												<span class="frame_label"> <span
													class="niceCheck b_n"> <input type="checkbox"
														name="gifton" value="1" {ifShopCore::app()->SSettings->__get('usegifts')
