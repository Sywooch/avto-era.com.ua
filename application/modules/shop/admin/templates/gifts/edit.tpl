<section class="mini-layout">
	<div class="frame_title clearfix">
		...
		<div class="pull-right">
			<div class="d-i_b">
				<a href="{$BASE_URL}admin/components/run/shop/gifts"
	...
	<form method="post"
		action="{$ADMIN_URL}gifts/edit/{echo $model->getId()}"
		class="form-horizontal" id="gift_ed_form">
		<table
					...
					<td colspan="6">
						<div class="inside_padd span9">
							<div class="control-group m-t_10">
								<label class="control-label">{lang('Gift certificate
									price','admin')}:</label>
								<div class="controls">
									<input type="text" name="price"
										value="{echo $model->getPrice()}" required />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">{lang('Key','admin')}:</label>
								<div class="controls">
									<input id="keyholder" type="text" name="key"
										value="{echo $model->getKey()}" disabled="disabled" required />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">{lang('Active
									until','admin')}:</label>
								<div class="controls">
									<input id="created" class="datepicker" type="text"
										value="{echo date('Y-m-d', $model->getEspDate())}"
										name="espir" required />
								</div>
							</div>
						</div>
