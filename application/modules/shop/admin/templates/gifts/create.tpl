		...
		<div class="pull-right">
			<div class="d-i_b">
				...
				<button type="button" class="btn btn-small btn-success formSubmit"
					data-form="#gift_cr_form" data-action="new" data-submit>
					<i class="icon-plus-sign icon-white"></i>{lang('Create','admin')}
				</button>
				<button type="button" class="btn btn-small  formSubmit"
					data-form="#gift_cr_form" data-action="exit">
					<i class="icon-check"></i>{lang('Create and exit','admin')}
				</button>
			</div>
		</div>
	</div>
	<form method="post" action="{$ADMIN_URL}gifts/create"
		class="form-horizontal" id="gift_cr_form">
		<table
					...
					<td colspan="6">
						<div class="inside_padd span9">
							<div class="control-group m-t_10">
								<label class="control-label" for="dd">{lang('Gift
									certificate price','admin')}:</label>
							...
							<div class="control-group">
								...
								<div class="controls">
									<button type="button" class="btn btn-small pull-right"
										id="generateButton" name="generate_button">
										<i class="icon-random"></i>{lang('Generate','admin')}
									</button>
									<div class="o_h">
							...
							<div class="control-group">
								<label class="control-label" for="created">{lang('Active
									until','admin')}:</label>
								<div class="controls">
									<input id="created" class="datepicker" type="text" value=""
										name="espir" required />
								</div>
							</div>
						</div>
