    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-danger disabled action_on" onclick="delete_function.deleteFunction()" id="del_sel_cert"><i class="icon-trash icon-white"></i>{lang('Delete','admin')}</button>
            </div>
        </div>  
    </div>
    {if count($model)>0}
