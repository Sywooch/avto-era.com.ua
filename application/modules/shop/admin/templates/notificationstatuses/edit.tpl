	...
	<section class="mini-layout">
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">{lang('Editing
					status of appearance','admin')}</span>
			...
			<div class="pull-right">
				<div class="d-i_b">
					...
					'/admin/components/run/shop/notificationstatuses/edit/'.$model->getId())}
				</div>
			</div>
		</div>
		<div class="content_big_td">
			<table
				...
				<thead>
					<tr>
						<th colspan="6">{lang('Callback status data','admin')}</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td colspan="6">
							<form
								action="{$ADMIN_URL}notificationstatuses/edit/{echo $model->getId()}/{$locale}"
								id="editNot" class="span9" method="post">
