<section class="mini-layout">
	...
	<div class="frame_title clearfix">
		<div class="pull-left">
			<span class="help-inline"></span> <span class="title w-s_n">{lang('Creating
				a status callback','admin')}</span>
		</div>
					...
					<td colspan="6">
						<div class="inside_padd">
							<form method="post" class="form-horizontal span9"
								action="{$ADMIN_URL}callbacks/createStatus"
									...
									<div class="controls">
										<span class="frame_label no_connection"> <span
											class="niceCheck b_n"> <input type="checkbox"
												name="IsDefault" id="IsDefault" value="1" />
										</span> {lang('By default','admin')}
										</span> <span class="help-block"> {lang('Status set for all
											new requests. ','admin')}</span>
									</div>
								</div>
								{form_csrf()}
							</form>
