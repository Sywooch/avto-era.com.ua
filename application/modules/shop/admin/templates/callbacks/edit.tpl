<section class="mini-layout">
    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <span class="help-inline"></span>
            <div class="d-i_b">
                <a href="{$ADMIN_URL}callbacks" class="pjax t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                        ...
                        <div class="inside_padd">
                            <form method="post" action="{$ADMIN_URL}callbacks/update/{echo $model->getId()}" class="form-horizontal span9" id="editCallbackForm">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="StatusId">
                                            {foreach SCallbackStatusesQuery::create()->orderById()->find() as $s}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        {echo date('H:i:s Y-m-d', $model->getDate())}
                                    </div>
                                </div> 
