<div class="container">
    ...
    {if sizeof($model)==0}
    <div id="notice" class="alert alert-info">{lang('Empty status list.','admin')}</div>
    {return}
    {/if}
        ...
        <section class="mini-layout">
            <div class="frame_title clearfix">
                <div class="pull-left">
                    ...
                    <span class="title">{lang('Browse topics callback','admin')}</span>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-condensed">
                        ...
                        <tbody >
                            ...
                            <tr data-original-title="" data-id="{echo $c->getId()}">
                                <td>{echo $c->getId()}</td>
                                <td>
                                    <a href="{$ADMIN_URL}callbacks/updateStatus/{echo $c->getId()}/{$locale}" data-rel="tooltip" data-title="{lang('Edit topic callback','admin')}">{echo ShopCore::encode($c->getText())}</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="#" onclick="callbacks.deleteStatus({echo $c->getId()}); return false;" class="btn btn-small btn-danger my_btn_s"> <i class="icon-trash icon-white"></i> </a>
                                </td>
                            </tr>
                            {/foreach}    
                        </tbody>
