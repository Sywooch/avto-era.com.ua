    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">{lang('The request for notification','admin')}</span>  
                <span style="color:silver;font-size:11px;">{lang('by','admin')} {echo STimeHelper::timeAgoInWords($model->getDateCreated())}</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/components/run/shop/notifications" class="t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="inside_padd">
                                <div class="span9">
                                    <div class="row">
                                        <dl class="dl-horizontal pull-left" style="margin-right: 70px;">
                                            <dt>{lang('ID','admin')}:</dt>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{echo ShopCore::encode($model->getUserPhone())}" />
                    ...
                    <tr>
                        <td>
                            <a href="{$ADMIN_URL}products/edit/{echo $product->getId()}">
                                <img width="60px" height="60px"  src="{echo $product->firstVariant->getSmallPhoto()}" title="{lang('Notified email','admin')}"/>
                            </a>
                        </td>
                        <td><a href="{$ADMIN_URL}products/edit/{echo $product->getId()}">{echo ShopCore::encode($product->getName())}</a></td>
                    </tr>
                    </form>
                </tbody>
            </table>
