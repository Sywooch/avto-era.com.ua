    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <a href="{$ADMIN_URL}search/index{$_SESSION['ref_url']}" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                                        ...
                                        <div class="form-horizontal">
                                            <div data-frame>
                                                ...
                                                <div class="control-group m-t_10">
                                                    ...
                                                    <div class="controls">
                                                        <button type="button"  class="btn btn-small disabled setHit" data-rel="tooltip" data-placement="top" data-original-title="{lang('hit','admin')}"><i class="icon-fire"></i> {lang('Hit','admin')}</button>
                                                        <button type="button"  class="btn btn-small disabled setHot" data-rel="tooltip" data-placement="top" data-original-title="{lang('novelty','admin')}"><i class="icon-gift"></i> {lang('Novelty','admin')}</button>
                                                        <button type="button"  class="btn btn-small disabled setAction" data-rel="tooltip" data-placement="top" data-original-title="{lang('promotion','admin')}"><i class="icon-star"></i> {lang('Promotion','admin')}</button>
                                                    </div>
                                                </div>
                                                <div class="variantsProduct">
                                                    <table class="table table-bordered t-l_a">
                                                        <thead>
                                                            <tr>
                                                                <th class="span3 vName" style="display: none;">{echo $translatable_w} {lang('Product variant name','admin')} </th>
                                                        ...
                                                        <tbody class="sortable save_positions_variant" data-url="/admin/components/run/shop/search/save_positions_variant"  id="variantHolder">
                                                            <tr id="ProductVariantRow_0">
                                                                <td class="vName" style="display: none;" >
                                                                    <input type="hidden" name="variants[RandomId][]"  class="random_id" value="45456465"/>                                                                  
                                                                    <input type="text" name="variants[Name][]" value=""/>
                                                                </td>
                                                                <td class="vNameH"></td>
                                                                <td class="number"><input type="text" name="variants[PriceInMain][]" value="" class="required"/></td>
                                                                    {if count($currencies)>0}
                                                                    <td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="8">
                                                                    <div class="clearfix">
                                                                        <button type="button" onclick="vName()" class="pull-right btn btn-small btn-success" id="addVariant"><i class="icon-plus-sign icon-white"></i>{lang('Add a variant','admin')}</button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                ...
                                                <button class="btn my_btn_s btn-small d_n" type="button" data-remove="example" data-rel="tooltip" data-title="{lang('Delete','admin')}"><i class="icon-remove"></i></button>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span9">
                                                    <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="elRTE" id="FullDescriptions" name="FullDescription"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
