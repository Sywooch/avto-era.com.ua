										...
										<div class="form-horizontal">
													...
													<tbody class="sortable" id="variantHolder">
														<tr id="ProductVariantRow_0">
															...
															<td><input type="hidden" name="variants[RandomId][]"
																class="random_id" value="45456465" /> <input type="text"
																name="variants[Name][]" value="" /></td>
															<td><input type="text"
																name="variants[PriceInMain][]" value="" class="required" /></td>
																...
																<div class="control-group">
																	<label class="control-label" style="display: none;">
																		<span class="btn btn-small p_r" data-url="file">
																			...
																			name="variants[mainPhoto][45456465]"
																			title="{lang('Main image','admin')}" /> <!--<input type="hidden" name="variants[MainImageForDel][]" value="0"/>    -->
																	</span>
																	</label>
																	<div class="controls">
															...
															<td class="variantImage">
																...
																<div class="control-group">
																	<label class="control-label" style="display: none;">
																		<span class="btn btn-small p_r" data-url="file">
																			<i class="icon-camera"></i> <input type="file"
																			name="variants[smallPhoto][45456465]"
																			title="{lang('Main image','admin')}" /> <!--<input type="hidden" name="variants[SmallImageForDel][]" value="0"/>    -->
																	</span>
																	</label>
																	<div class="controls">
																		<img src="{$THEME}images/select-picture.png"
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													</span> <span class="frame_label no_connection m-l_15"> <span
														class="niceCheck" style="background-position: -46px 0px;">
													...
													<div class="row">
														<div class="control-group span6">
															...
															<div class="controls">
																{if file_exists("uploads/shop/". $model->getId()
																."_mainMod.jpg")} <img
																	src="/uploads/shop/{echo $model->getId()}_mainMod.jpg?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
														...
														<div class="control-group span6">
															<label class="control-label" for="inputSMod">{lang('Another
																...
																class="btn btn-small p_r" data-url="file"> <i
																	class="icon-camera"></i>&nbsp;&nbsp;Выбрать файл <input
																	type="file" class="btn-small btn" id="inputSMod"
																	name="smallModPhoto">
															</span> <span
																class="frame_label no_connection active d_b m-t_10">
																	<button class="btn btn-small deleteMainImages"
															...
															<div class="controls">
																{if file_exists("uploads/shop/". $model->getId()
																."_smallMod.jpg")} <img
																	src="/uploads/shop/{echo $model->getId()}_smallMod.jpg?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
											...
											<div class="control-group">
												...
												<div class="controls">
													<textarea class="elRTE focusOnClick" id="ShortDescriptions"
