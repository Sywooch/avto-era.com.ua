<div id="images_modal" class="modal hide fade">
    <div class="modal-header">
        ...
        <div class="span5" style="width: 424px;">
            <input data-original-title="{lang('URL or request for search', 'admin')}" type="text" id="url_image" maxlength="255" placeholder="{lang('Enter the URL of the image or the search criterion', 'admin')}">
        </div>
