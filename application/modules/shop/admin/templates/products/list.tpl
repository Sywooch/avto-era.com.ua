...
<div class="footer_panel" align="right" id="productsListFooter" style="display:none;">
    ...
    <input id="footerImageButton" class="Hot" value="&nbsp;" type="button" onclick="shopProductsList_changeHot('{echo $CI->uri->uri_string()}?{http_build_query($_GET)}');" title="{lang('Change','admin')} '{lang('New','admin')}'">
    <input id="footerImageButton" class="Action" value="&nbsp;" type="button" onclick="shopProductsList_changeAction('{echo $CI->uri->uri_string()}?{http_build_query($_GET)}');" title="{lang('Change','admin')} '{lang('Special offers','admin')}'">
