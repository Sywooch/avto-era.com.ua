		...
		<div class="content_big_td">
			...
			<div class="clearfix">
				...
				<div class="pull-right m-t_20">
					<a href="/shop/product/{echo $model->getUrl()}" target="_blank">{lang('View
						page','admin')}<span class="f-s_14">→</span>
					</a>
				</div>
			</div>
			<div class="tab-content">
										...
										<div class="form-horizontal">
											<div data-frame>
												...
												<table class="table table-bordered t-l_a">
													<thead>
														<tr>
															<th width="17px"></th>
															<th>{echo $translatable_w} {lang('Product variant
																name','admin')}</th>
															<th>{echo
																ShopCore::encode($model->getLabel('Price'))} <span
																class="required">*</span>
															</th> {if count($currencies)>0}
															<th>{lang('Currency','admin')}</th> {/if}
															<th>{echo
													...
													<tbody class="sortable save_positions_variant"
														...
														id="variantHolder">
														{if $model->countProductVariants() > 0} {$i=0} {foreach
														$model->getProductVariants() as $v}
														<tr id="ProductVariantRow_{$i}">
															<input name="idv" type="hidden" value="{echo $v->id}" />
															<td><img src="{$SHOP_THEME}images/drag_arrow.png"
																class="drager" /></td>
															<td><input type="hidden" name="variants[RandomId][]"
																class="random_id" value="" /> <input type="hidden"
																name="variants[CurrentId][]" value="{echo $v->getId()}" />
																<input type="text" name="variants[Name][]"
																value="{echo ShopCore::encode($v->getName())}" /></td>
															<td><input type="text"
																name="variants[PriceInMain][]"
																value="{echo ShopCore::encode($v->getPriceInMain())}" /></td>
															{if count($currencies)>0}
															<td><select name="variants[currency][]">
																	{foreach $currencies as $c}
																	<option value="{echo $c->getId()}" {if $c->getId()
																		== $v->getCurrency()}selected="selected"{/if}>{echo
																		$c->getCode()}</option> {/foreach}
															</select></td> {/if}
															<td><input type="text" name="variants[Number][]"
																value="{echo ShopCore::encode($v->getNumber())}"
																class="textbox_short" /></td>
															<td><input type="text" name="variants[Stock][]"
																value="{echo ShopCore::encode($v->getStock())}"
																class="textbox_short" /></td>
															<td class="variantImage">{if $v->getMainImage()}
																<button class="btn btn-small delete_image" type="button"
																...
																<div class="control-group">
																	<label class="control-label" style="display: none;">
																		<span class="btn btn-small p_r" data-url="file">
																			...
																			name="variants[mainPhoto][{echo $v->getId()}]"
																			title="{lang('Main image','admin')}" /> <input
																			type="hidden" name="variants[MainImageForDel][]"
																			value="0" />
																	</span>
																	</label>
																	<div class="controls">
																		{if
																		file_exists('uploads/shop/'.$model->getId().'_vM'.$v->getId().'.jpg')}
																		<img
																			src="{echo productImageUrl($model->getId().'_vM'.$v->getId().'.jpg')}"
																			class="img-polaroid" style="width: 100px;">
																		{else:} <img src="{$THEME}images/select-picture.png"
																			class="img-polaroid " style="width: 100px;">
																		{/if}
																	</div>
																</div>
															</td>
															<td class="variantImage">{if $v->getSmallImage()}
																<button class="btn btn-small delete_image" type="button"
																	data-title="{lang('Delete','admin')}">
																	<i class="icon-remove"></i>
																</button> {/if}
																<div class="control-group">
																	<label class="control-label" style="display: none;">
																		<span class="btn btn-small p_r" data-url="file">
																			<i class="icon-camera"></i> <input type="file"
																			name="variants[smallPhoto][{echo $v->getId()}]"
																			title="{lang('Main image','admin')}" /> <input
																			type="hidden" name="variants[SmallImageForDel][]"
																			value="0" />
																	</span>
																	</label>
																	<div class="controls">
																		{if
																		file_exists('uploads/shop/'.$model->getId().'_vS'.$v->getId().'.jpg')}
																		<img
																			src="{echo productImageUrl($model->getId().'_vS'.$v->getId().'.jpg')}"
																			class="img-polaroid" style="width: 100px;">
																		{else:} <img src="{$THEME}images/select-picture.png"
																			class="img-polaroid " style="width: 100px;">
																		{/if}
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													</span> <span class="frame_label no_connection m-r_15"> <span
														class="niceCheck" style="background-position: -46px 0px;">
															<input type="checkbox" name="Hit" value="1" {if $model->getHit()
															== true}checked="checked"{/if}>
													</span> {lang('Hit','admin')}
													</span> <span class="frame_label no_connection m-r_15"> <span
														class="niceCheck" style="background-position: -46px 0px;">
															<input type="checkbox" name="Hot" value="1" {if $model->getHot()
															== true}checked="checked"{/if}>
													</span> {lang('New','admin')}
													</span> <span class="frame_label no_connection"> <span
														class="niceCheck" style="background-position: -46px 0px;">
															<input type="checkbox" name="Action" value="1"
															{if $model->getAction() ==
															true}checked="checked"{/if}>
													</span> {lang('Promotion','admin')}
													</span>
												</div>
											</div>
											<div class="row-fluid">
														...
														<div class="controls">
															<select name="CategoryId" id="comment"> {foreach
																...
																<option {if $category->getLevel() ==
																	0}style="font-weight: bold;"{/if} {if
																	$model->getCategoryId() ==
																	$category->getId()}selected="selected"{/if}
																	value="{echo
													...
													<div class="control-group">
														...
														<div class="controls">
															<select name="Categories[]" multiple="multiple"
																...
																$category} {$selected=""} {if
																in_array($category->getId(), $productCategories) &&
																$category->getId() != $model->getCategoryId()}
																{$selected="selected='selected'"} {/if}
																<option {if $category->getLevel() ==
																	0}style="font-weight: bold;"{/if} {$selected}
																	value="{echo
												...
												<div class="span7" id="productsPhoto">
													<div class="row">
														<div class="control-group span6">
															<label class="control-label" for="inputImg">{lang('Main
																image','admin')}: <span class="btn btn-small p_r"
																data-url="file"> <i class="icon-camera"></i>&nbsp;&nbsp;{lang('Select
																	a file','admin')} <input type="file"
																	class="btn-small btn" id="inputImg" name="mainPhoto">
																	<input type="hidden" name="deleteMainImage" value="0" />
															</span> <span
																class="frame_label no_connection active d_b m-t_10">
																	{if $model->getMainImage()}
																	<button class="btn btn-small deleteMainImages"
																		type="button" data-title="{lang('Delete','admin')}">
																		<i class="icon-remove"></i>
																	</button> {/if}
															</span> <span
																class="frame_label no_connection active d_b m-t_10">
																	<span class="niceCheck"
																	style="background-position: -46px -17px;"> <input
																		type="checkbox" checked="checked" value="1"
																		name="autoCreateSmallImage" />
																</span> {lang('Create small image','admin')}
															</span>
															</label>
															<div class="controls">
																{if file_exists("uploads/shop/". $model->getId()
																."_main.jpg") && $model->getMainImage()} <img
																	src="/uploads/shop/{echo $model->getMainImage()}?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
														...
														<div class="control-group span6">
															<label class="control-label" for="inputSImg">{lang('Small
																image','admin')}: <span class="btn btn-small p_r"
																data-url="file"> <i class="icon-camera"></i>&nbsp;&nbsp;{lang('Select
																	the file','admin')} <input type="file"
																	class="btn-small btn" id="inputSImg" name="smallPhoto">
															...
															<div class="controls">
																{if file_exists("uploads/shop/". $model->getId()
																."_small.jpg") && $model->getSmallImage()} <img
																	src="/uploads/shop/{echo $model->getId()}_small.jpg?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
													...
													<div class="row">
														<div class="control-group span6">
															<label class="control-label" for="inputMMod">{lang('Another
																main image variant','admin')}: <span
																class="btn btn-small p_r" data-url="file"> <i
																	class="icon-camera"></i>&nbsp;&nbsp;{lang('Select a
																	file','admin')} <input type="file"
																	class="btn-small btn" id="inputMMod"
																	name="mainModPhoto"> <input type="hidden"
																	name="deleteMainModImage" value="0" />
															</span> <span
																class="frame_label no_connection active d_b m-t_10">
																	{if $model->getMainModImage()}
																	<button class="btn btn-small deleteMainImages"
																		data-rel="tooltip"
																		data-title="{lang('Delete','admin')}" type="button">
																		<i class="icon-remove"></i>
																	</button> {/if}
															</span>
															</label>
															<div class="controls">
																...
																$model->getMainModImage()) && $model->getMainModImage()}
																<img
																	src="/uploads/shop/{echo $model->getMainModImage()}?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
														...
														<div class="control-group span6">
															<label class="control-label" for="inputSMod">{lang('Another
																small image variant','admin')}: <span
																class="btn btn-small p_r" data-url="file"> <i
																	class="icon-camera"></i>&nbsp;&nbsp;{lang('Select the
																	file','admin')} <input type="file"
																	class="btn-small btn" id="inputSMod"
																	name="smallModPhoto"> <input type="hidden"
																	name="deleteSmallModImage" value="0" />
															</span> <span
																class="frame_label no_connection active d_b m-t_10">
															...
															<div class="controls">
																{if file_exists("uploads/shop/".
																$model->getSmallModImage()) &&
																$model->getSmallModImage()} <img
																	src="/uploads/shop/{echo $model->getSmallModImage()}?{rand(1,9999)}"
																	class="img-polaroid" style="width: 100px;">
																{else:} <img src="{$THEME}images/select-picture.png"
																	class="img-polaroid " style="width: 100px;">
																{/if}
											...
											<div class="control-group">
												...
												<div class="controls">
													<textarea class="focusOnClick elRTE" id="ShortDescriptions"
														name="ShortDescription">{echo ShopCore::encode($model->getShortDescription())}</textarea>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<textarea class="elRTE focusOnClick" id="FullDescriptions"
														name="FullDescription">{echo ShopCore::encode($model->getFullDescription())}</textarea>
												</div>
											</div>
										</div>
									</div>
													...
													<div id="warehouses_container">
														<div>
															...
															<div id="warehouse_line">
																...
																</select> <input type="text" name="warehouses_c[]"
																	value="{echo $w_data->getCount()}" class="input-medium" />
																<a data-del="wares" class="btn btn-small"><i
											...
											<div class="control-group">
												...
												<div class="controls">
													<select id="comments" class="input-mini"
														name="EnableComments">
														<option {if $model->getEnableComments()} selected
															{/if} value="1">{lang('Yes','admin')}</option>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="oldP"
														value="{echo $model->getOldPrice()}" name="OldPrice" />
												</div>
											</div>
													...
													<div id="relatedProductsNames" style="margin-top: 10px;">
														...
														<div id="tpm_row{echo $shopKitProduct->getId()}">
															<span style="width: 70%; margin-left: 1%;"
																class="pull-left"> <a
																href="{echo $ADMIN_URL .'products/edit/'.$shopKitProduct->getUrl()}">{echo
																	ShopCore::encode($shopKitProduct->getName())}</a> <input
																type="hidden" name="RelatedProducts[]"
									...
									<div class="inside_padd span9">
										<div class="form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="Url" value="{echo $model->getUrl()}"
														name="Url" />
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="MetaTitle" id="Mtag"
														value="{echo $model->getMetaTitle()}" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="mDesc">{echo
													$translatable} {lang('Meta Description','admin')}:</label>
												<div class="controls">
													<input type="text" name="MetaDescription" id="mDesc"
														value="{echo $model->getMetaDescription()}" />
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="MetaKeywords" id="mKey"
														value="{echo $model->getMetaKeywords()}" />
												</div>
											</div>
										</div>
									</div>
						...
						<tbody>
							<tr>
								<td colspan="6">
									<div class="inside_padd">
										<div class="form-horizontal">
											<div class="span9">{echo
												ShopCore::app()->SPropertiesRenderer->renderAdmin($model->getCategoryId(),
												$model, $locale)}</div>
										</div>
									</div>
								</td>
									...
									<div class="inside_padd">
										<div class="form-horizontal">
											<div class="span9 offset3">
												...
												{for $i=0; $i<12; $i++} {if ($i+1) % 2}
												<div class="row">
													{/if}
													<div class="control-group span6">
														<label class="control-label" for="additionalImage_{$i}">
															<span class="btn btn-small p_r" data-url="file"> <i
																class="icon-camera"></i>&nbsp;&nbsp;{lang('Select a
																file','admin')} <input type="file" class="btn-small btn"
																id="additionalImage_{$i}" name="additionalImage_{$i}">
														</span> <input type="hidden" name="imagesForDelete[]" value="-1">
														</label>
														<div class="controls">
															{if file_exists("uploads/shop/". $model->getId() . "_"
															.$i .'.jpg')}
															<button class="btn btn-small rmAddPic" data-i="{echo $i}"
																onclick="change_status('{$ADMIN_URL}products/deleteAddImage/{echo $model->getId() . "_" .$i .'.jpg'}');">
																<i class="icon-remove"></i>
															</button>
															{/if} {if file_exists("uploads/shop/". $model->getId() .
															"_" .$i .'.jpg')} <img
																src="/uploads/shop/{echo $model->getId()}_{$i}.jpg?{rand(1,9999)}"
																class="img-polaroid" style="width: 100px;">
															{else:} <img src="{$THEME}images/select-picture.png"
																class="img-polaroid " style="width: 100px;"> {/if}
														</div>
													</div>
				...
				<div class="tab-pane" id="kits">
					<a style="float: right;" class="btn btn-mini btn-success pjax"
						href="/admin/components/run/shop/kits/kit_create/{echo $model->getId()}"><i
						class="icon-plus-sign icon-white"></i>{lang('Create a
						set','admin')}</a> {if count($model->getKits($criteria))}
					<table
						class="table table-striped table-bordered table-hover table-condensed">
						<thead>
							<tr>
								<th colspan="6">{lang('Kits','admin')}</th>
							</tr>
						</thead>
						<tbody class="sortable">
							<tr>
								<td colspan="6">{$criteria = 'ASC'} {if
									$model->getKits($criteria)->count() > 0} {foreach
									$model->getKits($criteria) as $kit}
									<table
										class="table table-striped table-bordered table-hover table-condensed">
										<thead>
											<tr>
												<th>ID:{echo $kit->getId()}</th>
												<th><a class="pjax"
													href="{$ADMIN_URL}kits/kit_edit/{echo $kit->getId()}">{lang('Editing','admin')}</a>
												</th>
												<th>{lang('Position','admin')}: {echo
													$kit->getPosition()}
													<button type="button" style="float: right"
														class="btn btn-mini kit_del"
										...
										<tbody>
											<tr>
												<td><b>{echo $kit->getLabel('Id')}</b></td>
												<td><b>{echo $kit->getLabel('Name')}</b></td>
												<td><b>{echo $kit->getLabel('Discount')}</b></td>

											</tr>
											{foreach $kit->getShopKitProducts() as $shopKitProduct} {$ap
											= $shopKitProduct->getSProducts()}
					...
					<div class="alert alert-info"
						style="margin-bottom: 18px; margin-top: 18px;">{lang('Kit
						List products are empty','admin')}</div>
					{/if}
				</div>
			</div>
		</div>
	...
	<table>
		<tbody>
			<tr id="ProductVariantRow_">
				...
				<td><input type="hidden" name="variants[RandomId][]"
					class="random_id" value="" /> <input type="hidden"
					name="variants[CurrentId][]" value="" /> <input type="text"
					name="variants[Name][]" value="" /></td>
				...
				<td><input type="text" name="variants[Number][]" value=""
					class="textbox_short" /></td>
				<td><input type="text" name="variants[Stock][]" value=""
					class="textbox_short" /></td>
				<td class="variantImage">{if $v->getMainImage()}
					<button class="btn btn-small delete_image" type="button"
						data-title="{lang('Delete','admin')}">
					...
					<div class="control-group">
						<label class="control-label" style="display: none;"> <span
							class="btn btn-small p_r" data-url="file"> <i
								class="icon-camera"></i> <input type="file"
								name="variants[mainPhoto][]"
								title="{lang('Main image','admin')}" /> <input type="hidden"
								name="variants[MainImageForDel][]" value="0" />
						</span>
						</label>
						<div class="controls">
				...
				<td class="variantImage">{if $v->getSmallImage()}
					...
					<div class="control-group">
						<label class="control-label" style="display: none;"> <span
							class="btn btn-small p_r" data-url="file"> <i
								class="icon-camera"></i> <input type="file"
								name="variants[smallPhoto][]"
								title="{lang('Main image','admin')}" /> <input type="hidden"
								name="variants[SmallImageForDel][]" value="0" />
						</span>
						</label>
						<div class="controls">
							<img src="{$THEME}images/select-picture.png"
				...
				<td>
					<button class="btn my_btn_s btn-small" type="button" data-remove
						data-rel="tooltip" data-title="{lang('Delete','admin')}">
						<i class="icon-remove"></i>
					</button>
				</td>
			</tr>
