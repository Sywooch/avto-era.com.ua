...
<section class="mini-layout">
    ...
    <div class="clearfix">
        ...
        <div class="pull-right m-t_20">
            <a href="/shop/product/{echo $model->getUrl()}" target="_blank">{lang('View page','admin')}<span class="f-s_14">→</span></a>
        </div>
    </div>
                                        ...
                                        <table class="table table-bordered t-l_a">
                                            ...
                                            <tbody class="sortable save_positions_variant" data-url="/admin/components/run/shop/search/save_positions_variant"  id="variantHolder">
                                                {if $model->countProductVariants() > 0}
                                                    ...
                                                    <td>
                                                        {if $i>0}
                                                            <button class="btn my_btn_s btn-small" type="button" data-remove data-rel="tooltip" data-title="{lang('Delete','admin')}"><i class="icon-remove"></i></button>
                                                            {/if}
                                                    </td>
                                                    </tr>
                                                    {$i++}
