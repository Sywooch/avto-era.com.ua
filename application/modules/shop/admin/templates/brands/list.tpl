...
<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang('List of brands','admin')}</span>
        </div>
                        ...
                        <tbody class="sortable save_positions" data-url="/admin/components/run/shop/brands/save_positions">
                            {foreach $model as $item}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="pjax" href="/admin/components/run/shop/brands/edit/{echo $item->getId()}/{echo $item->getLocale()}" data-rel="tooltip" data-title="{lang('Editing','admin')}">{echo ShopCore::encode($item->getName())}</a>
                                    </td>
                                    <td>
                                        <a href="{echo shop_url('brand/'.$item->getUrl())}" target="_blank">{echo shop_url('brand/'.$item->getUrl())}</a>
                                    </td>
                                </tr>
                            {/foreach}
                        </tbody>
