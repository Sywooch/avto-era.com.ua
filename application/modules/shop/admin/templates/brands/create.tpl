<section class="mini-layout">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="modules">
			<form method="post"
				action="{$BASE_URL}admin/components/run/shop/brands/create"
				class="form-horizontal" id="br_cr_form"
								...
								<div class="inside_padd">
									...
									<div class="span9">
										...
										<div class="control-group span6">
											...
											<div class="controls">
												{if file_exists("uploads/shop/brands/". $model->getUrl()
												.".jpg") } <img
													src="/uploads/shop/brands/{echo $model->getUrl()}.jpg?{rand(1,9999)}"
