					...
					<td colspan="6">
						<div class="inside_padd">
							<form method="post" class="form-horizontal span9"
								action="{$ADMIN_URL}orderstatuses/edit/{echo $model->getId()}/{echo $locale}"
