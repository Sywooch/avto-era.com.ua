    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <button type="button" class="btn btn-small action_on disabled listFilterSubmitButton"><i class="icon-filter"></i>{lang('Filter','admin')}</button>
                    <a href="{$ADMIN_URL}users/index"  title="{lang('Cancel filter','admin')}" type="button" class="btn btn-small pjax action_on disabled listFilterSubmitButton"><i class="icon-refresh"></i>{lang('Cancel filter','admin')}</a>
                        ...
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            <thead>
                                ...
                                <tr class="head_body">
                                    ...
                                    <td>{ /* }<input type="text" data-provide="typeahead" data-items="5" id="shopRoleAutoC" value="{$_GET['role']}" name="role"/>{ */ }
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="o_h d_b p_r">
                                                <input type="text" data-placement="top" data-original-title="{lang('choose a date','admin')}" data-rel="tooltip" class="datepicker "  name="dateCreated_f" value="{$_GET['dateCreated_f']}" >
                                        ...
                                        <label>
                                            ...
                                            <span class="o_h d_b p_r">
                                                <input type="text" data-placement="top" data-original-title="{lang('choose a date','admin')}" data-rel="tooltip" class="datepicker "  name="dateCreated_t" value="{$_GET['dateCreated_t']}">
                                                <i class="icon-calendar"></i>
                                            </span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <span class="pull-left"><span class="neigh_form_field help-inline"></span>{lang('from','admin')}&nbsp;&nbsp;</span>
                                            <span class="o_h d_b p_r">
                                                <input type="text" data-placement="top" data-original-title="{lang('numbers only','admin')}" data-rel="tooltip"   name="amout_f" value="{$_GET['amout_f']}" >
                                        ...
                                        <label>
                                            <span class="pull-left"><span class="neigh_form_field help-inline"></span>{lang('to','admin')}&nbsp;&nbsp;</span>
                                            <span class="o_h d_b p_r">
                                                <input type="text" data-placement="top" data-original-title="{lang('numbers only','admin')}" data-rel="tooltip"  name="amout_t" value="{$_GET['amout_t']}">
                                            </span>
                                        </label>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                {foreach $model as $u}
                                    <tr class="simple_tr">
                                        <td class="t-a_c">
                                            {if $u->getId() != $CI->dx_auth->get_user_id()} <span class="frame_label">
                                                    <span class="niceCheck b_n">
                                        ...
                                        <td>
                                            <span>{if $_GET['role'] && $roles[$u->getRoleId()]}{echo $roles[$u->getRoleId()]}{else:}{lang('Simple user', 'admin')}{/if}</span>
                                        </td>
                                ...
                                <td colspan="6">
                                    <div class="inside_padd">
                                        <div class="form-horizontal">
                                            <div class="row-fluid">
                                                <button type="button" class="btn btn-small action_on formSubmit export"  data-form="#exportUsers" ><i class="icon-plus-sign"></i>{lang('Export','admin')}</button>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="radio" name="export" id="monkey" value="monkey" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
