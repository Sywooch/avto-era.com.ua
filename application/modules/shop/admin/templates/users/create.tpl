    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">{lang('Create user','admin')}</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    ...
                    <button type="button" class="btn btn-small action_on formSubmit" data-form="#userCreate" data-action="exit"><i class="icon-check"></i>{lang('Save and exit','admin')}</button>
                </div>
            </div>                            
        </div>
        <div class="tab-pane">
