							...
							<td colspan="6">
								<div class="inside_padd span12">
									<div class="form-horizontal">
										...
										<div class="control-group">
											<label class="control-label" for="Password">{lang('Password','admin')}:</label>
											<div class="controls">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="Role" id="Role"> {foreach $roles as
													$role}
													<option value="{echo $role->id}">{echo
														$role->alt_name}</option> {/foreach}
												</select>
											</div>
										</div>
										<div class="control-group">
