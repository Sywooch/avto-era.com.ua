<section class="mini-layout">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="modules">
			<form method="post"
				action="{$BASE_URL}admin/components/run/shop/currencies/create"
				class="form-horizontal" id="cur_cr_form">
				<table
