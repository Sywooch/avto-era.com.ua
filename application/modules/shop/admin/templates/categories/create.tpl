    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary action_on formSubmit" data-form="#cat_cr_form" data-action="edit" data-submit><i class="icon-ok"></i>{lang('Save', 'admin')}</button>
                <button type="button" class="btn btn-small action_on formSubmit" data-form="#cat_cr_form" data-action="close"><i class="icon-check"></i>{lang('Save and exit', 'admin')}</button>
            </div>
        </div>                            
    </div>
    <form method="post" onkeypress="if(window.event.keyCode==13)return false;" action="{$ADMIN_URL}categories/create" enctype="multipart/form-data" class="form-horizontal" id="cat_cr_form">
                            ...
                            <div class="inside_padd">
                                <div class="span9">
                                    <div class="control-group">
                                        <label class="control-label" for="inputName"><i class="icon-flag"></i>&nbsp;{echo $model->getLabel('Name')}:</label>
                                        <div class="controls">
                            ...
                            <div class="inside_padd span9">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <span class="o_h d_b">
                                            <input type="text" name="tpl" value="" id="inputTemplateCategory"/>
                                        </span>
