    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">{lang('Delivery and payment','admin')}</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="{$BASE_URL}admin/components/run/shop/deliverymethods/index" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
                                ...
                                <div class="form-horizontal">
                                    <form id="deliveryUpdate" method="post" action="{$ADMIN_URL}deliverymethods/edit/{echo $model->getId()}/{echo $locale}">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="elRTE"  name="pricedescription" id="pricedescription">{echo ShopCore::encode($model->getpriceDescription())}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="span9">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div class="o_h">
                                                        <input type="text" name="Price" id="Price" value="{echo ShopCore::encode($model->getPrice())}{if $model->getIsPriceInPercent() == true}%{/if}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls number">
                                                    <span class="group_icon pull-right"><span class="help-block">{$CS}</span></span>
                                                    <div class="o_h">
                                                        <input type="text" name="FreeFrom" id="FreeFrom" value="{echo ShopCore::encode($model->getFreeFrom())}" />
                                                    </div>
                                                </div>
                                            </div>
