    ...
    <section class="mini-layout">
        ...
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/components/run/shop/deliverymethods/create" class="btn btn-small btn-success pjax"><i class="icon-plus-sign icon-white"></i>{lang('Create a way to deliver','admin')}</a>
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="span2">{lang('Free','admin')} {lang('from','admin')}</th>
                    ...
                    <tbody class="sortable save_positions" data-url="/admin/components/run/shop/deliverymethods/save_positions">
                        {foreach $model as $c}
                            ...
                            <tr >
                                ...
                                <td>
                                    <a class="pjax" href="{$ADMIN_URL}deliverymethods/edit/{echo $c->getId()}" data-rel="tooltip" data-title="{lang('Editing','admin')}">{echo ShopCore::encode($c->getName())}</a>
                                </td>
                                <td><p>{echo $c->getPrice()} {if $c->getIsPriceInPercent()}%{else:}{$CS}{/if}</p></td>
