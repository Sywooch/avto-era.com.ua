			...
			<div class="pull-right">
				<div class="d-i_b">
					...
					<button type="button" class="btn btn-small btn-success formSubmit"
						data-form="#createDelivery">
						<i class="icon-list-alt icon-white"></i>{lang('Create','admin')}
					</button>
					<button type="button" class="btn btn-small action_on formSubmit"
						data-form="#createDelivery" data-action="close">
						...
						<td colspan="6">
							<div class="inside_padd">
								<div class="form-horizontal">
									<div class="row-fluid">
										<form id="createDelivery" method="post"
											active="{$ADMIN_URL}deliverymethods/create">
											...
											<div class="control-group">
												<label class="control-label" for="priceDescription">{lang('Description
													delivery price','admin')}:</label>
												<div class="controls">
													<textarea name="pricedescription" id="priceDescription"
														class="elRTE"></textarea>
												</div>
											</div>

											<div class="control-group">
												<label class="control-label" for="Price">{lang('Delivery
													price','admin')}:</label>
											...
											<div class="control-group">
												...
												<div class="controls number">
													...
													<div class="o_h">
														<input type="text" name="FreeFrom" id="FreeFrom" value="" />
													</div>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<div>
														<button type="button"
															class="focus frame_label no_connection">
													...
													{/foreach} {else:} {lang('List is empty.','admin')} {/if}
												</div>
											</div>
											{form_csrf()}
										</form>
