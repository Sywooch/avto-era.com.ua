...
class ShopAdminCategories extends ShopAdminController {
    ...
    public function edit($id = null, $locale = null) {
        ...
        \CMSFactory\Events::create()->registerEvent(array('model' => $model, 'userId' => $this->dx_auth->get_user_id()), 'ShopAdminCategories:preEdit');
        \CMSFactory\Events::runFactory();
    ...
    public function delete() {
        ...
        if ($models = SCategoryQuery::create()->findBy('Id', $category_id)) {
            foreach ($models as $c)
                $c->delete();
