...
abstract class BaseShopBanersQuery extends ModelCriteria {
	...
	public function filterByOnMain($onMain = null, $comparison = null) {
		if (is_string ( $onMain )) {
			$on_main = in_array ( strtolower ( $onMain ), array (
					'false',
					'off',
					'-',
					'no',
	...
	public function filterByShopBanersI18n($shopBanersI18n, $comparison = null) {
		if ($shopBanersI18n instanceof ShopBanersI18n) {
			return $this->addUsingAlias ( ShopBanersPeer::ID, $shopBanersI18n->getId (), $comparison );
		} elseif ($shopBanersI18n instanceof PropelCollection) {
			return $this->useShopBanersI18nQuery ()->filterByPrimaryKeys ( $shopBanersI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useShopBanersI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinShopBanersI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'ShopBanersI18n', 'ShopBanersI18nQuery' );
	}
	
	/**
	 * Exclude object from result
	 *
	 * @param ShopBaners $shopBaners
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinShopBanersI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'ShopBanersI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'ShopBanersI18n', 'ShopBanersI18nQuery' );
	}
} // BaseShopBanersQuery