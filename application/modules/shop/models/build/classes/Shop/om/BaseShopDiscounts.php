...
abstract class BaseShopDiscounts extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = ShopDiscountsQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_discounts` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( ShopDiscountsPeer::NAME ))
			$criteria->add ( ShopDiscountsPeer::NAME, $this->name );
		if ($this->isColumnModified ( ShopDiscountsPeer::DESCRIPTION ))
			$criteria->add ( ShopDiscountsPeer::DESCRIPTION, $this->description );
		if ($this->isColumnModified ( ShopDiscountsPeer::ACTIVE ))
			$criteria->add ( ShopDiscountsPeer::ACTIVE, $this->active );
		if ($this->isColumnModified ( ShopDiscountsPeer::DATE_START ))
			$criteria->add ( ShopDiscountsPeer::DATE_START, $this->date_start );
		if ($this->isColumnModified ( ShopDiscountsPeer::DATE_STOP ))
			$criteria->add ( ShopDiscountsPeer::DATE_STOP, $this->date_stop );
		if ($this->isColumnModified ( ShopDiscountsPeer::DISCOUNT ))
			$criteria->add ( ShopDiscountsPeer::DISCOUNT, $this->discount );
		if ($this->isColumnModified ( ShopDiscountsPeer::USER_GROUP ))
			$criteria->add ( ShopDiscountsPeer::USER_GROUP, $this->user_group );
		if ($this->isColumnModified ( ShopDiscountsPeer::MIN_PRICE ))
			$criteria->add ( ShopDiscountsPeer::MIN_PRICE, $this->min_price );
		if ($this->isColumnModified ( ShopDiscountsPeer::MAX_PRICE ))
			$criteria->add ( ShopDiscountsPeer::MAX_PRICE, $this->max_price );
		if ($this->isColumnModified ( ShopDiscountsPeer::CATEGORIES ))
			$criteria->add ( ShopDiscountsPeer::CATEGORIES, $this->categories );
		if ($this->isColumnModified ( ShopDiscountsPeer::PRODUCTS ))
			$criteria->add ( ShopDiscountsPeer::PRODUCTS, $this->products );
	 ...
	 *        	An object of ShopDiscounts (or compatible) type.
