...
abstract class BaseSProperties extends ShopBaseObject  implements Persistent
{
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setShowFaq($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setMainProperty($arr[$keys[9]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SPropertiesPeer::SHOW_FAQ)) $criteria->add(SPropertiesPeer::SHOW_FAQ, $this->show_faq);
