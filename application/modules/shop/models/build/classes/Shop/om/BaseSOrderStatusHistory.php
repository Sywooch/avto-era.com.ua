...
abstract class BaseSOrderStatusHistory extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SOrderStatusHistoryQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_orders_status_history` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SOrderStatusHistoryPeer::ORDER_ID ))
			$criteria->add ( SOrderStatusHistoryPeer::ORDER_ID, $this->order_id );
		if ($this->isColumnModified ( SOrderStatusHistoryPeer::STATUS_ID ))
			$criteria->add ( SOrderStatusHistoryPeer::STATUS_ID, $this->status_id );
		if ($this->isColumnModified ( SOrderStatusHistoryPeer::USER_ID ))
			$criteria->add ( SOrderStatusHistoryPeer::USER_ID, $this->user_id );
		if ($this->isColumnModified ( SOrderStatusHistoryPeer::DATE_CREATED ))
			$criteria->add ( SOrderStatusHistoryPeer::DATE_CREATED, $this->date_created );
		if ($this->isColumnModified ( SOrderStatusHistoryPeer::COMMENT ))
			$criteria->add ( SOrderStatusHistoryPeer::COMMENT, $this->comment );
	 ...
	 *        	An object of SOrderStatusHistory (or compatible) type.
