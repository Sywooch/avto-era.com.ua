...
abstract class BaseShopKitProduct extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = ShopKitProductQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_kit_product` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( ShopKitProductPeer::DISCOUNT ))
			$criteria->add ( ShopKitProductPeer::DISCOUNT, $this->discount );
	 ...
	 *        	An object of ShopKitProduct (or compatible) type.
	...
	public function getSProductVariants(PropelPDO $con = null) {
		if ($this->aSProductVariants === null && ($this->product_id !== null)) {
			$this->aSProductVariants = SProductVariantsQuery::create ()->filterByShopKitProduct ( $this )-> // here
findOne ( $con );
			/*
			 * The following can be used additionally to
			 * guarantee the related object contains a reference
