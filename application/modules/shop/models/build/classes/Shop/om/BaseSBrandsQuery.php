...
abstract class BaseSBrandsQuery extends ModelCriteria {
	...
	public function filterBySProducts($sProducts, $comparison = null) {
		if ($sProducts instanceof SProducts) {
			return $this->addUsingAlias ( SBrandsPeer::ID, $sProducts->getBrandId (), $comparison );
	...
	public function filterBySBrandsI18n($sBrandsI18n, $comparison = null) {
		if ($sBrandsI18n instanceof SBrandsI18n) {
			return $this->addUsingAlias ( SBrandsPeer::ID, $sBrandsI18n->getId (), $comparison );
		} elseif ($sBrandsI18n instanceof PropelCollection) {
			return $this->useSBrandsI18nQuery ()->filterByPrimaryKeys ( $sBrandsI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSBrandsI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSBrandsI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SBrandsI18n', 'SBrandsI18nQuery' );
	}
	
	/**
	 * Exclude object from result
	 *
	 * @param SBrands $sBrands
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinSBrandsI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'SBrandsI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SBrandsI18n', 'SBrandsI18nQuery' );
	}
} // BaseSBrandsQuery