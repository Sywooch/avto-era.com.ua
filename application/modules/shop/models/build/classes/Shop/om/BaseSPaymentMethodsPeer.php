...
abstract class BaseSPaymentMethodsPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Active', 'CurrencyId', 'PaymentSystemName', 'Position', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'active', 'currencyId', 'paymentSystemName', 'position', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ACTIVE, self::CURRENCY_ID, self::PAYMENT_SYSTEM_NAME, self::POSITION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ACTIVE', 'CURRENCY_ID', 'PAYMENT_SYSTEM_NAME', 'POSITION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'active', 'currency_id', 'payment_system_name', 'position', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Active' => 1, 'CurrencyId' => 2, 'PaymentSystemName' => 3, 'Position' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'active' => 1, 'currencyId' => 2, 'paymentSystemName' => 3, 'position' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ACTIVE => 1, self::CURRENCY_ID => 2, self::PAYMENT_SYSTEM_NAME => 3, self::POSITION => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ACTIVE' => 1, 'CURRENCY_ID' => 2, 'PAYMENT_SYSTEM_NAME' => 3, 'POSITION' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'active' => 1, 'currency_id' => 2, 'payment_system_name' => 3, 'position' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function clearRelatedInstancePool()
	{
		...
		// Invalidate objects in SPaymentMethodsI18nPeer instance pool,
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SPaymentMethodsPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SPaymentMethodsPeer::NUM_HYDRATE_COLUMNS;
		} else {
	...
	public static function doSelectJoinCurrency(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SPaymentMethodsPeer::addSelectColumns($criteria);
		$startcol = SPaymentMethodsPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SPaymentMethodsPeer::addSelectColumns($criteria);
		$startcol2 = SPaymentMethodsPeer::NUM_HYDRATE_COLUMNS;
	...
	/**
	 * Performs an UPDATE on the database, given a SPaymentMethods or Criteria object.
	 *
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SPaymentMethodsPeer::doOnDeleteCascade(new Criteria(SPaymentMethodsPeer::DATABASE_NAME), $con);
			SPaymentMethodsPeer::doOnDeleteSetNull(new Criteria(SPaymentMethodsPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SPaymentMethodsPeer::doOnDeleteCascade($c, $con);
			
			// cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
			$c = clone $criteria;
			SPaymentMethodsPeer::doOnDeleteSetNull($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SPaymentMethodsPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(SPaymentMethodsI18nPeer::ID, $obj->getId());
			$affectedRows += SPaymentMethodsI18nPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria = new Criteria(SPaymentMethodsPeer::DATABASE_NAME);
			$updateValues = new Criteria(SPaymentMethodsPeer::DATABASE_NAME);
			$selectCriteria->add(SOrdersPeer::PAYMENT_METHOD, $obj->getId());
			$updateValues->add(SOrdersPeer::PAYMENT_METHOD, null);
