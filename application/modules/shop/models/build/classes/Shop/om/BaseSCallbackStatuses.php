...
abstract class BaseSCallbackStatuses extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SCallbackStatusesQuery::create()
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->sCallbackssScheduledForDeletion !== null) {
				if (!$this->sCallbackssScheduledForDeletion->isEmpty()) {
					SCallbacksQuery::create()
						->filterByPrimaryKeys($this->sCallbackssScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SCallbackStatusesPeer::ID)) $criteria->add(SCallbackStatusesPeer::ID, $this->id);
		if ($this->isColumnModified(SCallbackStatusesPeer::IS_DEFAULT)) $criteria->add(SCallbackStatusesPeer::IS_DEFAULT, $this->is_default);
	...
	public function getSCallbackss($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSCallbackss || null !== $criteria) {
			if ($this->isNew() && null === $this->collSCallbackss) {
				...
				$collSCallbackss = SCallbacksQuery::create(null, $criteria)
					->filterBySCallbackStatuses($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 *
	 * @param      PropelCollection $sCallbackss A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	...
	/**
	 * @param	SCallbacks $sCallbacks The sCallbacks object to add.
	 */
	...
	public function getSCallbackStatusesI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSCallbackStatusesI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collSCallbackStatusesI18ns) {
				...
				$collSCallbackStatusesI18ns = SCallbackStatusesI18nQuery::create(null, $criteria)
					->filterBySCallbackStatuses($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $sCallbackStatusesI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      SCallbackStatusesI18n $l SCallbackStatusesI18n
	 * @return     SCallbackStatuses The current object (for fluent API support)
	 */
	...
	/**
	 * @param	SCallbackStatusesI18n $sCallbackStatusesI18n The sCallbackStatusesI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = SCallbackStatusesI18nQuery::create()
