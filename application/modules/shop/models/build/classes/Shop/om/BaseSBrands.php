...
abstract class BaseSBrands extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SBrandsQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SBrandsPeer::IMAGE)) $criteria->add(SBrandsPeer::IMAGE, $this->image);
		if ($this->isColumnModified(SBrandsPeer::POSITION)) $criteria->add(SBrandsPeer::POSITION, $this->position);
	...
	public function getSBrandsI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSBrandsI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collSBrandsI18ns) {
				...
				$collSBrandsI18ns = SBrandsI18nQuery::create(null, $criteria)
					->filterBySBrands($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $sBrandsI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      SBrandsI18n $l SBrandsI18n
	 * @return     SBrands The current object (for fluent API support)
	 */
	...
	/**
	 * @param	SBrandsI18n $sBrandsI18n The sBrandsI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = SBrandsI18nQuery::create()
