...
abstract class BaseSCategoryPeer {
	...
	protected static $fieldKeys = array (
			...
			BasePeer::TYPE_COLNAME => array (
					...
					self::POSITION => 6,
					self::FULL_PATH => 7,
					self::FULL_PATH_IDS => 8,
					self::TPL => 9,
					self::ORDER_METHOD => 10,
					self::SHOWSITETITLE => 11 
			),
			BasePeer::TYPE_RAW_COLNAME => array (
					'ID' => 0,
					'EXTERNAL_ID' => 1,
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SCategoryPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param mixed $value
	 *        	A SCategory object or a primary key value.
	 */
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SCategory object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SCategory object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SCategory object or primary key or array of primary keys
