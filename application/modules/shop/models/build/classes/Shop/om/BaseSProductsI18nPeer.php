...
abstract class BaseSProductsI18nPeer {
	...
	protected static $fieldKeys = array (
			...
			BasePeer::TYPE_COLNAME => array (
					...
					self::LOCALE => 1,
					self::NAME => 2,
					self::SHORT_DESCRIPTION => 3,
					self::FULL_DESCRIPTION => 4,
					self::META_TITLE => 5,
					self::META_DESCRIPTION => 6,
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SProductsI18nPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param SProductsI18n $value
	 *        	A SProductsI18n object.
	 * @param string $key
	 ...
	 *
	 * @param mixed $value
	 *        	A SProductsI18n object or a primary key value.
	 */
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProductsI18n object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProductsI18n object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProductsI18n object or primary key or array of primary keys
