...
abstract class BaseShopProductCategories extends ShopBaseObject implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false) {
		try {
			...
			return $startcol + 2; // 2 = ShopProductCategoriesPeer::NUM_HYDRATE_COLUMNS.
		} catch ( Exception $e ) {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = ShopProductCategoriesQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		if ($this->isColumnModified ( ShopProductCategoriesPeer::PRODUCT_ID )) {
			$modifiedColumns [':p' . $index ++] = '`PRODUCT_ID`';
		}
		if ($this->isColumnModified ( ShopProductCategoriesPeer::CATEGORY_ID )) {
			$modifiedColumns [':p' . $index ++] = '`CATEGORY_ID`';
		}
		
		$sql = sprintf ( 'INSERT INTO `shop_product_categories` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false) {
		if (isset ( $alreadyDumpedObjects ['ShopProductCategories'] [serialize ( $this->getPrimaryKey () )] )) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects ['ShopProductCategories'] [serialize ( $this->getPrimaryKey () )] = true;
	 ...
	 *        	An object of ShopProductCategories (or compatible) type.
