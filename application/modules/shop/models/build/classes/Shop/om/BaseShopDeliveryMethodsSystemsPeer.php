...
abstract class BaseShopDeliveryMethodsSystemsPeer {
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. ShopDeliveryMethodsSystemsPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param ShopDeliveryMethodsSystems $value
	 *        	A ShopDeliveryMethodsSystems object.
	 * @param string $key
	...
	public static function addInstanceToPool($obj, $key = null) {
		if (Propel::isInstancePoolingEnabled ()) {
			if ($key === null) {
				$key = serialize ( array (
						( string ) $obj->getDeliveryMethodId (),
						( string ) $obj->getPaymentMethodId () 
				) );
			} // if key === null
	 ...
	 *
	 * @param mixed $value
	 *        	A ShopDeliveryMethodsSystems object or a primary key value.
	 */
	public static function removeInstanceFromPool($value) {
		if (Propel::isInstancePoolingEnabled () && $value !== null) {
			if (is_object ( $value ) && $value instanceof ShopDeliveryMethodsSystems) {
				$key = serialize ( array (
						( string ) $value->getDeliveryMethodId (),
						( string ) $value->getPaymentMethodId () 
				) );
	...
	public static function populateObject($row, $startcol = 0) {
		...
		if (null !== ($obj = ShopDeliveryMethodsSystemsPeer::getInstanceFromPool ( $key ))) {
			...
			$col = $startcol + ShopDeliveryMethodsSystemsPeer::NUM_HYDRATE_COLUMNS;
		} else {
	...
	public static function doSelectJoinSDeliveryMethods(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN) {
		...
		ShopDeliveryMethodsSystemsPeer::addSelectColumns ( $criteria );
		$startcol = ShopDeliveryMethodsSystemsPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN) {
		...
		ShopDeliveryMethodsSystemsPeer::addSelectColumns ( $criteria );
		$startcol2 = ShopDeliveryMethodsSystemsPeer::NUM_HYDRATE_COLUMNS;
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or ShopDeliveryMethodsSystems object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	...
	/**
	 * Performs an UPDATE on the database, given a ShopDeliveryMethodsSystems or Criteria object.
	 *
	 * @param mixed $values
	 *        	Criteria or ShopDeliveryMethodsSystems object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or ShopDeliveryMethodsSystems object or primary key or array of primary keys
	 ...
	 *
	 * @param ShopDeliveryMethodsSystems $obj
