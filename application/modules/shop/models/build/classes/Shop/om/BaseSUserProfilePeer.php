...
abstract class BaseSUserProfilePeer {
	...
	protected static $fieldKeys = array (
			...
			BasePeer::TYPE_COLNAME => array (
					...
					self::NEWPASS => 8,
					self::NEWPASS_KEY => 9,
					self::NEWPASS_TIME => 10,
					self::CREATED => 11,
					self::LAST_IP => 12,
					self::LAST_LOGIN => 13,
					self::MODIFIED => 14,
					self::CART_DATA => 15,
					self::WISH_LIST_DATA => 16,
					self::KEY => 17,
					self::AMOUT => 18,
					self::DISCOUNT => 19,
					self::ROLE_ID => 20 
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SUserProfilePeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param SUserProfile $value
	 *        	A SUserProfile object.
	 * @param string $key
	 ...
	 *
	 * @param mixed $value
	 *        	A SUserProfile object or a primary key value.
	 */
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SUserProfile object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SUserProfile object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SUserProfile object or primary key or array of primary keys
