...
abstract class BaseSProductPropertiesData extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SProductPropertiesDataQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SProductPropertiesDataPeer::ID)) $criteria->add(SProductPropertiesDataPeer::ID, $this->id);
		...
		if ($this->isColumnModified(SProductPropertiesDataPeer::LOCALE)) $criteria->add(SProductPropertiesDataPeer::LOCALE, $this->locale);
