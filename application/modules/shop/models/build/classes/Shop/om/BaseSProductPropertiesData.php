...
abstract class BaseSProductPropertiesData extends ShopBaseObject implements Persistent {
	...
	public function setId($v) {
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns [] = SProductPropertiesDataPeer::ID;
		}
	...
	public function setLocale($v) {
		...
		if ($this->locale !== $v) {
			$this->locale = $v;
			$this->modifiedColumns [] = SProductPropertiesDataPeer::LOCALE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false) {
		try {
			...
			return $startcol + 5; // 5 = SProductPropertiesDataPeer::NUM_HYDRATE_COLUMNS.
		} catch ( Exception $e ) {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SProductPropertiesDataQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		if ($this->isColumnModified ( SProductPropertiesDataPeer::ID )) {
			$modifiedColumns [':p' . $index ++] = '`ID`';
		}
		if ($this->isColumnModified ( SProductPropertiesDataPeer::PROPERTY_ID )) {
			$modifiedColumns [':p' . $index ++] = '`PROPERTY_ID`';
		}
		if ($this->isColumnModified ( SProductPropertiesDataPeer::PRODUCT_ID )) {
			$modifiedColumns [':p' . $index ++] = '`PRODUCT_ID`';
		}
		if ($this->isColumnModified ( SProductPropertiesDataPeer::VALUE )) {
			$modifiedColumns [':p' . $index ++] = '`VALUE`';
		}
		if ($this->isColumnModified ( SProductPropertiesDataPeer::LOCALE )) {
			$modifiedColumns [':p' . $index ++] = '`LOCALE`';
		}
		
		$sql = sprintf ( 'INSERT INTO `shop_product_properties_data` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false) {
		if (isset ( $alreadyDumpedObjects ['SProductPropertiesData'] [$this->getPrimaryKey ()] )) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects ['SProductPropertiesData'] [$this->getPrimaryKey ()] = true;
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SProductPropertiesDataPeer::ID ))
			$criteria->add ( SProductPropertiesDataPeer::ID, $this->id );
		if ($this->isColumnModified ( SProductPropertiesDataPeer::PROPERTY_ID ))
		...
		if ($this->isColumnModified ( SProductPropertiesDataPeer::VALUE ))
			$criteria->add ( SProductPropertiesDataPeer::VALUE, $this->value );
		if ($this->isColumnModified ( SProductPropertiesDataPeer::LOCALE ))
			$criteria->add ( SProductPropertiesDataPeer::LOCALE, $this->locale );
	 ...
	 *        	An object of SProductPropertiesData (or compatible) type.
