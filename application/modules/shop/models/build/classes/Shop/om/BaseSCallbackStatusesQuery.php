...
abstract class BaseSCallbackStatusesQuery extends ModelCriteria {
	 ...
	 * </code>
	 *
	 * @param boolean|string $isDefault
	 *        	The value to use as filter.
	...
	public function filterByIsDefault($isDefault = null, $comparison = null) {
		if (is_string ( $isDefault )) {
			$is_default = in_array ( strtolower ( $isDefault ), array (
					'false',
					'off',
					'-',
					'no',
	...
	public function filterBySCallbacks($sCallbacks, $comparison = null) {
		if ($sCallbacks instanceof SCallbacks) {
			return $this->addUsingAlias ( SCallbackStatusesPeer::ID, $sCallbacks->getStatusId (), $comparison );
	...
	public function filterBySCallbackStatusesI18n($sCallbackStatusesI18n, $comparison = null) {
		if ($sCallbackStatusesI18n instanceof SCallbackStatusesI18n) {
			return $this->addUsingAlias ( SCallbackStatusesPeer::ID, $sCallbackStatusesI18n->getId (), $comparison );
		} elseif ($sCallbackStatusesI18n instanceof PropelCollection) {
			return $this->useSCallbackStatusesI18nQuery ()->filterByPrimaryKeys ( $sCallbackStatusesI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSCallbackStatusesI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSCallbackStatusesI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SCallbackStatusesI18n', 'SCallbackStatusesI18nQuery' );
	}
	
	/**
	 * Exclude object from result
	 *
	 * @param SCallbackStatuses $sCallbackStatuses
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinSCallbackStatusesI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'SCallbackStatusesI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SCallbackStatusesI18n', 'SCallbackStatusesI18nQuery' );
	}
