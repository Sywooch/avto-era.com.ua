...
abstract class BaseCustomFields extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = CustomFieldsQuery::create()
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setValidators($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setclasses($arr[$keys[9]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CustomFieldsPeer::ID)) $criteria->add(CustomFieldsPeer::ID, $this->id);
		if ($this->isColumnModified(CustomFieldsPeer::ENTITY)) $criteria->add(CustomFieldsPeer::ENTITY, $this->entity);
		if ($this->isColumnModified(CustomFieldsPeer::FIELD_TYPE_ID)) $criteria->add(CustomFieldsPeer::FIELD_TYPE_ID, $this->field_type_id);
		if ($this->isColumnModified(CustomFieldsPeer::FIELD_NAME)) $criteria->add(CustomFieldsPeer::FIELD_NAME, $this->field_name);
		if ($this->isColumnModified(CustomFieldsPeer::IS_REQUIRED)) $criteria->add(CustomFieldsPeer::IS_REQUIRED, $this->is_required);
		if ($this->isColumnModified(CustomFieldsPeer::IS_ACTIVE)) $criteria->add(CustomFieldsPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(CustomFieldsPeer::OPTIONS)) $criteria->add(CustomFieldsPeer::OPTIONS, $this->options);
		if ($this->isColumnModified(CustomFieldsPeer::IS_PRIVATE)) $criteria->add(CustomFieldsPeer::IS_PRIVATE, $this->is_private);
		if ($this->isColumnModified(CustomFieldsPeer::VALIDATORS)) $criteria->add(CustomFieldsPeer::VALIDATORS, $this->validators);
		if ($this->isColumnModified(CustomFieldsPeer::CLASSES)) $criteria->add(CustomFieldsPeer::CLASSES, $this->classes);
		if ($this->isColumnModified(CustomFieldsPeer::POSITION)) $criteria->add(CustomFieldsPeer::POSITION, $this->position);
	...
	public function getCustomFieldsI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collCustomFieldsI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collCustomFieldsI18ns) {
				...
				$collCustomFieldsI18ns = CustomFieldsI18nQuery::create(null, $criteria)
					->filterByCustomFields($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 *
	 * @param      PropelCollection $customFieldsI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      CustomFieldsI18n $l CustomFieldsI18n
	 * @return     CustomFields The current object (for fluent API support)
	 */
	...
	/**
	 * @param	CustomFieldsI18n $customFieldsI18n The customFieldsI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = CustomFieldsI18nQuery::create()
