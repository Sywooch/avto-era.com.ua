...
abstract class BaseSCallbackThemes extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SCallbackThemesQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SCallbackThemesPeer::ID)) $criteria->add(SCallbackThemesPeer::ID, $this->id);
		if ($this->isColumnModified(SCallbackThemesPeer::POSITION)) $criteria->add(SCallbackThemesPeer::POSITION, $this->position);
	...
	public function getSCallbackThemesI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSCallbackThemesI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collSCallbackThemesI18ns) {
				...
				$collSCallbackThemesI18ns = SCallbackThemesI18nQuery::create(null, $criteria)
					->filterBySCallbackThemes($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $sCallbackThemesI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      SCallbackThemesI18n $l SCallbackThemesI18n
	 * @return     SCallbackThemes The current object (for fluent API support)
	 */
	...
	/**
	 * @param	SCallbackThemesI18n $sCallbackThemesI18n The sCallbackThemesI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = SCallbackThemesI18nQuery::create()
