...
abstract class BaseSProductsQuery extends ModelCriteria {
	...
	public function filterByHit($hit = null, $comparison = null) {
		if (is_string ( $hit )) {
			$hit = in_array ( strtolower ( $hit ), array (
					'false',
					'off',
					'-',
					'no',
	...
	public function filterByHot($hot = null, $comparison = null) {
		if (is_string ( $hot )) {
			$hot = in_array ( strtolower ( $hot ), array (
					'false',
					'off',
					'-',
					'no',
	...
	public function filterByAction($action = null, $comparison = null) {
		if (is_string ( $action )) {
			$action = in_array ( strtolower ( $action ), array (
					'false',
					'off',
					'-',
					'no',
	 ...
	 * </code>
	 *
	 * @param boolean|string $enableComments
	 *        	The value to use as filter.
	 *        	Non-boolean arguments are converted using the following rules:
	 *        	* 1, '1', 'true', 'on', and 'yes' are converted to boolean true
	 *        	* 0, '0', 'false', 'off', and 'no' are converted to boolean false
	...
	public function filterByEnableComments($enableComments = null, $comparison = null) {
		if (is_string ( $enableComments )) {
			$enable_comments = in_array ( strtolower ( $enableComments ), array (
					'false',
					'off',
					'-',
					'no',
	 ...
	 *
	 * @param SBrands|PropelCollection $sBrands
	...
	public function filterByBrand($sBrands, $comparison = null) {
		if ($sBrands instanceof SBrands) {
			return $this->addUsingAlias ( SProductsPeer::BRAND_ID, $sBrands->getId (), $comparison );
		} elseif ($sBrands instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this->addUsingAlias ( SProductsPeer::BRAND_ID, $sBrands->toKeyValue ( 'PrimaryKey', 'Id' ), $comparison );
		} else {
	...
	public function useBrandQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinBrand ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'Brand', 'SBrandsQuery' );
	}
	...
	public function filterByMainCategory($sCategory, $comparison = null) {
		if ($sCategory instanceof SCategory) {
			return $this->addUsingAlias ( SProductsPeer::CATEGORY_ID, $sCategory->getId (), $comparison );
		} elseif ($sCategory instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this->addUsingAlias ( SProductsPeer::CATEGORY_ID, $sCategory->toKeyValue ( 'PrimaryKey', 'Id' ), $comparison );
		} else {
	...
	public function useMainCategoryQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinMainCategory ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'MainCategory', 'SCategoryQuery' );
	}
	...
	public function filterByShopKit($shopKit, $comparison = null) {
		if ($shopKit instanceof ShopKit) {
			return $this->addUsingAlias ( SProductsPeer::ID, $shopKit->getProductId (), $comparison );
		} elseif ($shopKit instanceof PropelCollection) {
			return $this->useShopKitQuery ()->filterByPrimaryKeys ( $shopKit->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function filterByShopKitProduct($shopKitProduct, $comparison = null) {
		if ($shopKitProduct instanceof ShopKitProduct) {
			return $this->addUsingAlias ( SProductsPeer::ID, $shopKitProduct->getProductId (), $comparison );
	...
	public function filterBySProductsI18n($sProductsI18n, $comparison = null) {
		if ($sProductsI18n instanceof SProductsI18n) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sProductsI18n->getId (), $comparison );
		} elseif ($sProductsI18n instanceof PropelCollection) {
			return $this->useSProductsI18nQuery ()->filterByPrimaryKeys ( $sProductsI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSProductsI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSProductsI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SProductsI18n', 'SProductsI18nQuery' );
	}
	...
	public function filterBySProductImages($sProductImages, $comparison = null) {
		if ($sProductImages instanceof SProductImages) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sProductImages->getProductId (), $comparison );
		} elseif ($sProductImages instanceof PropelCollection) {
			return $this->useSProductImagesQuery ()->filterByPrimaryKeys ( $sProductImages->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSProductImagesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSProductImages ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SProductImages', 'SProductImagesQuery' );
	}
	...
	public function filterByProductVariant($sProductVariants, $comparison = null) {
		if ($sProductVariants instanceof SProductVariants) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sProductVariants->getProductId (), $comparison );
		} elseif ($sProductVariants instanceof PropelCollection) {
			return $this->useProductVariantQuery ()->filterByPrimaryKeys ( $sProductVariants->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useProductVariantQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinProductVariant ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'ProductVariant', 'SProductVariantsQuery' );
	}
	...
	public function filterBySWarehouseData($sWarehouseData, $comparison = null) {
		if ($sWarehouseData instanceof SWarehouseData) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sWarehouseData->getProductId (), $comparison );
	...
	public function filterByShopProductCategories($shopProductCategories, $comparison = null) {
		if ($shopProductCategories instanceof ShopProductCategories) {
			return $this->addUsingAlias ( SProductsPeer::ID, $shopProductCategories->getProductId (), $comparison );
	...
	public function filterBySProductPropertiesData($sProductPropertiesData, $comparison = null) {
		if ($sProductPropertiesData instanceof SProductPropertiesData) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sProductPropertiesData->getProductId (), $comparison );
		} elseif ($sProductPropertiesData instanceof PropelCollection) {
			return $this->useSProductPropertiesDataQuery ()->filterByPrimaryKeys ( $sProductPropertiesData->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSProductPropertiesDataQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinSProductPropertiesData ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SProductPropertiesData', 'SProductPropertiesDataQuery' );
	}
	...
	public function filterBySNotifications($sNotifications, $comparison = null) {
		if ($sNotifications instanceof SNotifications) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sNotifications->getProductId (), $comparison );
	...
	public function filterBySOrderProducts($sOrderProducts, $comparison = null) {
		if ($sOrderProducts instanceof SOrderProducts) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sOrderProducts->getProductId (), $comparison );
	...
	public function filterBySProductsRating($sProductsRating, $comparison = null) {
		if ($sProductsRating instanceof SProductsRating) {
			return $this->addUsingAlias ( SProductsPeer::ID, $sProductsRating->getProductId (), $comparison );
		} elseif ($sProductsRating instanceof PropelCollection) {
			return $this->useSProductsRatingQuery ()->filterByPrimaryKeys ( $sProductsRating->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSProductsRatingQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSProductsRating ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SProductsRating', 'SProductsRatingQuery' );
	}
	...
	public function filterByCategory($sCategory, $comparison = Criteria::EQUAL) {
		return $this->useShopProductCategoriesQuery ()->filterByCategory ( $sCategory, $comparison )->endUse ();
	}
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinSProductsI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'SProductsI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SProductsI18n', 'SProductsI18nQuery' );
	}
