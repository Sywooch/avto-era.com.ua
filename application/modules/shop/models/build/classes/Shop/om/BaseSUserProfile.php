...
abstract class BaseSUserProfile extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SUserProfileQuery::create()
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setBanned($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setBanReason($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setNewpass($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setNewpassKey($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setNewpassTime($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDateCreated($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setLastIp($arr[$keys[12]]);
		...
		if (array_key_exists($keys[15], $arr)) $this->setCartData($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setWishListData($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setKey($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setAmout($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setDiscount($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setRoleId($arr[$keys[20]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SUserProfilePeer::USERNAME)) $criteria->add(SUserProfilePeer::USERNAME, $this->username);
		if ($this->isColumnModified(SUserProfilePeer::PASSWORD)) $criteria->add(SUserProfilePeer::PASSWORD, $this->password);
		if ($this->isColumnModified(SUserProfilePeer::EMAIL)) $criteria->add(SUserProfilePeer::EMAIL, $this->email);
		...
		if ($this->isColumnModified(SUserProfilePeer::BANNED)) $criteria->add(SUserProfilePeer::BANNED, $this->banned);
		if ($this->isColumnModified(SUserProfilePeer::BAN_REASON)) $criteria->add(SUserProfilePeer::BAN_REASON, $this->ban_reason);
		if ($this->isColumnModified(SUserProfilePeer::NEWPASS)) $criteria->add(SUserProfilePeer::NEWPASS, $this->newpass);
		if ($this->isColumnModified(SUserProfilePeer::NEWPASS_KEY)) $criteria->add(SUserProfilePeer::NEWPASS_KEY, $this->newpass_key);
		if ($this->isColumnModified(SUserProfilePeer::NEWPASS_TIME)) $criteria->add(SUserProfilePeer::NEWPASS_TIME, $this->newpass_time);
		if ($this->isColumnModified(SUserProfilePeer::CREATED)) $criteria->add(SUserProfilePeer::CREATED, $this->created);
		if ($this->isColumnModified(SUserProfilePeer::LAST_IP)) $criteria->add(SUserProfilePeer::LAST_IP, $this->last_ip);
		if ($this->isColumnModified(SUserProfilePeer::LAST_LOGIN)) $criteria->add(SUserProfilePeer::LAST_LOGIN, $this->last_login);
		if ($this->isColumnModified(SUserProfilePeer::MODIFIED)) $criteria->add(SUserProfilePeer::MODIFIED, $this->modified);
		if ($this->isColumnModified(SUserProfilePeer::CART_DATA)) $criteria->add(SUserProfilePeer::CART_DATA, $this->cart_data);
		if ($this->isColumnModified(SUserProfilePeer::WISH_LIST_DATA)) $criteria->add(SUserProfilePeer::WISH_LIST_DATA, $this->wish_list_data);
		if ($this->isColumnModified(SUserProfilePeer::KEY)) $criteria->add(SUserProfilePeer::KEY, $this->key);
		if ($this->isColumnModified(SUserProfilePeer::AMOUT)) $criteria->add(SUserProfilePeer::AMOUT, $this->amout);
		if ($this->isColumnModified(SUserProfilePeer::DISCOUNT)) $criteria->add(SUserProfilePeer::DISCOUNT, $this->discount);
		if ($this->isColumnModified(SUserProfilePeer::ROLE_ID)) $criteria->add(SUserProfilePeer::ROLE_ID, $this->role_id);
