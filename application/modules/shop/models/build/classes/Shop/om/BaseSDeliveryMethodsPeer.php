...
abstract class BaseSDeliveryMethodsPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Price', 'FreeFrom', 'Enabled', 'IsPriceInPercent', 'Position', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'price', 'freeFrom', 'enabled', 'isPriceInPercent', 'position', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PRICE, self::FREE_FROM, self::ENABLED, self::IS_PRICE_IN_PERCENT, self::POSITION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PRICE', 'FREE_FROM', 'ENABLED', 'IS_PRICE_IN_PERCENT', 'POSITION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'price', 'free_from', 'enabled', 'is_price_in_percent', 'position', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Price' => 1, 'FreeFrom' => 2, 'Enabled' => 3, 'IsPriceInPercent' => 4, 'Position' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'price' => 1, 'freeFrom' => 2, 'enabled' => 3, 'isPriceInPercent' => 4, 'position' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PRICE => 1, self::FREE_FROM => 2, self::ENABLED => 3, self::IS_PRICE_IN_PERCENT => 4, self::POSITION => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PRICE' => 1, 'FREE_FROM' => 2, 'ENABLED' => 3, 'IS_PRICE_IN_PERCENT' => 4, 'POSITION' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'price' => 1, 'free_from' => 2, 'enabled' => 3, 'is_price_in_percent' => 4, 'position' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
