...
abstract class BaseSDeliveryMethodsPeer {
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SDeliveryMethodsPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param SDeliveryMethods $value
	 *        	A SDeliveryMethods object.
	 * @param string $key
	 ...
	 *
	 * @param mixed $value
	 *        	A SDeliveryMethods object or a primary key value.
	 */
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SDeliveryMethods object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SDeliveryMethods object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SDeliveryMethods object or primary key or array of primary keys
