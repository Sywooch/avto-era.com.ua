...
abstract class BaseSOrderStatuses extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SOrderStatusesQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SOrderStatusesPeer::ID)) $criteria->add(SOrderStatusesPeer::ID, $this->id);
		if ($this->isColumnModified(SOrderStatusesPeer::POSITION)) $criteria->add(SOrderStatusesPeer::POSITION, $this->position);
	...
	public function getSOrderStatusesI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSOrderStatusesI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collSOrderStatusesI18ns) {
				...
				$collSOrderStatusesI18ns = SOrderStatusesI18nQuery::create(null, $criteria)
					->filterBySOrderStatuses($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 *
	 * @param      PropelCollection $sOrderStatusesI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      SOrderStatusesI18n $l SOrderStatusesI18n
	 * @return     SOrderStatuses The current object (for fluent API support)
	 */
	...
	/**
	 * @param	SOrderStatusesI18n $sOrderStatusesI18n The sOrderStatusesI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = SOrderStatusesI18nQuery::create()
