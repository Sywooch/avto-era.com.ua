...
abstract class BaseSProductImages extends ShopBaseObject implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false) {
		try {
			...
			return $startcol + 3; // 3 = SProductImagesPeer::NUM_HYDRATE_COLUMNS.
		} catch ( Exception $e ) {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SProductImagesQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		if ($this->isColumnModified ( SProductImagesPeer::PRODUCT_ID )) {
			$modifiedColumns [':p' . $index ++] = '`PRODUCT_ID`';
		}
		if ($this->isColumnModified ( SProductImagesPeer::IMAGE_NAME )) {
			$modifiedColumns [':p' . $index ++] = '`IMAGE_NAME`';
		}
		if ($this->isColumnModified ( SProductImagesPeer::POSITION )) {
			$modifiedColumns [':p' . $index ++] = '`POSITION`';
		}
		
		$sql = sprintf ( 'INSERT INTO `shop_product_images` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false) {
		if (isset ( $alreadyDumpedObjects ['SProductImages'] [serialize ( $this->getPrimaryKey () )] )) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects ['SProductImages'] [serialize ( $this->getPrimaryKey () )] = true;
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SProductImagesPeer::POSITION ))
			$criteria->add ( SProductImagesPeer::POSITION, $this->position );
	 ...
	 *        	An object of SProductImages (or compatible) type.
