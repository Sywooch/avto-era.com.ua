...
abstract class BaseSProductImagesPeer {
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SProductImagesPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param SProductImages $value
	 *        	A SProductImages object.
	 * @param string $key
	 ...
	 *
	 * @param mixed $value
	 *        	A SProductImages object or a primary key value.
	 */
	...
	public static function populateObject($row, $startcol = 0) {
		...
		if (null !== ($obj = SProductImagesPeer::getInstanceFromPool ( $key ))) {
			...
			$col = $startcol + SProductImagesPeer::NUM_HYDRATE_COLUMNS;
		} else {
	...
	public static function doSelectJoinSProducts(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN) {
		...
		SProductImagesPeer::addSelectColumns ( $criteria );
		$startcol = SProductImagesPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN) {
		...
		SProductImagesPeer::addSelectColumns ( $criteria );
		$startcol2 = SProductImagesPeer::NUM_HYDRATE_COLUMNS;
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProductImages object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	...
	/**
	 * Performs an UPDATE on the database, given a SProductImages or Criteria object.
	 *
	 * @param mixed $values
	 *        	Criteria or SProductImages object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProductImages object or primary key or array of primary keys
