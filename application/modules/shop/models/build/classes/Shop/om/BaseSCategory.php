...
abstract class BaseSCategory extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SCategoryQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
			...
			if ($ret) {
				...
				SCategoryI18nQuery::create ()->filterBySCategory ( $this )->delete ( $con );
				$con->commit ();
		...
		if (! $this->alreadyInSave) {
			...
			if ($this->productsScheduledForDeletion !== null) {
				if (! $this->productsScheduledForDeletion->isEmpty ()) {
					ShopProductCategoriesQuery::create ()->filterByPrimaryKeys ( $this->productsScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
			...
			if ($this->propertysScheduledForDeletion !== null) {
				if (! $this->propertysScheduledForDeletion->isEmpty ()) {
					ShopProductPropertiesCategoriesQuery::create ()->filterByPrimaryKeys ( $this->propertysScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
			...
			if ($this->sCategorysRelatedByIdScheduledForDeletion !== null) {
				if (! $this->sCategorysRelatedByIdScheduledForDeletion->isEmpty ()) {
					SCategoryQuery::create ()->filterByPrimaryKeys ( $this->sCategorysRelatedByIdScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
			...
			if ($this->sCategoryI18nsScheduledForDeletion !== null) {
				if (! $this->sCategoryI18nsScheduledForDeletion->isEmpty ()) {
					SCategoryI18nQuery::create ()->filterByPrimaryKeys ( $this->sCategoryI18nsScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
			...
			if ($this->sProductssScheduledForDeletion !== null) {
				if (! $this->sProductssScheduledForDeletion->isEmpty ()) {
					SProductsQuery::create ()->filterByPrimaryKeys ( $this->sProductssScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
			...
			if ($this->shopProductPropertiesCategoriessScheduledForDeletion !== null) {
				if (! $this->shopProductPropertiesCategoriessScheduledForDeletion->isEmpty ()) {
					ShopProductPropertiesCategoriesQuery::create ()->filterByPrimaryKeys ( $this->shopProductPropertiesCategoriessScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_category` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SCategoryPeer::EXTERNAL_ID ))
			$criteria->add ( SCategoryPeer::EXTERNAL_ID, $this->external_id );
		if ($this->isColumnModified ( SCategoryPeer::URL ))
			$criteria->add ( SCategoryPeer::URL, $this->url );
		if ($this->isColumnModified ( SCategoryPeer::ACTIVE ))
			$criteria->add ( SCategoryPeer::ACTIVE, $this->active );
		if ($this->isColumnModified ( SCategoryPeer::IMAGE ))
			$criteria->add ( SCategoryPeer::IMAGE, $this->image );
		if ($this->isColumnModified ( SCategoryPeer::PARENT_ID ))
			$criteria->add ( SCategoryPeer::PARENT_ID, $this->parent_id );
		if ($this->isColumnModified ( SCategoryPeer::POSITION ))
			$criteria->add ( SCategoryPeer::POSITION, $this->position );
		if ($this->isColumnModified ( SCategoryPeer::FULL_PATH ))
			$criteria->add ( SCategoryPeer::FULL_PATH, $this->full_path );
		if ($this->isColumnModified ( SCategoryPeer::FULL_PATH_IDS ))
			$criteria->add ( SCategoryPeer::FULL_PATH_IDS, $this->full_path_ids );
		if ($this->isColumnModified ( SCategoryPeer::TPL ))
			$criteria->add ( SCategoryPeer::TPL, $this->tpl );
		if ($this->isColumnModified ( SCategoryPeer::ORDER_METHOD ))
			$criteria->add ( SCategoryPeer::ORDER_METHOD, $this->order_method );
		if ($this->isColumnModified ( SCategoryPeer::SHOWSITETITLE ))
			$criteria->add ( SCategoryPeer::SHOWSITETITLE, $this->showsitetitle );
	 ...
	 *        	An object of SCategory (or compatible) type.
	...
	public function getSCategorysRelatedById($criteria = null, PropelPDO $con = null) {
		if (null === $this->collSCategorysRelatedById || null !== $criteria) {
			if ($this->isNew () && null === $this->collSCategorysRelatedById) {
				...
				$collSCategorysRelatedById = SCategoryQuery::create ( null, $criteria )->filterBySCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 *
	 * @param PropelCollection $sCategorysRelatedById
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	...
	public function countSCategorysRelatedById(Criteria $criteria = null, $distinct = false, PropelPDO $con = null) {
		if (null === $this->collSCategorysRelatedById || null !== $criteria) {
			if ($this->isNew () && null === $this->collSCategorysRelatedById) {
				...
				return $query->filterBySCategory ( $this )->count ( $con );
			}
		} else {
	...
	/**
	 *
	 * @param SCategoryRelatedById $sCategoryRelatedById
	 *        	The sCategoryRelatedById object to add.
	 */
	...
	public function getSCategoryI18ns($criteria = null, PropelPDO $con = null) {
		if (null === $this->collSCategoryI18ns || null !== $criteria) {
			if ($this->isNew () && null === $this->collSCategoryI18ns) {
				...
				$collSCategoryI18ns = SCategoryI18nQuery::create ( null, $criteria )->filterBySCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param PropelCollection $sCategoryI18ns
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	 ...
	 *        	The sCategoryI18n object to add.
	 */
	...
	public function getSProductss($criteria = null, PropelPDO $con = null) {
		if (null === $this->collSProductss || null !== $criteria) {
			if ($this->isNew () && null === $this->collSProductss) {
				...
				$collSProductss = SProductsQuery::create ( null, $criteria )->filterByMainCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param PropelCollection $sProductss
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	...
	public function countSProductss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null) {
		if (null === $this->collSProductss || null !== $criteria) {
			if ($this->isNew () && null === $this->collSProductss) {
				...
				return $query->filterByMainCategory ( $this )->count ( $con );
			}
		} else {
	...
	public function getShopProductCategoriess($criteria = null, PropelPDO $con = null) {
		if (null === $this->collShopProductCategoriess || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopProductCategoriess) {
				...
				$collShopProductCategoriess = ShopProductCategoriesQuery::create ( null, $criteria )->filterByCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	...
	public function getShopProductPropertiesCategoriess($criteria = null, PropelPDO $con = null) {
		if (null === $this->collShopProductPropertiesCategoriess || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopProductPropertiesCategoriess) {
				...
				$collShopProductPropertiesCategoriess = ShopProductPropertiesCategoriesQuery::create ( null, $criteria )->filterByPropertyCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param PropelCollection $shopProductPropertiesCategoriess
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	...
	public function countShopProductPropertiesCategoriess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null) {
		if (null === $this->collShopProductPropertiesCategoriess || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopProductPropertiesCategoriess) {
				...
				return $query->filterByPropertyCategory ( $this )->count ( $con );
			}
		} else {
	 ...
	 *
	 * @param ShopProductPropertiesCategories $l
	 ...
	 *        	The shopProductPropertiesCategories object to add.
	 */
	...
	public function getProducts($criteria = null, PropelPDO $con = null) {
		if (null === $this->collProducts || null !== $criteria) {
			if ($this->isNew () && null === $this->collProducts) {
				...
				$collProducts = SProductsQuery::create ( null, $criteria )->filterByCategory ( $this )->find ( $con );
				if (null !== $criteria) {
					return $collProducts;
				}
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param PropelCollection $products
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	public function setProducts(PropelCollection $products, PropelPDO $con = null) {
		$shopProductCategoriess = ShopProductCategoriesQuery::create ()->filterBySProducts ( $products )->filterByCategory ( $this )->find ( $con );
	...
	public function getPropertys($criteria = null, PropelPDO $con = null) {
		if (null === $this->collPropertys || null !== $criteria) {
			if ($this->isNew () && null === $this->collPropertys) {
				...
				$collPropertys = SPropertiesQuery::create ( null, $criteria )->filterByPropertyCategory ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param PropelCollection $propertys
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	public function setPropertys(PropelCollection $propertys, PropelPDO $con = null) {
		$shopProductPropertiesCategoriess = ShopProductPropertiesCategoriesQuery::create ()->filterBySProperties ( $propertys )->filterByPropertyCategory ( $this )->find ( $con );
	 ...
	 *        	The ShopProductPropertiesCategories object to relate
	 * @return void
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null) {
		if (! isset ( $this->currentTranslations [$locale] )) {
			...
			if ($this->isNew ()) {
				...
				$translation = SCategoryI18nQuery::create ()->filterByPrimaryKey ( array (
						$this->getPrimaryKey (),
						$locale 
				) )->findOneOrCreate ( $con );
				$this->currentTranslations [$locale] = $translation;
	...
	public function removeTranslation($locale = 'ru', PropelPDO $con = null) {
		if (! $this->isNew ()) {
			SCategoryI18nQuery::create ()->filterByPrimaryKey ( array (
					$this->getPrimaryKey (),
					$locale 
			) )->delete ( $con );
		}
