...
abstract class BaseSDeliveryMethodsQuery extends ModelCriteria {
	...
	public function filterByEnabled($enabled = null, $comparison = null) {
		if (is_string ( $enabled )) {
			$enabled = in_array ( strtolower ( $enabled ), array (
					'false',
					'off',
					'-',
					'no',
	 ...
	 * </code>
	 *
	 * @param boolean|string $isPriceInPercent
	 *        	The value to use as filter.
	 *        	Non-boolean arguments are converted using the following rules:
	 *        	* 1, '1', 'true', 'on', and 'yes' are converted to boolean true
	 *        	* 0, '0', 'false', 'off', and 'no' are converted to boolean false
	...
	public function filterByIsPriceInPercent($isPriceInPercent = null, $comparison = null) {
		if (is_string ( $isPriceInPercent )) {
			$is_price_in_percent = in_array ( strtolower ( $isPriceInPercent ), array (
					'false',
					'off',
					'-',
					'no',
	...
	public function filterBySDeliveryMethodsI18n($sDeliveryMethodsI18n, $comparison = null) {
		if ($sDeliveryMethodsI18n instanceof SDeliveryMethodsI18n) {
			return $this->addUsingAlias ( SDeliveryMethodsPeer::ID, $sDeliveryMethodsI18n->getId (), $comparison );
		} elseif ($sDeliveryMethodsI18n instanceof PropelCollection) {
			return $this->useSDeliveryMethodsI18nQuery ()->filterByPrimaryKeys ( $sDeliveryMethodsI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSDeliveryMethodsI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSDeliveryMethodsI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SDeliveryMethodsI18n', 'SDeliveryMethodsI18nQuery' );
	}
	...
	public function filterByShopDeliveryMethodsSystems($shopDeliveryMethodsSystems, $comparison = null) {
		if ($shopDeliveryMethodsSystems instanceof ShopDeliveryMethodsSystems) {
			return $this->addUsingAlias ( SDeliveryMethodsPeer::ID, $shopDeliveryMethodsSystems->getDeliveryMethodId (), $comparison );
	...
	public function filterBySOrders($sOrders, $comparison = null) {
		if ($sOrders instanceof SOrders) {
			return $this->addUsingAlias ( SDeliveryMethodsPeer::ID, $sOrders->getDeliveryMethod (), $comparison );
	...
	public function filterByPaymentMethods($sPaymentMethods, $comparison = Criteria::EQUAL) {
		return $this->useShopDeliveryMethodsSystemsQuery ()->filterByPaymentMethods ( $sPaymentMethods, $comparison )->endUse ();
	}
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinSDeliveryMethodsI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'SDeliveryMethodsI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SDeliveryMethodsI18n', 'SDeliveryMethodsI18nQuery' );
	}
