 ...
 */
abstract class BaseShopBaners extends ShopBaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ShopBanersPeer';
	...
	/**
	 * @var        array ShopBanersI18n[] Collection to store aggregation of ShopBanersI18n objects.
	 */
	 ...
	 * @return     ShopBaners The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ShopBanersPeer::ID;
		}
	...
	public function setPosition($v)
	{
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns[] = ShopBanersPeer::POSITION;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = ShopBanersPeer::ACTIVE;
		}
	...
	public function setCategories($v)
	{
		...
		if ($this->categories !== $v) {
			$this->categories = $v;
			$this->modifiedColumns[] = ShopBanersPeer::CATEGORIES;
		}
	...
	public function setOnMain($v)
	{
		...
		if ($this->on_main !== $v) {
			$this->on_main = $v;
			$this->modifiedColumns[] = ShopBanersPeer::ON_MAIN;
		}
	...
	public function setEspdate($v)
	{
		...
		if ($this->espdate !== $v) {
			$this->espdate = $v;
			$this->modifiedColumns[] = ShopBanersPeer::ESPDATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->categories = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->on_main = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->espdate = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = ShopBanersPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating ShopBaners object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ShopBanersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ShopBanersQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ShopBanersPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ShopBanersPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(ShopBanersPeer::POSITION)) {
			$modifiedColumns[':p' . $index++]  = '`POSITION`';
		}
		if ($this->isColumnModified(ShopBanersPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(ShopBanersPeer::CATEGORIES)) {
			$modifiedColumns[':p' . $index++]  = '`CATEGORIES`';
		}
		if ($this->isColumnModified(ShopBanersPeer::ON_MAIN)) {
			$modifiedColumns[':p' . $index++]  = '`ON_MAIN`';
		}
		if ($this->isColumnModified(ShopBanersPeer::ESPDATE)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ShopBanersPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ShopBanersPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ShopBaners'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ShopBaners'][$this->getPrimaryKey()] = true;
		$keys = ShopBanersPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
		...
		if ($includeForeignObjects) {
			if (null !== $this->collShopBanersI18ns) {
				$result['ShopBanersI18ns'] = $this->collShopBanersI18ns->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
			}
		}
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setCategories($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setOnMain($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setEspdate($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ShopBanersPeer::ID)) $criteria->add(ShopBanersPeer::ID, $this->id);
		if ($this->isColumnModified(ShopBanersPeer::POSITION)) $criteria->add(ShopBanersPeer::POSITION, $this->position);
		if ($this->isColumnModified(ShopBanersPeer::ACTIVE)) $criteria->add(ShopBanersPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(ShopBanersPeer::CATEGORIES)) $criteria->add(ShopBanersPeer::CATEGORIES, $this->categories);
		if ($this->isColumnModified(ShopBanersPeer::ON_MAIN)) $criteria->add(ShopBanersPeer::ON_MAIN, $this->on_main);
		if ($this->isColumnModified(ShopBanersPeer::ESPDATE)) $criteria->add(ShopBanersPeer::ESPDATE, $this->espdate);
	...
	{
		$criteria = new Criteria(ShopBanersPeer::DATABASE_NAME);
		$criteria->add(ShopBanersPeer::ID, $this->id);
	 ...
	 *
	 * @return     ShopBanersPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ShopBanersPeer();
		}
		return self::$peer;
	}
	...
	public function initShopBanersI18ns($overrideExisting = true)
	{
		...
		$this->collShopBanersI18ns = new PropelObjectCollection();
		$this->collShopBanersI18ns->setModel('ShopBanersI18n');
	}

	/**
	 * Gets an array of ShopBanersI18n objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 * If this ShopBaners is new, it will return
	 * an empty collection or the current collection; the criteria is ignored on a new object.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array ShopBanersI18n[] List of ShopBanersI18n objects
	 * @throws     PropelException
	 */
	public function getShopBanersI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collShopBanersI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collShopBanersI18ns) {
				// return empty collection
				$this->initShopBanersI18ns();
			} else {
				$collShopBanersI18ns = ShopBanersI18nQuery::create(null, $criteria)
					->filterByShopBaners($this)
					->find($con);
				if (null !== $criteria) {
	...
	/**
	 * Sets a collection of ShopBanersI18n objects related by a one-to-many relationship
	 * to the current object.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $shopBanersI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	public function setShopBanersI18ns(PropelCollection $shopBanersI18ns, PropelPDO $con = null)
	{
		$this->shopBanersI18nsScheduledForDeletion = $this->getShopBanersI18ns(new Criteria(), $con)->diff($shopBanersI18ns);

		foreach ($shopBanersI18ns as $shopBanersI18n) {
			// Fix issue with collection modified by reference
			if ($shopBanersI18n->isNew()) {
	 ...
	 * @throws     PropelException
	 */
	public function countShopBanersI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collShopBanersI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collShopBanersI18ns) {
				return 0;
			} else {
				$query = ShopBanersI18nQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a ShopBanersI18n object to this object
	 * through the ShopBanersI18n foreign key attribute.
	 *
	 * @param      ShopBanersI18n $l ShopBanersI18n
	 * @return     ShopBaners The current object (for fluent API support)
	 */
	public function addShopBanersI18n(ShopBanersI18n $l)
	{
		...
		if (!$this->collShopBanersI18ns->contains($l)) { // only add it if the **same** object is not already associated
	...
	/**
	 * @param	ShopBanersI18n $shopBanersI18n The shopBanersI18n object to add.
	 */
	protected function doAddShopBanersI18n($shopBanersI18n)
	{
	...
	public function clearAllReferences($deep = false)
	{
		...
		if ($this->collShopBanersI18ns instanceof PropelCollection) {
			$this->collShopBanersI18ns->clearIterator();
		}
		$this->collShopBanersI18ns = null;
	}
	...
	{
		return (string) $this->exportTo(ShopBanersPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				$translation = new ShopBanersI18n();
				$translation->setLocale($locale);
			} else {
				$translation = ShopBanersI18nQuery::create()
