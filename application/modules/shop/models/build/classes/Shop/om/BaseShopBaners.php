...
abstract class BaseShopBaners extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = ShopBanersQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
			...
			if ($ret) {
				...
				ShopBanersI18nQuery::create ()->filterByShopBaners ( $this )->delete ( $con );
				$con->commit ();
		...
		if (! $this->alreadyInSave) {
			...
			if ($this->shopBanersI18nsScheduledForDeletion !== null) {
				if (! $this->shopBanersI18nsScheduledForDeletion->isEmpty ()) {
					ShopBanersI18nQuery::create ()->filterByPrimaryKeys ( $this->shopBanersI18nsScheduledForDeletion->getPrimaryKeys ( false ) )->delete ( $con );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_banners` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( ShopBanersPeer::POSITION ))
			$criteria->add ( ShopBanersPeer::POSITION, $this->position );
		if ($this->isColumnModified ( ShopBanersPeer::ACTIVE ))
			$criteria->add ( ShopBanersPeer::ACTIVE, $this->active );
		if ($this->isColumnModified ( ShopBanersPeer::CATEGORIES ))
			$criteria->add ( ShopBanersPeer::CATEGORIES, $this->categories );
		if ($this->isColumnModified ( ShopBanersPeer::ON_MAIN ))
			$criteria->add ( ShopBanersPeer::ON_MAIN, $this->on_main );
		if ($this->isColumnModified ( ShopBanersPeer::ESPDATE ))
			$criteria->add ( ShopBanersPeer::ESPDATE, $this->espdate );
	 ...
	 *        	An object of ShopBaners (or compatible) type.
	...
	public function getShopBanersI18ns($criteria = null, PropelPDO $con = null) {
		if (null === $this->collShopBanersI18ns || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopBanersI18ns) {
				...
				$collShopBanersI18ns = ShopBanersI18nQuery::create ( null, $criteria )->filterByShopBaners ( $this )->find ( $con );
				if (null !== $criteria) {
	 ...
	 *
	 * @param PropelCollection $shopBanersI18ns
	 *        	A Propel collection.
	 * @param PropelPDO $con
	 *        	Optional connection object
	 */
	...
	public function countShopBanersI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null) {
		if (null === $this->collShopBanersI18ns || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopBanersI18ns) {
				...
				return $query->filterByShopBaners ( $this )->count ( $con );
			}
		} else {
	 ...
	 *        	The shopBanersI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null) {
		if (! isset ( $this->currentTranslations [$locale] )) {
			...
			if ($this->isNew ()) {
				...
				$translation = ShopBanersI18nQuery::create ()->filterByPrimaryKey ( array (
						$this->getPrimaryKey (),
						$locale 
				) )->findOneOrCreate ( $con );
				$this->currentTranslations [$locale] = $translation;
	...
	public function removeTranslation($locale = 'ru', PropelPDO $con = null) {
		if (! $this->isNew ()) {
			ShopBanersI18nQuery::create ()->filterByPrimaryKey ( array (
					$this->getPrimaryKey (),
					$locale 
			) )->delete ( $con );
		}
