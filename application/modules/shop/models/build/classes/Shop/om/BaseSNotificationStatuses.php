...
abstract class BaseSNotificationStatuses extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SNotificationStatusesQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SNotificationStatusesPeer::ID)) $criteria->add(SNotificationStatusesPeer::ID, $this->id);
		if ($this->isColumnModified(SNotificationStatusesPeer::POSITION)) $criteria->add(SNotificationStatusesPeer::POSITION, $this->position);
	...
	public function getSNotificationStatusesI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSNotificationStatusesI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collSNotificationStatusesI18ns) {
				...
				$collSNotificationStatusesI18ns = SNotificationStatusesI18nQuery::create(null, $criteria)
					->filterBySNotificationStatuses($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 * and new objects from the given Propel collection.
	 *
	 * @param      PropelCollection $sNotificationStatusesI18ns A Propel collection.
	 * @param      PropelPDO $con Optional connection object
	 */
	 ...
	 *
	 * @param      SNotificationStatusesI18n $l SNotificationStatusesI18n
	 * @return     SNotificationStatuses The current object (for fluent API support)
	 */
	...
	/**
	 * @param	SNotificationStatusesI18n $sNotificationStatusesI18n The sNotificationStatusesI18n object to add.
	 */
	...
	public function getTranslation($locale = 'ru', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				...
				$translation = SNotificationStatusesI18nQuery::create()
