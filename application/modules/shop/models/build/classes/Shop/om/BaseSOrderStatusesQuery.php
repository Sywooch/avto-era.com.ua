...
abstract class BaseSOrderStatusesQuery extends ModelCriteria {
	...
	public function filterBySOrderStatusesI18n($sOrderStatusesI18n, $comparison = null) {
		if ($sOrderStatusesI18n instanceof SOrderStatusesI18n) {
			return $this->addUsingAlias ( SOrderStatusesPeer::ID, $sOrderStatusesI18n->getId (), $comparison );
		} elseif ($sOrderStatusesI18n instanceof PropelCollection) {
			return $this->useSOrderStatusesI18nQuery ()->filterByPrimaryKeys ( $sOrderStatusesI18n->getPrimaryKeys () )->endUse ();
		} else {
	...
	public function useSOrderStatusesI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN) {
		return $this->joinSOrderStatusesI18n ( $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SOrderStatusesI18n', 'SOrderStatusesI18nQuery' );
	}
	...
	public function filterBySOrders($sOrders, $comparison = null) {
		if ($sOrders instanceof SOrders) {
			return $this->addUsingAlias ( SOrderStatusesPeer::ID, $sOrders->getStatus (), $comparison );
	...
	public function filterBySOrderStatusHistory($sOrderStatusHistory, $comparison = null) {
		if ($sOrderStatusHistory instanceof SOrderStatusHistory) {
			return $this->addUsingAlias ( SOrderStatusesPeer::ID, $sOrderStatusHistory->getStatusId (), $comparison );
	 ...
	 *
	 * @param SOrderStatuses $sOrderStatuses
	...
	public function joinI18n($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		...
		return $this->joinSOrderStatusesI18n ( $relationAlias, $joinType )->addJoinCondition ( $relationName, $relationName . '.Locale = ?', $locale );
	}
	...
	public function joinWithI18n($locale = 'ru', $joinType = Criteria::LEFT_JOIN) {
		$this->joinI18n ( $locale, null, $joinType )->with ( 'SOrderStatusesI18n' );
	...
	public function useI18nQuery($locale = 'ru', $relationAlias = null, $joinType = Criteria::LEFT_JOIN) {
		return $this->joinI18n ( $locale, $relationAlias, $joinType )->useQuery ( $relationAlias ? $relationAlias : 'SOrderStatusesI18n', 'SOrderStatusesI18nQuery' );
	}
