...
abstract class BaseSNotificationStatusesI18n extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SNotificationStatusesI18nQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_notification_statuses_i18n` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SNotificationStatusesI18nPeer::NAME ))
			$criteria->add ( SNotificationStatusesI18nPeer::NAME, $this->name );
	 ...
	 *        	An object of SNotificationStatusesI18n (or compatible) type.
