...
abstract class BaseSCategoryI18n extends ShopBaseObject implements Persistent {
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = SCategoryI18nQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	protected function doInsert(PropelPDO $con) {
		...
		$sql = sprintf ( 'INSERT INTO `shop_category_i18n` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( SCategoryI18nPeer::NAME ))
			$criteria->add ( SCategoryI18nPeer::NAME, $this->name );
		if ($this->isColumnModified ( SCategoryI18nPeer::H1 ))
			$criteria->add ( SCategoryI18nPeer::H1, $this->h1 );
		if ($this->isColumnModified ( SCategoryI18nPeer::DESCRIPTION ))
			$criteria->add ( SCategoryI18nPeer::DESCRIPTION, $this->description );
		if ($this->isColumnModified ( SCategoryI18nPeer::META_DESC ))
			$criteria->add ( SCategoryI18nPeer::META_DESC, $this->meta_desc );
		if ($this->isColumnModified ( SCategoryI18nPeer::META_TITLE ))
			$criteria->add ( SCategoryI18nPeer::META_TITLE, $this->meta_title );
		if ($this->isColumnModified ( SCategoryI18nPeer::META_KEYWORDS ))
			$criteria->add ( SCategoryI18nPeer::META_KEYWORDS, $this->meta_keywords );
	 ...
	 *        	An object of SCategoryI18n (or compatible) type.
