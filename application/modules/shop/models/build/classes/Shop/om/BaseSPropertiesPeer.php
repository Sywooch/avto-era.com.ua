...
abstract class BaseSPropertiesPeer {
	...
	protected static $fieldKeys = array (
			...
			BasePeer::TYPE_COLNAME => array (
					...
					self::ACTIVE => 4,
					self::SHOW_ON_SITE => 5,
					self::SHOW_IN_COMPARE => 6,
					self::SHOW_IN_FILTER => 7,
					self::SHOW_FAQ => 8,
					self::MAIN_PROPERTY => 9,
					self::POSITION => 10 
			),
			BasePeer::TYPE_RAW_COLNAME => array (
					'ID' => 0,
	 ...
	 * @param string $column
	 *        	The column name for current table. (i.e. SPropertiesPeer::COLUMN_NAME).
	 * @return string
	 */
	 ...
	 *
	 * @param SProperties $value
	 *        	A SProperties object.
	 * @param string $key
	 ...
	 *
	 * @param mixed $value
	 *        	A SProperties object or a primary key value.
	 */
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProperties object containing data that is used to create the INSERT statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProperties object containing data that is used to create the UPDATE statement.
	 * @param PropelPDO $con
	 ...
	 *
	 * @param mixed $values
	 *        	Criteria or SProperties object or primary key or array of primary keys
