...
abstract class BaseSProductPropertiesDataPeer {
	...
	const ID = 'shop_product_properties_data.ID';
	...
	const LOCALE = 'shop_product_properties_data.LOCALE';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PropertyId', 'ProductId', 'Value', 'Locale', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'propertyId', 'productId', 'value', 'locale', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PROPERTY_ID, self::PRODUCT_ID, self::VALUE, self::LOCALE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PROPERTY_ID', 'PRODUCT_ID', 'VALUE', 'LOCALE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'property_id', 'product_id', 'value', 'locale', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PropertyId' => 1, 'ProductId' => 2, 'Value' => 3, 'Locale' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'propertyId' => 1, 'productId' => 2, 'value' => 3, 'locale' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PROPERTY_ID => 1, self::PRODUCT_ID => 2, self::VALUE => 3, self::LOCALE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PROPERTY_ID' => 1, 'PRODUCT_ID' => 2, 'VALUE' => 3, 'LOCALE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'property_id' => 1, 'product_id' => 2, 'value' => 3, 'locale' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(SProductPropertiesDataPeer::ID);
			...
			$criteria->addSelectColumn(SProductPropertiesDataPeer::LOCALE);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SProductPropertiesDataPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SProductPropertiesDataPeer::NUM_HYDRATE_COLUMNS;
		} else {
	...
	public static function doSelectJoinSProperties(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SProductPropertiesDataPeer::addSelectColumns($criteria);
		$startcol = SProductPropertiesDataPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SProductPropertiesDataPeer::addSelectColumns($criteria);
		$startcol2 = SProductPropertiesDataPeer::NUM_HYDRATE_COLUMNS;

		SPropertiesPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + SPropertiesPeer::NUM_HYDRATE_COLUMNS;

		SProductsPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + SProductsPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(SProductPropertiesDataPeer::ID) && $criteria->keyContainsValue(SProductPropertiesDataPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SProductPropertiesDataPeer::ID.')');
		}
	...
	/**
	 * Performs an UPDATE on the database, given a SProductPropertiesData or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SProductPropertiesDataPeer::ID);
			$value = $criteria->remove(SProductPropertiesDataPeer::ID);
			if ($value) {
				$selectCriteria->add(SProductPropertiesDataPeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SProductPropertiesDataPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				SProductPropertiesDataPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SProductPropertiesDataPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(SProductPropertiesDataPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SProductPropertiesDataPeer::DATABASE_NAME);
			$criteria->add(SProductPropertiesDataPeer::ID, $pks, Criteria::IN);
			$objs = SProductPropertiesDataPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
