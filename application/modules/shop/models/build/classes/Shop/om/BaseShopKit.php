 ...
 */
abstract class BaseShopKit extends ShopBaseObject implements Persistent {
	
	/**
	 * Peer class name
	 */
	const PEER = 'ShopKitPeer';
	...
	/**
	 * Initializes internal state of BaseShopKit object.
	 * 
	 * @see applyDefaults()
	 */
	 ...
	 * @param int $v
	 *        	new value
	 * @return ShopKit The current object (for fluent API support)
	 */
	public function setId($v) {
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns [] = ShopKitPeer::ID;
		}
	...
	public function setProductId($v) {
		...
		if ($this->product_id !== $v) {
			$this->product_id = $v;
			$this->modifiedColumns [] = ShopKitPeer::PRODUCT_ID;
		}
	...
	public function setActive($v) {
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns [] = ShopKitPeer::ACTIVE;
		}
	...
	public function setPosition($v) {
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns [] = ShopKitPeer::POSITION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false) {
		try {
			...
			return $startcol + 4; // 4 = ShopKitPeer::NUM_HYDRATE_COLUMNS.
		} catch ( Exception $e ) {
			throw new PropelException ( "Error populating ShopKit object", $e );
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null) {
		...
		$stmt = ShopKitPeer::doSelectStmt ( $this->buildPkeyCriteria (), $con );
	...
	public function delete(PropelPDO $con = null) {
		...
		try {
			$deleteQuery = ShopKitQuery::create ()->filterByPrimaryKey ( $this->getPrimaryKey () );
	...
	public function save(PropelPDO $con = null) {
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave ( $con );
				ShopKitPeer::addInstanceToPool ( $this );
			} else {
				$affectedRows = 0;
			}
			$con->commit ();
	...
	protected function doInsert(PropelPDO $con) {
		...
		if ($this->isColumnModified ( ShopKitPeer::ID )) {
			$modifiedColumns [':p' . $index ++] = '`ID`';
		}
		if ($this->isColumnModified ( ShopKitPeer::PRODUCT_ID )) {
			$modifiedColumns [':p' . $index ++] = '`PRODUCT_ID`';
		}
		if ($this->isColumnModified ( ShopKitPeer::ACTIVE )) {
			$modifiedColumns [':p' . $index ++] = '`ACTIVE`';
		}
		if ($this->isColumnModified ( ShopKitPeer::POSITION )) {
			$modifiedColumns [':p' . $index ++] = '`POSITION`';
		}
		
		$sql = sprintf ( 'INSERT INTO `shop_kit` (%s) VALUES (%s)', implode ( ', ', $modifiedColumns ), implode ( ', ', array_keys ( $modifiedColumns ) ) );
	...
	protected function doValidate($columns = null) {
		if (! $this->alreadyInValidation) {
			...
			if (($retval = ShopKitPeer::doValidate ( $this, $columns )) !== true) {
	...
	public function getByName($name, $type = BasePeer::TYPE_PHPNAME) {
		$pos = ShopKitPeer::translateFieldName ( $name, $type, BasePeer::TYPE_NUM );
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false) {
		if (isset ( $alreadyDumpedObjects ['ShopKit'] [$this->getPrimaryKey ()] )) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects ['ShopKit'] [$this->getPrimaryKey ()] = true;
		$keys = ShopKitPeer::getFieldNames ( $keyType );
		$result = array (
				$keys [0] => $this->getId (),
	...
	public function buildCriteria() {
		...
		if ($this->isColumnModified ( ShopKitPeer::ID ))
			$criteria->add ( ShopKitPeer::ID, $this->id );
		if ($this->isColumnModified ( ShopKitPeer::PRODUCT_ID ))
			$criteria->add ( ShopKitPeer::PRODUCT_ID, $this->product_id );
		if ($this->isColumnModified ( ShopKitPeer::ACTIVE ))
			$criteria->add ( ShopKitPeer::ACTIVE, $this->active );
		if ($this->isColumnModified ( ShopKitPeer::POSITION ))
			$criteria->add ( ShopKitPeer::POSITION, $this->position );
	 ...
	 *        	An object of ShopKit (or compatible) type.
	 ...
	 * If this ShopKit is new, it will return
	...
	public function getShopKitProducts($criteria = null, PropelPDO $con = null) {
		if (null === $this->collShopKitProducts || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopKitProducts) {
				...
				$collShopKitProducts = ShopKitProductQuery::create ( null, $criteria )->filterByShopKit ( $this )->find ( $con );
				if (null !== $criteria) {
	...
	public function countShopKitProducts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null) {
		if (null === $this->collShopKitProducts || null !== $criteria) {
			if ($this->isNew () && null === $this->collShopKitProducts) {
				...
				return $query->filterByShopKit ( $this )->count ( $con );
			}
		} else {
	...
	public function __toString() {
		return ( string ) $this->exportTo ( ShopKitPeer::DEFAULT_STRING_FORMAT );
	}
} // BaseShopKit
