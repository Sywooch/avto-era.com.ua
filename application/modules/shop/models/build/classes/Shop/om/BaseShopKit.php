...
abstract class BaseShopKit extends ShopBaseObject  implements Persistent
{
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ShopKitQuery::create()
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ShopKitPeer::ID)) $criteria->add(ShopKitPeer::ID, $this->id);
		if ($this->isColumnModified(ShopKitPeer::PRODUCT_ID)) $criteria->add(ShopKitPeer::PRODUCT_ID, $this->product_id);
		if ($this->isColumnModified(ShopKitPeer::ACTIVE)) $criteria->add(ShopKitPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(ShopKitPeer::POSITION)) $criteria->add(ShopKitPeer::POSITION, $this->position);
