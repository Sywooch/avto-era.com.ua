...
class ShopKitProductTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('SProductVariants', 'SProductVariants', RelationMap::MANY_TO_ONE, array('product_id' => 'product_id', ), 'CASCADE', 'CASCADE');
		$this->addRelation('ShopKit', 'ShopKit', RelationMap::MANY_TO_ONE, array('kit_id' => 'id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
