...
class SProductsTableMap extends TableMap {
	...
	public function buildRelations() {
		...
		$this->addRelation ( 'SProductPropertiesData', 'SProductPropertiesData', RelationMap::ONE_TO_MANY, array (
				'id' => 'product_id' 
		), 'CASCADE', null, 'SProductPropertiesDatas' );
	...
	public function getBehaviors() {
		return array (
				'i18n' => array (
						...
						'i18n_columns' => 'name, short_description, full_description, meta_title, meta_description, meta_keywords',
