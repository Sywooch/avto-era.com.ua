...
class SDeliveryMethodsTableMap extends TableMap
{
	...
	{
		$this->addRelation('SDeliveryMethodsI18n', 'SDeliveryMethodsI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', 'CASCADE', 'SDeliveryMethodsI18ns');
		$this->addRelation('ShopDeliveryMethodsSystems', 'ShopDeliveryMethodsSystems', RelationMap::ONE_TO_MANY, array('id' => 'delivery_method_id', ), 'CASCADE', null, 'ShopDeliveryMethodsSystemss');
		$this->addRelation('SOrders', 'SOrders', RelationMap::ONE_TO_MANY, array('id' => 'delivery_method', ), 'SET NULL', null, 'SOrderss');
	...
	{
		return array(
			'i18n' => array('i18n_table' => '%TABLE%_i18n', 'i18n_phpname' => '%PHPNAME%I18n', 'i18n_columns' => 'name, description, pricedescription', 'locale_column' => 'locale', 'default_locale' => 'ru', 'locale_alias' => '', ),
		);
	} // getBehaviors()
