...
class SCallbacksTableMap extends TableMap
{
	...
	{
		$this->addRelation('SCallbackStatuses', 'SCallbackStatuses', RelationMap::MANY_TO_ONE, array('status_id' => 'id', ), null, null);
		$this->addRelation('SCallbackThemes', 'SCallbackThemes', RelationMap::MANY_TO_ONE, array('theme_id' => 'id', ), null, null);
	} // buildRelations()
