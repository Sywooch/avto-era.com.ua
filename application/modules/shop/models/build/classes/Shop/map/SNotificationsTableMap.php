...
class SNotificationsTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('SProductVariants', 'SProductVariants', RelationMap::MANY_TO_ONE, array('variant_id' => 'id', ), null, null);
		$this->addRelation('SNotificationStatuses', 'SNotificationStatuses', RelationMap::MANY_TO_ONE, array('status' => 'id', ), null, null);
	} // buildRelations()
