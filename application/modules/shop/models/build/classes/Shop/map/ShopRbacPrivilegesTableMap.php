...
class ShopRbacPrivilegesTableMap extends TableMap
{
	...
	{
		$this->addRelation('ShopRbacGroup', 'ShopRbacGroup', RelationMap::MANY_TO_ONE, array('group_id' => 'id', ), 'CASCADE', 'CASCADE');
		$this->addRelation('ShopRbacRolesPrivileges', 'ShopRbacRolesPrivileges', RelationMap::ONE_TO_MANY, array('id' => 'privilege_id', ), 'CASCADE', 'CASCADE', 'ShopRbacRolesPrivilegess');
