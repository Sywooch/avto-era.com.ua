...
class SProductVariantsTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('SCurrencies', 'SCurrencies', RelationMap::MANY_TO_ONE, array('currency' => 'id', ), 'CASCADE', 'CASCADE');
		$this->addRelation('ShopKitProduct', 'ShopKitProduct', RelationMap::ONE_TO_MANY, array('product_id' => 'product_id', ), 'CASCADE', 'CASCADE', 'ShopKitProducts');
		$this->addRelation('SProductVariantsI18n', 'SProductVariantsI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', 'CASCADE', 'SProductVariantsI18ns');
		$this->addRelation('SNotifications', 'SNotifications', RelationMap::ONE_TO_MANY, array('id' => 'variant_id', ), null, null, 'SNotificationss');
		$this->addRelation('SOrderProducts', 'SOrderProducts', RelationMap::ONE_TO_MANY, array('id' => 'variant_id', ), null, null, 'SOrderProductss');
	} // buildRelations()
