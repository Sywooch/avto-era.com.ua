...
class CustomFieldsTableMap extends TableMap
{
	...
	{
		$this->addRelation('CustomFieldsI18n', 'CustomFieldsI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', 'CASCADE', 'CustomFieldsI18ns');
	} // buildRelations()
	...
	{
		return array(
			'i18n' => array('i18n_table' => '%TABLE%_i18n', 'i18n_phpname' => '%PHPNAME%I18n', 'i18n_columns' => 'field_label, field_description, possible_values', 'locale_column' => 'locale', 'default_locale' => 'ru', 'locale_alias' => '', ),
		);
	} // getBehaviors()
