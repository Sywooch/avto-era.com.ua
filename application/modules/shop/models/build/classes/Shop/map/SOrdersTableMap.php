...
class SOrdersTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('SPaymentMethods', 'SPaymentMethods', RelationMap::MANY_TO_ONE, array('payment_method' => 'id', ), 'SET NULL', null);
		$this->addRelation('SOrderStatuses', 'SOrderStatuses', RelationMap::MANY_TO_ONE, array('status' => 'id', ), 'SET NULL', null);
		$this->addRelation('SOrderProducts', 'SOrderProducts', RelationMap::ONE_TO_MANY, array('id' => 'order_id', ), 'CASCADE', null, 'SOrderProductss');
		$this->addRelation('SOrderStatusHistory', 'SOrderStatusHistory', RelationMap::ONE_TO_MANY, array('id' => 'order_id', ), 'CASCADE', null, 'SOrderStatusHistorys');
	} // buildRelations()
