 ...
 * up to version 1333376021.
 * Generated on 2012-04-02 14:13:41 
 */
class PropelMigration_1333376021 {
...
ALTER TABLE `shop_kit_product` ADD
(
	`discount` VARCHAR(11)
);
...
ALTER TABLE `shop_kit_product` DROP `discount`;
