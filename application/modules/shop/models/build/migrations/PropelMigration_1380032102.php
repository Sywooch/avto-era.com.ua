 ...
 * up to version 1380032102.
 * Generated on 2013-09-24 17:15:02 by andriy
 */
class PropelMigration_1380032102
{
...
ALTER TABLE `custom_fields_i18n` ADD CONSTRAINT `custom_fields_i18n_FK_1`
	FOREIGN KEY (`id`)
...
ALTER TABLE `shop_orders` DROP `order_send`;
...
DROP INDEX `external_id` ON `shop_products`;

ALTER TABLE `shop_products` CHANGE `old_price` `old_price` FLOAT (10,2);

ALTER TABLE `shop_products` DROP `moysclad_uuid`;
...
ALTER TABLE `custom_fields_i18n` DROP FOREIGN KEY `custom_fields_i18n_FK_1`;
...
(
	`order_send` VARCHAR(256) NOT NULL
);
...
(
	`moysclad_uuid` VARCHAR(256) NOT NULL
);

CREATE INDEX `external_id` ON `shop_products` (`external_id`);
