 ...
 * up to version 1311092217.
 * Generated on 2011-07-19 16:16:57 
 */
class PropelMigration_1311092217
{
...
ALTER TABLE `shop_wishes_products` CHANGE `price` `price` FLOAT (10,2);
...
ALTER TABLE `shop_user_profile` DROP `wish_list_data`;
