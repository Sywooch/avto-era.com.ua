 ...
 * up to version 1372166252.
 * Generated on 2013-06-25 16:17:32 by andriy
 */
class PropelMigration_1372166252 {
...
ALTER TABLE `shop_orders` CHANGE `discount_info` `discount_info` TEXT;
...
ALTER TABLE `shop_orders` CHANGE `discount_info` `discount_info` INTEGER;
