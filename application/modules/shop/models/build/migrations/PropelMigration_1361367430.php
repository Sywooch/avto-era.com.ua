 ...
 * up to version 1361367430.
 * Generated on 2013-02-20 15:37:10 by pefolios
 */
class PropelMigration_1361367430 {
...
ALTER TABLE `shop_banners` CHANGE `on_main` `on_main` TINYINT(1);

ALTER TABLE `shop_banners` CHANGE `ESPDATE` `espdate` INTEGER;
...
ALTER TABLE `shop_product_variants` CHANGE `position` `position` INTEGER;
...
ALTER TABLE `shop_banners` CHANGE `on_main` `on_main` VARCHAR(255) NOT NULL;

ALTER TABLE `shop_banners` CHANGE `espdate` `ESPDATE` VARCHAR(255) NOT NULL;
...
ALTER TABLE `shop_product_variants` CHANGE `position` `position` INTEGER DEFAULT 0;
