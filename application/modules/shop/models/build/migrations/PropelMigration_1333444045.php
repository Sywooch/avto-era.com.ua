 ...
 * up to version 1333444045.
 * Generated on 2012-04-03 09:07:25 
 */
class PropelMigration_1333444045
{
...
ALTER TABLE `shop_kit_product` CHANGE `discount` `discount` VARCHAR(11) DEFAULT \'0\';
...
ALTER TABLE `shop_kit_product` CHANGE `discount` `discount` VARCHAR(11);
