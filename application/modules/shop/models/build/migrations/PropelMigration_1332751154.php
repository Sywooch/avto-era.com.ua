 ...
 * up to version 1332751154.
 * Generated on 2012-03-26 08:39:14 
 */
class PropelMigration_1332751154
{
...
CREATE INDEX `shop_rbac_privileges_FI_1` ON `shop_rbac_privileges` (`group_id`);
...
(
	...
	PRIMARY KEY (`id`),
	INDEX `shop_rbac_group_I_1` (`name`)
...
DROP INDEX `shop_rbac_privileges_FI_1` ON `shop_rbac_privileges`;

ALTER TABLE `shop_rbac_privileges` DROP `group_id`;
