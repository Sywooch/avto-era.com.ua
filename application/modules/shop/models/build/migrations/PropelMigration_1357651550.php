 ...
 * up to version 1357651550.
 * Generated on 2013-01-08 15:25:50 by user
 */
class PropelMigration_1357651550
{
...
ALTER TABLE `shop_banners` CHANGE `active` `active` TINYINT(1);
...
ALTER TABLE `shop_rbac_group` CHANGE `name` `name` VARCHAR(255) NOT NULL;

ALTER TABLE `shop_rbac_group` ADD
(
	`description` VARCHAR(255)
);

ALTER TABLE `shop_rbac_group` DROP `type`;

CREATE INDEX `shop_rbac_group_I_1` ON `shop_rbac_group` (`name`);

ALTER TABLE `shop_rbac_privileges` CHANGE `name` `name` VARCHAR(255) NOT NULL;

ALTER TABLE `shop_rbac_privileges` ADD
(
	`description` VARCHAR(255)
);
...
ALTER TABLE `shop_rbac_roles` ADD
(
	`description` VARCHAR(255)
);
...
ALTER TABLE `shop_banners` CHANGE `active` `active` TINYINT(1) NOT NULL;

ALTER TABLE `shop_banners_i18n` DROP FOREIGN KEY `shop_banners_i18n_FK_1`;

ALTER TABLE `shop_brands` DROP `position`;
...
DROP INDEX `shop_rbac_group_I_1` ON `shop_rbac_group`;

ALTER TABLE `shop_rbac_group` CHANGE `name` `name` VARCHAR(100) NOT NULL;
...
ALTER TABLE `shop_rbac_group` DROP `description`;

ALTER TABLE `shop_rbac_privileges` DROP FOREIGN KEY `shop_rbac_privileges_FK_1`;

ALTER TABLE `shop_rbac_privileges` CHANGE `name` `name` VARCHAR(100) NOT NULL;

ALTER TABLE `shop_rbac_privileges` DROP `description`;

ALTER TABLE `shop_rbac_roles` DROP `description`;
