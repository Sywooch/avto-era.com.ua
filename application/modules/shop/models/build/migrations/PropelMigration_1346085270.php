 ...
 * up to version 1346085270.
 * Generated on 2012-08-27 16:34:30 
 */
class PropelMigration_1346085270
{
...
ALTER TABLE `shop_products_i18n` ADD CONSTRAINT `shop_products_i18n_FK_2`
	FOREIGN KEY (`id`)
	REFERENCES `shop_spy` (`product_id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;
...
ALTER TABLE `shop_spy` DROP FOREIGN KEY `shop_spy_FK_1`;

DROP INDEX `shop_spy_FI_1` ON `shop_spy`;
...
ALTER TABLE `shop_products_i18n` DROP FOREIGN KEY `shop_products_i18n_FK_2`;
...
CREATE INDEX `shop_spy_FI_1` ON `shop_spy` (`product_id`);

ALTER TABLE `shop_spy` ADD CONSTRAINT `shop_spy_FK_1`
	FOREIGN KEY (`product_id`)
	REFERENCES `shop_products_i18n` (`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;
