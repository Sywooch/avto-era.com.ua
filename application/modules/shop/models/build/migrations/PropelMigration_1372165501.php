 ...
 * up to version 1372165501.
 * Generated on 2013-06-25 16:05:01 by andriy
 */
class PropelMigration_1372165501
{
...
ALTER TABLE `shop_orders` DROP `discount`;

ALTER TABLE `shop_orders` DROP `discount_info`;

ALTER TABLE `shop_orders` DROP `origin_price`;
