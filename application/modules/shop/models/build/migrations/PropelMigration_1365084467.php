 ...
 * up to version 1365084467.
 * Generated on 2013-04-04 14:07:47 
 */
class PropelMigration_1365084467
{
...
ALTER TABLE `custom_fields` CHANGE `CLASSES` `classes` TEXT;

ALTER TABLE `custom_fields` CHANGE `position` `position` TINYINT;

ALTER TABLE `custom_fields` DROP `field_access_rules`;
...
ALTER TABLE `custom_fields` CHANGE `classes` `CLASSES` VARCHAR(255);

ALTER TABLE `custom_fields` CHANGE `position` `position` INTEGER;
