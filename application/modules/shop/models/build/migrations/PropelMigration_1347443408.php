 ...
 * up to version 1347443408.
 * Generated on 2012-09-12 12:50:08 by kaero
 */
class PropelMigration_1347443408 {
...
ALTER TABLE `shop_orders` DROP `comulativ`;
...
ALTER TABLE `shop_user_profile` DROP `amout`;

ALTER TABLE `shop_user_profile` DROP `discount`;
