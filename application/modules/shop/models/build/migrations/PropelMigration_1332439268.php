 ...
 * up to version 1332439268.
 * Generated on 2012-03-22 18:01:08 
 */
class PropelMigration_1332439268
{
...
CREATE TABLE `shop_rbac_user_roles`
(
	`id` INTEGER NOT NULL,
	`user_id` INTEGER NOT NULL,
	`role_id` INTEGER NOT NULL,
	PRIMARY KEY (`id`),
	INDEX `shop_rbac_user_roles_FI_1` (`role_id`),
	CONSTRAINT `shop_rbac_user_roles_FK_1`
		FOREIGN KEY (`role_id`)
...
(
	...
	PRIMARY KEY (`id`),
	INDEX `shop_rbac_roles_privileges_FI_1` (`role_id`),
	INDEX `shop_rbac_roles_privileges_FI_2` (`privilege_id`),
	CONSTRAINT `shop_rbac_roles_privileges_FK_1`
		FOREIGN KEY (`role_id`)
		REFERENCES `shop_rbac_roles` (`id`)
		ON UPDATE CASCADE
		ON DELETE CASCADE,
	CONSTRAINT `shop_rbac_roles_privileges_FK_2`
...
DROP TABLE IF EXISTS `shop_rbac_user_roles`;
