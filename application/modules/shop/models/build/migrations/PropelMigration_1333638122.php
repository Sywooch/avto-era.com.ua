 ...
 * up to version 1333638122.
 * Generated on 2012-04-05 15:02:02 
 */
class PropelMigration_1333638122
{
...
ALTER TABLE `shop_orders_products` ADD
(
	`kit_id` INTEGER,
	`is_main` TINYINT(1)
);
...
ALTER TABLE `shop_orders_products` DROP `kit_id`;

ALTER TABLE `shop_orders_products` DROP `is_main`;
