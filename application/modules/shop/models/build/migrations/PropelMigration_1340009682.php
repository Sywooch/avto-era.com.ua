 ...
 * up to version 1340009682.
 * Generated on 2012-06-18 11:54:42 by kaero
 */
class PropelMigration_1340009682 {
...
ALTER TABLE `shop_product_properties` CHANGE `main_propery` `main_property` TINYINT(1);
...
ALTER TABLE `shop_product_properties` CHANGE `main_property` `main_propery` TINYINT(1);
