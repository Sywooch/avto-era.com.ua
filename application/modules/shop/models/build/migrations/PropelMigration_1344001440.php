 ...
 * up to version 1344001440.
 * Generated on 2012-08-03 13:44:00 
 */
class PropelMigration_1344001440 {
...
ALTER TABLE `shop_category` CHANGE `tpl` `tpl` VARCHAR(250);

ALTER TABLE `shop_category` CHANGE `order_method` `order_method` INTEGER;
...
ALTER TABLE `shop_gifts` CHANGE `key` `key` VARCHAR(255);

ALTER TABLE `shop_gifts` CHANGE `active` `active` INTEGER;

ALTER TABLE `shop_gifts` CHANGE `price` `price` INTEGER;

ALTER TABLE `shop_gifts` CHANGE `created` `created` INTEGER;
...
ALTER TABLE `shop_orders` CHANGE `external_id` `external_id` VARCHAR(255);
...
ALTER TABLE `shop_product_properties_data` CHANGE `locale` `locale` VARCHAR(5) NOT NULL;
...
ALTER TABLE `shop_product_properties_i18n` CHANGE `data` `data` TEXT;
...
ALTER TABLE `shop_products` CHANGE `tpl` `tpl` VARCHAR(250);
...
ALTER TABLE `shop_rbac_privileges` ADD CONSTRAINT `shop_rbac_privileges_FK_1`
	FOREIGN KEY (`group_id`)
	REFERENCES `shop_rbac_group` (`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;

ALTER TABLE `shop_rbac_roles_privileges` ADD CONSTRAINT `shop_rbac_roles_privileges_FK_1`
	FOREIGN KEY (`role_id`)
	REFERENCES `shop_rbac_roles` (`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;

ALTER TABLE `shop_rbac_roles_privileges` ADD CONSTRAINT `shop_rbac_roles_privileges_FK_2`
	FOREIGN KEY (`privilege_id`)
	REFERENCES `shop_rbac_privileges` (`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;

ALTER TABLE `shop_user_profile` CHANGE `user_external_id` `user_external_id` VARCHAR(255);

ALTER TABLE `shop_user_profile` ADD CONSTRAINT `shop_user_profile_FK_1`
	FOREIGN KEY (`role_id`)
	REFERENCES `shop_rbac_roles` (`id`)
	ON UPDATE CASCADE
	ON DELETE SET NULL;
...
ALTER TABLE `shop_category` CHANGE `tpl` `tpl` VARCHAR(100) NOT NULL;

ALTER TABLE `shop_category` CHANGE `order_method` `order_method` INTEGER NOT NULL;
...
ALTER TABLE `shop_gifts` CHANGE `key` `key` VARCHAR(255) NOT NULL;

ALTER TABLE `shop_gifts` CHANGE `active` `active` INTEGER NOT NULL;

ALTER TABLE `shop_gifts` CHANGE `price` `price` INTEGER NOT NULL;

ALTER TABLE `shop_gifts` CHANGE `created` `created` INTEGER NOT NULL;
...
ALTER TABLE `shop_orders` CHANGE `external_id` `external_id` VARCHAR(255) NOT NULL;
...
ALTER TABLE `shop_product_properties_data` CHANGE `locale` `locale` VARCHAR(255) NOT NULL;

ALTER TABLE `shop_product_properties_i18n` DROP FOREIGN KEY `shop_product_properties_i18n_FK_1`;

ALTER TABLE `shop_product_properties_i18n` CHANGE `data` `data` VARCHAR(255) NOT NULL;
...
ALTER TABLE `shop_products` CHANGE `tpl` `tpl` VARCHAR(100) NOT NULL;
...
ALTER TABLE `shop_rbac_privileges` DROP FOREIGN KEY `shop_rbac_privileges_FK_1`;

ALTER TABLE `shop_rbac_roles_privileges` DROP FOREIGN KEY `shop_rbac_roles_privileges_FK_1`;

ALTER TABLE `shop_rbac_roles_privileges` DROP FOREIGN KEY `shop_rbac_roles_privileges_FK_2`;

ALTER TABLE `shop_user_profile` DROP FOREIGN KEY `shop_user_profile_FK_1`;

ALTER TABLE `shop_user_profile` CHANGE `user_external_id` `user_external_id` VARCHAR(255) NOT NULL;
