 ...
 * up to version 1315387608.
 * Generated on 2011-09-07 12:26:48 by firstrow
 */
class PropelMigration_1315387608
{
...
ALTER TABLE `shop_product_properties_data` DROP PRIMARY KEY;

ALTER TABLE `shop_product_properties_data` CHANGE `property_id` `property_id` INTEGER;

ALTER TABLE `shop_product_properties_data` CHANGE `product_id` `product_id` INTEGER;
...
ALTER TABLE `shop_product_properties_data` DROP `multiple`;

ALTER TABLE `shop_product_properties_data` ADD PRIMARY KEY (`id`);

CREATE INDEX `shop_product_properties_data_FI_1` ON `shop_product_properties_data` (`property_id`);
...
DROP INDEX `shop_product_properties_data_FI_1` ON `shop_product_properties_data`;

ALTER TABLE `shop_product_properties_data` CHANGE `property_id` `property_id` INTEGER NOT NULL;

ALTER TABLE `shop_product_properties_data` CHANGE `product_id` `product_id` INTEGER NOT NULL;
...
ALTER TABLE `shop_product_properties_data` DROP `id`;

ALTER TABLE `shop_product_properties_data` ADD PRIMARY KEY (`property_id`,`product_id`);
