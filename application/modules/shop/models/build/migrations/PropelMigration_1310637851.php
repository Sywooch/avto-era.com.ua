 ...
 * up to version 1310637851.
 * Generated on 2011-07-14 10:04:11 
 */
class PropelMigration_1310637851 {
...
ALTER TABLE `shop_orders` CHANGE `status` `status` INTEGER;
...
ALTER TABLE `shop_orders` CHANGE `status` `status` SMALLINT;
