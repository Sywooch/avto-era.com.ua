 ...
 * up to version 1331304565.
 * Generated on 2012-03-09 14:49:25 
 */
class PropelMigration_1331304565 {
...
ALTER TABLE `shop_product_variants_i18n` CHANGE `id` `id` INTEGER NOT NULL;
...
ALTER TABLE `shop_product_variants_i18n` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;
