 ...
 * up to version 1311348940.
 * Generated on 2011-07-22 15:35:40 
 */
class PropelMigration_1311348940
{
...
CREATE INDEX `shop_user_profile_I_1` ON `shop_user_profile` (`key`);
...
DROP INDEX `shop_user_profile_I_1` ON `shop_user_profile`;

ALTER TABLE `shop_user_profile` DROP `key`;
