 ...
 * up to version 1347436258.
 * Generated on 2012-09-12 10:50:58 by pefolios
 */
class PropelMigration_1347436258 {
...
ALTER TABLE `shop_spy` ADD
(
	`old_price` INTEGER(11)
);
...
ALTER TABLE `shop_spy` DROP `old_price`;
