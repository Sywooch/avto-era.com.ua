 ...
 * up to version 1314862370.
 * Generated on 2011-09-01 10:32:50 by firstrow
 */
class PropelMigration_1314862370 {
...
CREATE INDEX `shop_callbacks_I_4` ON `shop_callbacks` (`date`);
...
DROP INDEX `shop_callbacks_I_4` ON `shop_callbacks`;
...
ALTER TABLE `shop_product_variants` DROP `mainImage`;

ALTER TABLE `shop_product_variants` DROP `smallImage`;
