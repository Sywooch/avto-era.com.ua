 ...
 * up to version 1312365805.
 * Generated on 2011-08-03 13:03:25 by firstrow
 */
class PropelMigration_1312365805
{
...
ALTER TABLE `shop_callbacks_statuses` CHANGE `default` `is_default` TINYINT;
...
ALTER TABLE `shop_callbacks_statuses` CHANGE `is_default` `default` TINYINT;
