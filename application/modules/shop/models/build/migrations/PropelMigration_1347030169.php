 ...
 * up to version 1347030169.
 * Generated on 2012-09-07 18:02:49 by kaero
 */
class PropelMigration_1347030169 {
...
ALTER TABLE `shop_spy` DROP `variant_id`;

ALTER TABLE `shop_spy` DROP `key`;

ALTER TABLE `shop_spy` DROP `email`;
