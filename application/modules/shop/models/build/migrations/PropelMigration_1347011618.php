 ...
 * up to version 1347011618.
 * Generated on 2012-09-07 09:53:38 
 */
class PropelMigration_1347011618 {
...
ALTER TABLE `shop_spy` CHANGE `email` `email` VARCHAR(50);
...
ALTER TABLE `shop_spy` CHANGE `email` `email` VARCHAR(50) NOT NULL;

ALTER TABLE `shop_spy` CHANGE `variant_id` `variant_id` INTEGER NOT NULL;

CREATE UNIQUE INDEX `key` ON `shop_spy` (`key`);
