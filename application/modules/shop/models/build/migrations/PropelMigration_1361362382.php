 ...
 * up to version 1361362382.
 * Generated on 2013-02-20 14:13:02 by koloda
 */
class PropelMigration_1361362382 {
...
ALTER TABLE `shop_banners_i18n` CHANGE `text` `text` VARCHAR(255);
...
ALTER TABLE `shop_banners_i18n` CHANGE `text` `text` TEXT;
