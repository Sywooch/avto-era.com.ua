 ...
 * up to version 1346147759.
 * Generated on 2012-08-28 09:55:59 
 */
class PropelMigration_1346147759 {
...
CREATE INDEX `shop_product_variants_FI_2` ON `shop_product_variants` (`currency`);
...
DROP INDEX `shop_product_variants_FI_2` ON `shop_product_variants`;

ALTER TABLE `shop_product_variants` CHANGE `price` `price` FLOAT(10,5) NOT NULL;

ALTER TABLE `shop_product_variants` DROP `currency`;
