 ...
 * up to version 1377855182.
 * Generated on 2013-08-30 12:33:02 by andriy
 */
class PropelMigration_1377855182 {
...
ALTER TABLE `custom_fields` DROP `field_description`;

ALTER TABLE `custom_fields_i18n` ADD
(
...
ALTER TABLE `custom_fields_i18n` DROP `field_description`;
