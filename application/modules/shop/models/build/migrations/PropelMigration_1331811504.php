 ...
 * up to version 1331811504.
 * Generated on 2012-03-15 11:38:24 
 */
class PropelMigration_1331811504
{
...
ALTER TABLE `shop_banners` DROP `name`;

ALTER TABLE `shop_banners` DROP `text`;

ALTER TABLE `shop_banners` DROP `url`;

ALTER TABLE `shop_banners` DROP `image`;
...
DROP INDEX `shop_brands_I_1` ON `shop_brands`;

ALTER TABLE `shop_brands` DROP `name`;

ALTER TABLE `shop_brands` DROP `description`;

ALTER TABLE `shop_brands` DROP `meta_title`;

ALTER TABLE `shop_brands` DROP `meta_description`;

ALTER TABLE `shop_brands` DROP `meta_keywords`;

CREATE INDEX `shop_brands_I_1` ON `shop_brands` (`url`);
...
ALTER TABLE `shop_callbacks_themes` DROP `text`;
...
DROP INDEX `shop_category_I_1` ON `shop_category`;

ALTER TABLE `shop_category` CHANGE `active` `active` TINYINT(1);

ALTER TABLE `shop_category` DROP `name`;

ALTER TABLE `shop_category` DROP `h1`;

ALTER TABLE `shop_category` DROP `description`;

ALTER TABLE `shop_category` DROP `meta_desc`;

ALTER TABLE `shop_category` DROP `meta_title`;

ALTER TABLE `shop_category` DROP `meta_keywords`;

CREATE INDEX `shop_category_I_1` ON `shop_category` (`url`);
...
DROP INDEX `shop_delivery_methods_I_1` ON `shop_delivery_methods`;
...
ALTER TABLE `shop_delivery_methods` DROP `name`;

ALTER TABLE `shop_delivery_methods` DROP `description`;

CREATE INDEX `shop_delivery_methods_I_1` ON `shop_delivery_methods` (`enabled`);
...
DROP INDEX `shop_notification_statuses_I_1` ON `shop_notification_statuses`;

ALTER TABLE `shop_notification_statuses` DROP `name`;

CREATE INDEX `shop_notification_statuses_I_1` ON `shop_notification_statuses` (`position`);
...
DROP INDEX `shop_order_statuses_I_1` ON `shop_order_statuses`;

ALTER TABLE `shop_order_statuses` DROP `name`;

CREATE INDEX `shop_order_statuses_I_1` ON `shop_order_statuses` (`position`);
...
DROP INDEX `shop_payment_methods_I_1` ON `shop_payment_methods`;
...
ALTER TABLE `shop_payment_methods` DROP `name`;

ALTER TABLE `shop_payment_methods` DROP `description`;

CREATE INDEX `shop_payment_methods_I_1` ON `shop_payment_methods` (`position`);
...
DROP INDEX `shop_product_properties_I_1` ON `shop_product_properties`;

ALTER TABLE `shop_product_properties` CHANGE `active` `active` TINYINT(1);

ALTER TABLE `shop_product_properties` CHANGE `show_in_compare` `show_in_compare` TINYINT(1);

ALTER TABLE `shop_product_properties` CHANGE `show_on_site` `show_on_site` TINYINT(1);

ALTER TABLE `shop_product_properties` CHANGE `multiple` `multiple` TINYINT(1);

ALTER TABLE `shop_product_properties` DROP `name`;

CREATE INDEX `shop_product_properties_I_1` ON `shop_product_properties` (`active`);
...
DROP INDEX `shop_product_variants_I_4` ON `shop_product_variants`;

ALTER TABLE `shop_product_variants` CHANGE `price` `price` FLOAT (10,5) NOT NULL;

ALTER TABLE `shop_product_variants` DROP `name`;

CREATE INDEX `shop_product_variants_I_4` ON `shop_product_variants` (`price`);
...
DROP INDEX `shop_products_I_1` ON `shop_products`;
...
ALTER TABLE `shop_products` DROP `name`;

ALTER TABLE `shop_products` DROP `short_description`;

ALTER TABLE `shop_products` DROP `full_description`;

ALTER TABLE `shop_products` DROP `meta_title`;

ALTER TABLE `shop_products` DROP `meta_description`;

ALTER TABLE `shop_products` DROP `meta_keywords`;

CREATE INDEX `shop_products_I_1` ON `shop_products` (`url`);
...
CREATE INDEX `shop_brands_I_1` ON `shop_brands` (`name`);
...
ALTER TABLE `shop_callbacks_themes` ADD
(
	`text` VARCHAR(255)
);
...
CREATE INDEX `shop_category_I_1` ON `shop_category` (`name`);
...
ALTER TABLE `shop_delivery_methods` ADD
(
	`name` VARCHAR(500) NOT NULL,
	`description` TEXT
);

CREATE INDEX `shop_delivery_methods_I_1` ON `shop_delivery_methods` (`name`);
...
ALTER TABLE `shop_notification_statuses` ADD
(
	`name` VARCHAR(500) NOT NULL
);

CREATE INDEX `shop_notification_statuses_I_1` ON `shop_notification_statuses` (`name`);
...
ALTER TABLE `shop_order_statuses` ADD
(
	`name` VARCHAR(500) NOT NULL
);

CREATE INDEX `shop_order_statuses_I_1` ON `shop_order_statuses` (`name`);
...
CREATE INDEX `shop_payment_methods_I_1` ON `shop_payment_methods` (`name`);
...
ALTER TABLE `shop_product_properties` CHANGE `active` `active` TINYINT;

ALTER TABLE `shop_product_properties` CHANGE `show_in_compare` `show_in_compare` TINYINT;

ALTER TABLE `shop_product_properties` CHANGE `show_on_site` `show_on_site` TINYINT;

ALTER TABLE `shop_product_properties` CHANGE `multiple` `multiple` TINYINT;
...
CREATE INDEX `shop_product_properties_I_1` ON `shop_product_properties` (`name`);
...
CREATE INDEX `shop_product_variants_I_4` ON `shop_product_variants` (`name`);
...
CREATE INDEX `shop_products_I_1` ON `shop_products` (`name`);
