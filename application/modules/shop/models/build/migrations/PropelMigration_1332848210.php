 ...
 * up to version 1332848210.
 * Generated on 2012-03-27 11:36:50 
 */
class PropelMigration_1332848210
{
...
ALTER TABLE `shop_user_profile` ADD
(
	`role_id` INTEGER
);

CREATE INDEX `shop_user_profile_FI_1` ON `shop_user_profile` (`role_id`);
...
DROP INDEX `shop_user_profile_FI_1` ON `shop_user_profile`;

ALTER TABLE `shop_user_profile` DROP `role_id`;
