 ...
 * up to version 1331633079.
 * Generated on 2012-03-13 10:04:39 
 */
class PropelMigration_1331633079
{
...
ALTER TABLE `shop_settings` DROP PRIMARY KEY;

ALTER TABLE `shop_settings` CHANGE `locale` `locale` VARCHAR(5) NOT NULL;

ALTER TABLE `shop_settings` ADD PRIMARY KEY (`name`,`locale`);
...
ALTER TABLE `shop_settings` CHANGE `locale` `locale` VARCHAR(5);

ALTER TABLE `shop_settings` ADD PRIMARY KEY (`name`);
