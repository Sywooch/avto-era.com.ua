 ...
 * up to version 1380719193.
 * Generated on 2013-10-02 16:06:33 by mark
 */
class PropelMigration_1380719193 {
...
ALTER TABLE `shop_product_properties_i18n` CHANGE `description` `description` TEXT;
...
ALTER TABLE `custom_fields` DROP `access_types`;
...
ALTER TABLE `shop_product_properties_i18n` CHANGE `description` `description` VARCHAR(255) NOT NULL;
