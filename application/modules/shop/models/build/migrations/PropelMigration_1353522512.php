 ...
 * up to version 1353522512.
 * Generated on 2012-11-21 20:28:32 by andrijpc
 */
class PropelMigration_1353522512
{
...
ALTER TABLE `shop_delivery_methods_i18n` CHANGE `test` `price_description` TEXT;
...
ALTER TABLE `shop_delivery_methods_i18n` CHANGE `price_description` `test` TEXT;
