 ...
 * up to version 1360836029.
 * Generated on 2013-02-14 10:00:29 
 */
class PropelMigration_1360836029
{
...
ALTER TABLE `custom_fields` CHANGE `field_access_rules` `classes` TEXT;
...
ALTER TABLE `custom_fields` CHANGE `classes` `field_access_rules` TEXT;
