 ...
 * up to version 1345818396.
 * Generated on 2012-08-24 14:26:36 
 */
class PropelMigration_1345818396
{
...
ALTER TABLE `custom_fields_data` CHANGE `user_id` `entity_id` INTEGER NOT NULL;
...
ALTER TABLE `shop_orders` CHANGE `gift_cert_key` `gift_cert_key` VARCHAR(25);

ALTER TABLE `shop_orders` CHANGE `gift_cert_price` `gift_cert_price` INTEGER;
...
ALTER TABLE `shop_products` CHANGE `user_id` `user_id` INTEGER;
...
ALTER TABLE `custom_fields_data` CHANGE `entity_id` `user_id` INTEGER NOT NULL;
...
ALTER TABLE `shop_gifts` CHANGE `active` `active` INTEGER(4) NOT NULL;
...
ALTER TABLE `shop_orders` CHANGE `gift_cert_key` `gift_cert_key` VARCHAR(25) NOT NULL;

ALTER TABLE `shop_orders` CHANGE `gift_cert_price` `gift_cert_price` INTEGER NOT NULL;
...
ALTER TABLE `shop_products` CHANGE `user_id` `user_id` INTEGER NOT NULL;
...
ALTER TABLE `shop_spy` CHANGE `user_id` `user_id` INTEGER NOT NULL;

ALTER TABLE `shop_spy` CHANGE `product_id` `product_id` INTEGER NOT NULL;
