 ...
 * up to version 1353582954.
 * Generated on 2012-11-22 11:15:54 
 */
class PropelMigration_1353582954 {
...
ALTER TABLE `shop_delivery_methods_i18n` DROP `pricedescription`;
...
ALTER TABLE `users` CHANGE `key` `key` VARCHAR(255) NOT NULL;
...
ALTER TABLE `shop_delivery_methods_i18n` ADD
(
	`pricedescription` VARCHAR(50)
);
...
ALTER TABLE `users` CHANGE `key` `key` VARCHAR(50) NOT NULL;
