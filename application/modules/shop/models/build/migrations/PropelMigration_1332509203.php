 ...
 * up to version 1332509203.
 * Generated on 2012-03-23 13:26:43 
 */
class PropelMigration_1332509203
{
...
ALTER TABLE `shop_rbac_privileges` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;

CREATE INDEX `shop_rbac_privileges_I_1` ON `shop_rbac_privileges` (`name`);

ALTER TABLE `shop_rbac_roles` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;

ALTER TABLE `shop_rbac_roles_privileges` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `shop_rbac_user_roles` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;

CREATE INDEX `shop_rbac_user_roles_I_1` ON `shop_rbac_user_roles` (`user_id`);

ALTER TABLE `shop_rbac_user_roles` ADD CONSTRAINT `shop_rbac_user_roles_FK_1`
	FOREIGN KEY (`role_id`)
	REFERENCES `shop_rbac_roles` (`id`)
	ON UPDATE CASCADE
	ON DELETE CASCADE;
...
DROP INDEX `shop_rbac_privileges_I_1` ON `shop_rbac_privileges`;

ALTER TABLE `shop_rbac_privileges` CHANGE `id` `id` INTEGER NOT NULL;

ALTER TABLE `shop_rbac_roles` CHANGE `id` `id` INTEGER NOT NULL;
...
ALTER TABLE `shop_rbac_roles_privileges` CHANGE `id` `id` INTEGER NOT NULL;

ALTER TABLE `shop_rbac_user_roles` DROP FOREIGN KEY `shop_rbac_user_roles_FK_1`;

DROP INDEX `shop_rbac_user_roles_I_1` ON `shop_rbac_user_roles`;

ALTER TABLE `shop_rbac_user_roles` CHANGE `id` `id` INTEGER NOT NULL;
