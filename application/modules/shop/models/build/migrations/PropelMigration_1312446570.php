 ...
 * up to version 1312446570.
 * Generated on 2011-08-04 08:29:30 
 */
class PropelMigration_1312446570 {
...
ALTER TABLE `shop_notifications` ADD
(
	`notified_by_email` TINYINT
);
...
ALTER TABLE `shop_notifications` DROP `notified_by_email`;
