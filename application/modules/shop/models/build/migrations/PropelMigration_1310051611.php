 ...
 * up to version 1310051611.
 * Generated on 2011-07-07 15:13:31 
 */
class PropelMigration_1310051611 {
...
CREATE INDEX `shop_orders_FI_2` ON `shop_orders` (`payment_method`);
...
DROP INDEX `shop_orders_FI_2` ON `shop_orders`;

ALTER TABLE `shop_orders` CHANGE `delivery_price` `delivery_price` FLOAT(10,2);

ALTER TABLE `shop_orders` DROP `payment_method`;
