 ...
 * up to version 1372169532.
 * Generated on 2013-06-25 17:12:12 by andrij
 */
class PropelMigration_1372169532 {
...
DROP INDEX `id` ON `shop_products`;
...
CREATE INDEX `id` ON `shop_products` (`id`);
