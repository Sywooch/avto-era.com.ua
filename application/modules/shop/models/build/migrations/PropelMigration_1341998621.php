 ...
 * up to version 1341998621.
 * Generated on 2012-07-11 12:23:41 
 */
class PropelMigration_1341998621 {
...
ALTER TABLE `shop_product_properties_data` ADD
(
...
ALTER TABLE `shop_product_properties_data` DROP `locale`;

ALTER TABLE `shop_product_properties_i18n` DROP FOREIGN KEY `shop_product_properties_i18n_FK_1`;

ALTER TABLE `shop_product_properties_i18n` DROP `data`;
