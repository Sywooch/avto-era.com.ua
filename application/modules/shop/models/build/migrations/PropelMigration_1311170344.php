 ...
 * up to version 1311170344.
 * Generated on 2011-07-20 13:59:04 
 */
class PropelMigration_1311170344 {
...
ALTER TABLE `shop_wishes` CHANGE `total_price` `total_price` FLOAT (10,2);

ALTER TABLE `shop_wishes_products` DROP `product_name`;

ALTER TABLE `shop_wishes_products` DROP `variant_name`;

ALTER TABLE `shop_wishes_products` DROP `price`;

ALTER TABLE `shop_wishes_products` DROP `quantity`;

ALTER TABLE `shop_wishes_products` ADD CONSTRAINT `shop_wishes_products_FK_1`
	FOREIGN KEY (`product_id`)
	REFERENCES `shop_products` (`id`);

ALTER TABLE `shop_wishes_products` ADD CONSTRAINT `shop_wishes_products_FK_2`
	FOREIGN KEY (`wish_id`)
...
ALTER TABLE `shop_wishes_products` DROP FOREIGN KEY `shop_wishes_products_FK_1`;

ALTER TABLE `shop_wishes_products` DROP FOREIGN KEY `shop_wishes_products_FK_2`;

ALTER TABLE `shop_wishes_products` ADD
(
