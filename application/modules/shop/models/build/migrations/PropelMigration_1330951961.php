 ...
 * up to version 1330951961.
 * Generated on 2012-03-05 12:52:41 
 */
class PropelMigration_1330951961 {
...
CREATE INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n` (`lang`);

CREATE INDEX `shop_product_properties_i18n_I_2` ON `shop_product_properties_i18n` (`name`);
...
DROP INDEX `shop_product_properties_i18n_I_2` ON `shop_product_properties_i18n`;

DROP INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n`;

ALTER TABLE `shop_product_properties_i18n` DROP `lang`;

CREATE INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n` (`name`);
