 ...
 * up to version 1370359709.
 * Generated on 2013-06-04 18:28:29 by andriy
 */
class PropelMigration_1370359709
{
...
DROP INDEX `product_id` ON `shop_product_categories`;
...
DROP INDEX `property_id` ON `shop_product_properties_categories`;
...
ALTER TABLE `shop_product_properties_i18n` ADD
(
	`description` TEXT
);
...
ALTER TABLE `shop_sorting` CHANGE `tooltip` `tooltip` VARCHAR(100);

ALTER TABLE `shop_sorting` CHANGE `get` `get` VARCHAR(25) NOT NULL;

ALTER TABLE `shop_sorting` CHANGE `active` `active` TINYINT(1);
...
CREATE INDEX `product_id` ON `shop_product_categories` (`product_id`);
...
CREATE INDEX `property_id` ON `shop_product_properties_categories` (`property_id`);
...
ALTER TABLE `shop_product_properties_i18n` DROP `description`;
...
ALTER TABLE `shop_sorting` CHANGE `tooltip` `tooltip` VARCHAR(50) NOT NULL;

ALTER TABLE `shop_sorting` CHANGE `get` `get` VARCHAR(15);

ALTER TABLE `shop_sorting` CHANGE `active` `active` TINYINT(1) NOT NULL;
