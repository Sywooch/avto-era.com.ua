 ...
 * up to version 1344508463.
 * Generated on 2012-08-09 10:34:23 
 */
class PropelMigration_1344508463 {
...
ALTER TABLE `custom_fields` CHANGE `ENTITY` `entity` VARCHAR(32);

ALTER TABLE `custom_fields` CHANGE `options` `options` VARCHAR(65);
...
ALTER TABLE `custom_fields` CHANGE `entity` `ENTITY` VARCHAR(32) NOT NULL;

ALTER TABLE `custom_fields` CHANGE `options` `options` VARCHAR(65) NOT NULL;
