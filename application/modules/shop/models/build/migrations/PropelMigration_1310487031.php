 ...
 * up to version 1310487031.
 * Generated on 2011-07-12 16:10:31 
 */
class PropelMigration_1310487031 {
...
ALTER TABLE `shop_delivery_methods` CHANGE `price_in_percent` `is_price_in_percent` TINYINT NOT NULL;
...
ALTER TABLE `shop_delivery_methods` CHANGE `is_price_in_percent` `price_in_percent` TINYINT NOT NULL;
