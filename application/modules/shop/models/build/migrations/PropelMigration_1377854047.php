 ...
 * up to version 1377854047.
 * Generated on 2013-08-30 12:14:07 by andriy
 */
class PropelMigration_1377854047
{
...
ALTER TABLE `custom_fields` CHANGE `id` `id` INTEGER NOT NULL;

ALTER TABLE `custom_fields` ADD
(
	`locale` VARCHAR(4) NOT NULL
);

ALTER TABLE `custom_fields` ADD PRIMARY KEY (`id`,`locale`);

ALTER TABLE `custom_fields_data` ADD
(
	`locale` VARCHAR(4) NOT NULL
);
...
ALTER TABLE `shop_currencies` CHANGE `showOnSite` `showOnSite` INT (1) DEFAULT 0;
...
ALTER TABLE `shop_delivery_methods` CHANGE `position` `position` INTEGER(11);
...
ALTER TABLE `shop_orders` CHANGE `discount` `discount` FLOAT (10,2);

ALTER TABLE `shop_orders` CHANGE `origin_price` `origin_price` FLOAT (10,2);

ALTER TABLE `shop_orders` CHANGE `comulativ` `comulativ` FLOAT (10,2);
...
ALTER TABLE `shop_orders_products` ADD CONSTRAINT `shop_orders_products_FK_3`
...
ALTER TABLE `shop_products` CHANGE `views` `views` INTEGER DEFAULT 0;
...
ALTER TABLE `custom_fields` CHANGE `id` `id` INTEGER NOT NULL AUTO_INCREMENT;

ALTER TABLE `custom_fields` DROP `locale`;

ALTER TABLE `custom_fields` ADD PRIMARY KEY (`id`);

ALTER TABLE `custom_fields_data` DROP `locale`;
...
ALTER TABLE `shop_currencies` CHANGE `showOnSite` `showOnSite` INTEGER(1) DEFAULT 0;

ALTER TABLE `shop_delivery_methods` CHANGE `price` `price` FLOAT(10,2) NOT NULL;

ALTER TABLE `shop_delivery_methods` CHANGE `free_from` `free_from` FLOAT(10,2) NOT NULL;

ALTER TABLE `shop_delivery_methods` CHANGE `position` `position` INTEGER;
...
ALTER TABLE `shop_orders_products` DROP FOREIGN KEY `shop_orders_products_FK_3`;
...
ALTER TABLE `shop_products` CHANGE `views` `views` INTEGER;
...
ALTER TABLE `shop_sorting` DROP `name`;

ALTER TABLE `shop_sorting` DROP `name_front`;

ALTER TABLE `shop_sorting` DROP `tooltip`;
