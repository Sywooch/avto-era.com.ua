 ...
 * up to version 1330952197.
 * Generated on 2012-03-05 12:56:37 
 */
class PropelMigration_1330952197
{
...
ALTER TABLE `shop_product_properties_i18n` DROP PRIMARY KEY;

DROP INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n`;

ALTER TABLE `shop_product_properties_i18n` CHANGE `locale` `locale` VARCHAR(5) NOT NULL;

ALTER TABLE `shop_product_properties_i18n` DROP `loacale`;

ALTER TABLE `shop_product_properties_i18n` ADD PRIMARY KEY (`id`);

CREATE INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n` (`locale`);
...
ALTER TABLE `shop_product_properties_i18n` CHANGE `locale` `locale` VARCHAR(5) DEFAULT \'en_EN\' NOT NULL;

ALTER TABLE `shop_product_properties_i18n` ADD
(
	`loacale` VARCHAR(5) NOT NULL
);

ALTER TABLE `shop_product_properties_i18n` ADD PRIMARY KEY (`id`,`locale`);

CREATE INDEX `shop_product_properties_i18n_I_1` ON `shop_product_properties_i18n` (`loacale`);
