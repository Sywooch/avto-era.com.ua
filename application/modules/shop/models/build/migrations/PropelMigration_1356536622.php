 ...
 * up to version 1356536622.
 * Generated on 2012-12-26 15:43:42 
 */
class PropelMigration_1356536622 {
...
ALTER TABLE `shop_brands` CHANGE `position` `position` SMALLINT NOT NULL;
...
ALTER TABLE `shop_brands` CHANGE `position` `position` INTEGER(8) NOT NULL;
