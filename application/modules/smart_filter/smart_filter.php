...
class Smart_filter extends \Category\BaseCategory {
	...
	public function init() {
		...
		return \CMSFactory\assetManager::create ()->registerScript ( 'jquery.ui-slider', TRUE )->registerScript ( 'filter', TRUE )->render ( 'main', true );
	}
	public function filter() {
		$this->set_price ();
		
		return \CMSFactory\assetManager::create ()->setData ( $this->data )->render ( 'filter', true );
	}
