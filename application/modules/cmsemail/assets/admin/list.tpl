<div class="container">
	...
	<div class="modal hide fade modal_del">
		...
		<div class="modal-footer">
			<a href="#" class="btn btn-primary"
				onclick="delete_function.deleteFunctionConfirm('/admin/components/cp/cmsemail/delete/')">{lang('Delete',
				'cmsemail')}</a> <a href="#" class="btn"
				onclick="$('.modal').modal('hide');">{lang('Cancel',
				'cmsemail')}</a>
		</div>
	</div>
	...
	<section class="mini-layout">
		<div class="frame_title clearfix">
			<div class="pull-left">
				<span class="help-inline"></span> <span class="title">{lang('Email-notifications
					managing', 'cmsemail')}</span>
			</div>
			<div class="pull-right">
				...
				<div class="d-i_b">
					...
					</a> <a class="btn btn-small pjax"
						href="{$BASE_URL}admin/components/cp/cmsemail/settings"> <i
						class="icon-wrench"></i> {lang('Settings', 'cmsemail')}
					</a>
					<button type="button"
					...
					<a class="btn btn-small btn-success pjax"
						href="/admin/components/cp/cmsemail/create"> <i
						class="icon-list-alt icon-white"></i>{lang('Create template',
						'cmsemail')}
					</a>
				</div>
			</div>
		...
		<div class="tab-content">
				...
				<form method="post" action="#" class="form-horizontal">
					<table
						...
						<tbody class="sortable">
							...
							<tr>
								<td class="t-a_c">{if $model.id > 7} <span
									class="frame_label"> <span class="niceCheck b_n">
								...
								<td><a class="pjax"
									href="/admin/components/cp/cmsemail/edit/{echo $model.id}/#settings">{echo
										$model.name}</a></td> {$settings = unserialize($model.settings)}
			...
			{else:} </br>
			<div class="alert alert-info">{lang('Templates list empty',
				'cmsemail')}</div>
			{/if}
		</div>
	</section>
