...
#headline p {
	...
	margin-top: 0px;
	margin-bottom: 30px;
	text-shadow: 0 2px 1px #FEFEFE !important;
	color: #1D9995 !important;
}
												...
												<tr>
													...
													<td class="w580" width="580">
														<div id="headline" align="center">
															<p>
																<strong><singleline label="Title">{lang('Comment
																	status')}#{echo $comment->id} {lang('has been updated
																	successfully')}</singleline></strong>
															</p>
														</div>
													</td>
													<td class="w30" width="30"></td>
												...
												<tr>
													...
													<td class="w580" width="580">
														<table class="w580" border="0" cellpadding="0"
															...
															<tbody>
																<tr>
																	<td class="w580" width="350"
																		style="font-size: 16px; color: #444;"><b>{lang('Go
																			to the page with the comment')}:</b></td>
																	<td style="font-size: 16px;"><a
																		style="text-decoration: underline;"
																		href="{site_url($comment->source['full_url'])}">{truncate(site_url($comment->source['full_url']),
																			35)}</a></td>
																</tr>
																<tr>
