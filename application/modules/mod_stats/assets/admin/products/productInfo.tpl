<div class="span8">
	...
	<div class="span6 d_i-b m-l_0">
		<input id="productForStats" type="text" value=""
			class="ui-autocomplete-input d-i_b" autocomplete="off" role="textbox"
			aria-autocomplete="list" aria-haspopup="true"> <input
			id="statsProductId" type="hidden" name="productId" value="">
	</div>
	<div class="span2">
		<a class="btn btn-small" id="productInfoButtonShow"> <i
			class="icon-share-alt"> </i> {lang('Show','mod_stats')}
		</a>
	</div>
</div>
