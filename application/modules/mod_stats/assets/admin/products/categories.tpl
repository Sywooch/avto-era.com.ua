<div>
	<a id="selectCategoryHideShow"> {lang('Select categories',
		'mod_stats')} </a>
	<div id="categoriesMultiSelectBlock" style="display: none;">
		<div class="control-group">
			<div class="controls">
				<select multiple="multiple" id="selectCategoriesIds"
					style="height: 150px !important;"> {foreach
					$data['categoryTree'] as $category} {$selected=""} {if
					...
					<option {if $category->getLevel() == 0}
						style="font-weight: bold;"{/if} {$selected} value="{echo
		...
		<div class="span2" style="float: right;">
			<a class="btn btn-small" id="withSelectedCategoriesDrawChartButton">
				<i class="icon-share-alt"> </i> {lang('Show','mod_stats')}
			</a>
		</div>
		<br />
		<hr />
