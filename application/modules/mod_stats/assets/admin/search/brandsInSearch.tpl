					...
					<div class="form-horizontal">
						<div class="row-fluid">
							<div class="control-group">
								<label class="control-label"> {lang('Quantity of words',
									'mod_stats')} :</label>
								<div class="controls number">
									<input id="quantityOfWordsStatsSearch"
										class="input-small required f_l"
									...
									<span class="frame_label no_connection m-r_15 m-l_40 m-t_10">
										<span class="" style="background-position: -46px 0px;">
											...
											{if $_COOKIE['use_locale_search_stats'] ==
											'true'} checked="checked" {/if}/>
									</span> {lang('Consider the current language', 'mod_stats')}
									</span>
							...
							<div class="control-group">
								<label class="control-label"> {lang('Count of results',
									'mod_stats')} :</label>
								<div class="controls number">
							...
							<div class="control-group">
								<div class="controls">
									<a class="btn btn-small" id="startBrandsAnalisInSearch"
										style="margin-right: 80px;"> <i class="icon-share-alt">
									</i> {lang('Starting the analysis','mod_stats')}
									</a>
								</div>
							</div>
						</div>
