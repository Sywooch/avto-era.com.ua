<div class="span7">
	<select id="selectCategoryId"> {foreach $data as $category}
		<option {if $category->getLevel() == 0}style="font-weight:
			bold;"{/if} value="{echo $category->getId()}" {if
			$_COOKIE['cat_id_for_stats'] ==
