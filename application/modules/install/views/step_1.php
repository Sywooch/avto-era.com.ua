...
<ul class="list">
    <?php foreach ($dirs as $k => $v) { ?>
        <li class="<?php echo $v ?>"><?php echo $k?><?php if('ok'==$v) { ?> <i
		class=" icon-ok-circle"></i> <?php } else { ?> <i
		class=" icon-minus-sign"></i> <?php } ?></li>
    <?php } ?>
    </ul>
</p>
...
<p align="left">
	<br /> <a href="<?php echo $next_link ?>" class="btn btn-success"><i
		class="icon-ok icon-white"></i><?php echo lang('Next', 'install') ?></a>
