...
<form method="post" action="/documentation/create_new_page">
	...
	<div class="input-group">
		<select name="NewPage[category]" class="form-control">
			{$this->view("cats_select_create.tpl", array('tree' =>
			$tree,'sel_cat' => $_POST['NewPage']['category']));}
		</select>
	</div>
	...
	<div class="input-group">
		<input type="text" name="NewPage[title]"
	...
	<div class="input-group">
		<input type="text" name="NewPage[url]"
			value="{echo set_value('NewPage[url]')}" class="form-control"
