...
class Digital_products extends MY_Controller {
	...
	public function _extendProductAdmin($data) {
		...
		\CMSFactory\assetManager::create ()->appendData ( 'customAdminInterface', ShopCore::app ()->CustomFieldsHelper->getCustomField ( ShopCore::app ()->SSettings->DPLinkCFID, 'product', $model->getId () )->asAdminHtml () );
	}
	...
	public function _install() {
		$this->db->where ( 'name', 'digital_products' )->update ( 'components', array (
				'autoload' => '1',
				'enabled' => '1'
		) );
